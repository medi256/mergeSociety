    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          to handle asynchronous operations compared to callbacks, especially
          when you have several asynchronous tasks that depend on each other.
        </p>
        ...
        <ul>
          <li>
            <strong>Resolved</strong>: The promise has successfully completed,
            and the result is available.
          </li>
          <li>
            <strong>Rejected</strong>: Something went wrong, and the promise
        ...
        <p>
          ...
          order, you're "promised" that your food will arrive. If everything
          goes well, you get your meal (the promise is <code>resolved</code>).
          If something goes wrong (e.g., they run out of ingredients), they
          notify you that the order can’t be fulfilled (the promise is{" "}
          <code>rejected</code>).
        </p>
        ...
        <ul>
          ...
          <li>
            <code>reject</code>: A function that is called if there’s an error
            or failure.
          </li>
        </ul>
...
const myPromise = new Promise((resolve, reject) => {
  ...
  if (success) {
    ...
    reject('There was an error.');
        ...
        <p>
          In this example, the promise checks if <code>success</code> is true.
          If it is, the promise is resolved with the message "Operation was
  ...
  .catch((error) => {
    console.log(error);  // This runs if the promise is rejected
        ...
        <ul>
          ...
          <li>
            If the promise is rejected, the <code>.catch()</code> method logs
            the error message ("There was an error.").
          </li>
        </ul>
  ...
  .catch((error) => {
    console.log(error);  // This will run if there's an error
        ...
        <ul>
          ...
          <li>
            The promise simulates fetching data (or some other long-running
            task).
          </li>
          <li>
          ...
          <li>
            If the data is fetched successfully, the promise is resolved with
            the message "Data received successfully!"
          </li>
          <li>
        ...
        <p>
          ...
          link <code>.then()</code> calls together to handle multiple
          asynchronous tasks in a sequence. For example:
        </p>
...
fetchData()
  ...
  .catch((error) => {
    console.log(error);  // Catch any error that occurs in any step
        ...
        <p>
          Think of promises like placing an online order. You place the order,
          and you are promised the delivery of the product (which might take
          some time). The promise has two possible outcomes: either the delivery
          is successful (resolved) and you get your product, or there’s a
          problem with the delivery (rejected) and you get an error
          notification. You don’t wait by the door the whole time; instead,
          you’re notified when the delivery is done or if something goes wrong.
        </p>
        ...
        <ul>
          ...
          <li>
            Promise chaining allows us to handle multiple asynchronous tasks in
            a sequence.
          </li>
        </ul>
