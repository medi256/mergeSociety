      ...
      <div className="lesson-container">
        <section>
          ...
          <p>
            ...
            task, you’ve likely used assignment operators without even realizing
            it!
          </p>
          <p>
            Let’s explore how assignment operators can help make your code
            cleaner and faster.
          </p>
...
console.log("Initial score:", score); // Output: Initial score: 10
          ...
          <p>
            Instead of writing something like <code>score = score + 5</code>{" "}
            every time we want to increase the score, we can use the addition
...
console.log("New score:", score); // Output: New score: 15
          ...
          <p>
            This operator adds the value on the right to the variable on the
            left and updates the variable. It’s a great shortcut for making your
            code cleaner.
          </p>
          ...
          <p>
            Just like the addition assignment, the subtraction assignment
            operator reduces the value of a variable:
          </p>
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
...
console.log("Remaining health:", health); // Output: Remaining health: 80
          ...
          <p>
            The multiplication assignment operator multiplies the variable by
...
console.log("Doubled score:", score); // Output: Doubled score: 20
          ...
          <p>
            The division assignment operator divides the variable by the value
            on the right:
          </p>
          <pre>
            <code>
...
console.log("Remaining apples:", apples); // Output: Remaining apples: 5
          ...
          <p>
            The modulus assignment operator gives the remainder when dividing
            the variable by the value on the right:
          </p>
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
...
console.log("Remainder:", total); // Output: Remainder: 1
          ...
          <p>
            ...
            other types of operators to create powerful expressions. For
            example:
          </p>
          <pre>
            <code>
...
console.log("New experience:", experience); // Output: New experience: 550
          ...
          <p>
            ...
            comparison, logical, and assignment operators! Next, we’ll dive
            into:
          </p>
          <ul>
            <li>
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Create a countdown timer that reduces the remaining time by 1
              second until it reaches 0.
            </li>
            <li>
              Make a program that simulates spending money on items, reducing
              the balance each time an item is purchased.
            </li>
          </ul>
          <p>
            Practice makes perfect, so keep experimenting with these operators
            and see how they can make your code more efficient!
          </p>
