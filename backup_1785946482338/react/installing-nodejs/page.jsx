    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          treehouse, but you don’t want to make every part from scratch. You
          might buy ready-made parts, like pre-cut wooden boards or ladders. npm
          is like a giant store that contains thousands of ready-made pieces of
          code (called <strong>packages </strong> ) that you can use in your
          projects, so you don’t have to build everything yourself.
        </p>
        <p>
          Together, <strong>Node.js </strong> and <strong> npm </strong> will
          make your life much easier as a React developer by helping you run
          your project and use all the great tools that others have already
          created.
        </p>
        ...
        <p>
          ...
          it’s best to go with the LTS version, as it’s more stable and
          reliable.
        </p>
        <p>
          <strong>
        ...
        <p>
          ...
          Congratulations, you’ve just installed Node.js and npm on your
          computer!
        </p>
        ...
        <p>
          ...
          <strong>command line </strong> (also known as Terminal on Mac or
          Command Prompt on Windows). Don’t worry if you’ve never used the
          command line before—we’ll guide you through it step by step.
        </p>
        <ul>
          <li>
        ...
        <p>
          ...
          pop up, like `v16.x.x` (the numbers might be different depending on
        ...
        <p>
          ...
          installed on your computer. You should see a number like `8.x.x`
          (again, the numbers might be different based on your installation).
        </p>
        <p>
          If you see version numbers for both Node.js and npm, you’re good to
          go! Everything is installed correctly.
        </p>
