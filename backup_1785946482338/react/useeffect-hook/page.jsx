...
export default SimpleEffectComponent;`}
        ...
        <p>
          You need to import <code>useEffect</code> from the React library,
          along with <code>useState</code>.
        </p>
        <pre>
          <code>
            {" "}
        ...
        <p>
          <code>message</code>: This state variable stores the message to
          display.
          <br />
...
export default UpdateTitleComponent;`}
        ...
        <p>
          <code>document.title</code>: This changes the title of the browser
          tab. When the component mounts, the document title updates to 'New
          Title'.
        </p>
...
export default TimerComponent;`}
        ...
        <p>
          <code>setInterval</code>: Sets up a timer that logs 'Tick' every
          second.
          <br />
          Cleanup function: The function returned from <code>
            useEffect
          </code>{" "}
        ...
        <ul>
          ...
          <li>
            ...
            like a timer or subscription, provide a cleanup function to remove
            or clear those resources when the component unmounts.
          </li>
          <pre>
            <code>
              <SyntaxHighlighter language="jsx" style={docco}>
...
return () => clearInterval(timer); // Cleanup function
          ...
          <li>
            <strong>Multiple Effects:</strong> You can use{" "}
            <code>useEffect</code> multiple times in the same component to
            handle different side effects.
          </li>
          <pre>
            <code>
              <SyntaxHighlighter language="jsx" style={docco}>
