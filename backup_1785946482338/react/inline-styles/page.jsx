    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          elements using the <code>style</code> prop. This approach allows you
          to define styles inline with your JSX, making your code more concise
          and dynamic. With inline styles, you can easily update and manage
          styles without the need for separate stylesheet files.
        </p>
        ...
        <p>
          Inline styles in React are a way to apply styles directly to JSX
          elements. Instead of using separate CSS classes or external
          stylesheets, you define the styles inline with your JSX code. Inline
          styles are defined as JavaScript objects with CSS property names and
          values.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>Code Concision:</strong> Inline styles eliminate the need
            for separate stylesheet files, making your code more concise and
            easier to maintain.
          </li>
          <li>
        ...
        <ol>
          <li>
            <strong>Define Inline Styles:</strong> Create a JavaScript object
            with CSS property names and values.
          </li>
          <li>
            <strong>Apply Inline Styles:</strong> Use the <code>style</code>{" "}
            prop to apply the inline styles to your JSX elements.
          </li>
        </ol>
...
`}
        ...
        <p>
          ...
          property names and values. We can use this object to apply styles to
          our JSX elements.
        </p>
...
`}
        ...
        <p>
          ...
          <code>inlineStyles</code> object are applied directly to these
          elements.
        </p>
...
`}
        ...
        <p>
          ...
          applications. They eliminate the need for separate stylesheet files
          and make your code more dynamic and flexible. However, for larger
