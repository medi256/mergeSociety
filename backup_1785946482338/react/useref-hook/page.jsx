    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          always refer back to it, no matter how many times you change the
          pages. In this analogy, <code>useRef</code> is like that magic
          notebook. It lets you keep a persistent note (or reference) without
          changing how your component behaves.
        </p>
        ...
        <ul>
          ...
          <li>
            Storing a value that doesn't need to trigger re-renders when
            updated.
          </li>
          <li>
        ...
        <p>
          In summary, <code>useRef</code> provides a way to interact with
          elements and values directly, without affecting the component's
          rendering.
        </p>

        <h2>How Does useRef Work?</h2>
        <p>
          Let’s walk through how the <code>useRef</code> Hook works, step by
...
export default ExampleComponent;`}
        ...
        <p>
          ...
          create something called a ref object. The <code>useRef</code> Hook
          helps you do this.
        </p>
        <pre>
          <code>
        ...
        <ul>
          ...
          <li>
            <code>{`useRef(null)`}</code>: This tells React to create a ref
            object that starts as <code>null</code>. When the component renders,
            React will assign the ref to the DOM element you reference.
          </li>
        </ul>
...
inputRef.current.focus();
        ...
        <ul>
          ...
          <li>
            <strong>Accessing elements:</strong> Once the component renders,
            React assigns the ref object to the DOM element. You can then use
        ...
        <ul>
          <li>
            ...
            does not cause your component to re-render. It’s purely for
            accessing elements or storing values without affecting the UI.
          </li>
          <li>
            <strong>Ref object persists:</strong> The ref object persists for
            the full lifetime of the component. It doesn’t get reset on
            re-renders.
          </li>
          <li>
