    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          <strong> VS Code</strong> installed and set up, it’s time to create
          your very first React project! This will be your workspace where
          you’ll write, test, and run your React code. We’ll be using a tool
          called **Create React App** to make this process easy and fast.
        </p>

        <h2>What is Create React App?</h2>
        <p>
          <code> Create React App </code> is a tool developed by the React team
          to help you quickly set up a React project with all the necessary
          files and configurations. Think of it as a "starter kit" for React.
          You won’t have to manually set up a bunch of files or worry about
          configuration—Create React App does all that for you.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            pre-configured so you don’t have to worry about setting up things
            like Webpack, Babel, or other tools.
          </li>
          <li>
          ...
          <li>
            <strong>Ready for production </strong> : When you’re ready to
            publish your project, Create React App will help you create a
            version of your project that’s optimized for performance.
          </li>
        </ul>
        ...
        <p>
          The first thing you need to do is open a terminal (also called a
          command line). In VS Code, there’s a built-in terminal that you can
        ...
        <ul>
          ...
          <li>
            ...
            computer by searching for "Command Prompt" (on Windows) or
        ...
        <ul>
          ...
          <li>
            ...
            You can change this to anything you want, but for now, we’ll use
            this name to keep things simple.
          </li>
        </ul>
        <p>
          ...
          and dependencies for you. You’ll see a lot of messages in the
          terminal, but don’t worry—this is completely normal!
        </p>

        <h3>Step 4: Open Your New React Project</h3>
        <p>
          After the installation is complete, you’ll have a new folder called
          `my-first-react-app` (or whatever you named your project) in the
          folder where you ran the command. This folder contains all the files
        ...
        <ul>
          ...
          <li>
            This command moves you into your project folder, where you’ll be
            able to start working with your React code.
          </li>
        </ul>

        <h3>Step 5: Start the Development Server</h3>
        <p>
          Before you start coding, let’s see if everything is working correctly
          by running your React project. React comes with a built-in{" "}
          <strong>development server </strong> that allows you to see your
          project in action while you’re building it. To start the server, type
        ...
        <p>
          ...
          correctly, you should see the default React welcome page that looks
          like this:
        </p>
        ...
        <ul>
          <li>
            ...
            dependencies (external libraries) that your project needs to run.
            You don’t need to worry about these files.
          </li>
          <li>
            <code>public/ </code> : This folder contains files that are public,
            meaning they can be accessed by the user’s browser. It includes
            files like `index.html`, where your React app is displayed.
          </li>
          <li>
            ...
            <ul>
              ...
              <li>
                ...
                It’s where React renders the `App` component and mounts it to
                the `index.html` file.
              </li>
            </ul>
          </li>
        ...
        <p>
          ...
          building amazing things with React! In the next section, we’ll dive
          into
          <strong> JSX </strong> (JavaScript XML) and see how React allows you
          to build user interfaces using components.
        </p>
