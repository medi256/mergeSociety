...
const KeysUnderstanding = () => {
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          helps React keep track of which items change, are added, or are
          removed. Think of it like this: if you have a group of friends, and
          you want to know who's who, you might give each friend a unique
          nickname. That's what keys do for items in a list!
        </p>
        ...
        <p>
          ...
          "Teddy Bear" to "Robot", "Toy Car" to "Teddy Bear", and so on. This
          can cause problems and make your app slower.
        </p>
        <p>
          With keys, React knows exactly what changed. It can say, "Oh, a new
          toy with this specific key was added at the beginning. I don't need to
          touch the other toys."
        </p>

        <h2>How to Use Keys</h2>
        <p>
          Let's update our fruit list example from the previous lesson to
          include keys:
        </p>
        <pre>
          <code>
    ...
    <div>
      ...
      <ul>
        ...
        <ul>
          ...
          <li>
            Keys should not change or be generated randomly. They should stay
            the same unless the item is deleted.
          </li>
          <li>
            Don't use array index as keys if your list order might change. It
            can cause problems!
          </li>
        </ul>
  ...
  <li key={index}>{fruit.name}</li>
        ...
        <p>
          Sometimes, you might not have a unique ID for each item. In these
          cases, you can create a unique key by combining multiple properties.
          For example:
        </p>
        <pre>
          <code>
...
`}
        ...
        <p>
          Here, we're creating a unique key by combining the name and color.
          This works because we know each fruit name and color combination will
          be unique in our list.
        </p>
        ...
        <ul>
          ...
          <li>
            Create a new list (maybe favorite books or movies) and give each
            item a unique key.
          </li>
          <li>
            Try adding and removing items from your list. Notice how React
            handles the changes smoothly with keys!
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            They help React identify which items have changed, been added, or
            been removed.
          </li>
          <li>Keys should be unique among siblings and shouldn't change.</li>
          <li>
            Using array index as keys can cause problems if your list order
            might change.
          </li>
          <li>
        ...
        <p>
          ...
          prevent weird bugs when your lists change. It's a small thing that
