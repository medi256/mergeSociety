    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          button, hovering over an element, or submitting a form. React allows
          you to handle these events in a structured way using event handlers.
        </p>
        <p>
        ...
        <h2>
          Key Differences in Handling Events in React vs. Regular
          HTML/JavaScript
        </h2>
        <p>
...
export default App;`}
        ...
        <ul>
          ...
          <li>
            <strong>The onClick event:</strong> We attach the{" "}
            <code>onClick</code> event directly to the button. Whenever the
            button is clicked, the event triggers the <code>handleClick</code>{" "}
            function, which then shows the alert message.
          </li>
        </ul>
        <p>
          Notice that in React, the event name is <code>onClick</code>{" "}
          (camelCase) instead of the lowercase <code>onclick</code> that you
          might have seen in regular HTML.
        </p>
        <p>
        ...
        <p>
          There may be situations where you want to handle different actions
          based on which button is clicked. For example, imagine you have
          multiple buttons on the page, and you want to know exactly which
          button the user clicked. To handle this, you can pass arguments (or
          values) to the event handler.
        </p>
...
export default App;`}
        ...
        <ul>
          ...
          <li>
            ...
            pass the name of the button to the <code>handleClick</code>{" "}
            function, we use an arrow function inside the <code>onClick</code>{" "}
            event: <code>{`onClick={() => handleClick("First")}`}</code>. This
            allows us to pass the string 'First' to the function when the first
            button is clicked, and 'Second' when the second button is clicked.
          </li>
        </ul>
        <p>
          <strong>Why use an arrow function?</strong> If you tried to write{" "}
          <code>{`onClick={handleClick("First")}`}</code>, the function would
          run immediately when the page loads, and we don’t want that. By using
          the arrow function <code>{`() => handleClick('First')`}</code>, it
          only runs when the button is actually clicked.
        </p>
        ...
        <ul>
          <li>
            <code>onMouseEnter</code>: Runs when the user hovers their mouse
            over an element.
          </li>
          <li>
          ...
          <li>
            <code>onFocus</code>: Runs when an element (like an input field)
            gains focus.
          </li>
          <li>
        ...
        <ul>
          <li>
            Attach event handlers like <code>onClick</code> to elements in
            React.
          </li>
          <li>Write functions that respond to events like button clicks.</li>
          <li>
            Pass arguments to event handlers so we can control what happens
