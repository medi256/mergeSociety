    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          learn how to efficiently manage and navigate through nested routes in
        ...
        <p>
          ...
          routes can contain child routes. Nested routes are useful when you
          have sections of your application that require multiple levels of
          navigation.
        </p>
        ...
        <ul>
          <li>
            ...
            makes it easier to manage and maintain your routes as your
            application grows.
          </li>
          <li>
            <strong>Code Reusability:</strong> With nested routes, you can reuse
            common route structures across different sections of your
            application.
          </li>
          <li>
            <strong>Dynamic Routing:</strong> Nested routes enable dynamic
            routing by allowing you to render different components based on the
            current route and its nested routes.
          </li>
        </ul>
        ...
        <ol>
          <li>
            <strong>Define Parent Routes:</strong> Create a parent route using
            the <code>Route</code> component.
          </li>
          <li>
          ...
          <li>
            <strong>Set Default Route with Index:</strong> If you want a
            specific child route to be rendered by default, you can use the{" "}
            <code>index</code> attribute instead of omitting the{" "}
            <code>path</code> prop.
          </li>
        </ol>
...
`}
        ...
        <p>
          In this code, we define two child routes within the news page route:
          one for the technology section (<code>/news/technology</code>) and
          another for the sports section (<code>/news/sports</code>). We specify
          the <code>element</code> prop to indicate the component that should be
...
`}
        ...
        <p>
          In this code, we added a default route (<code>/news</code>) that will
          be rendered when the user visits <code>/news</code> without specifying
          a specific child route. The <code>IntroductionH</code> component will
...
`}
        ...
        <ul>
          ...
          <li>
            ...
            define child routes using the <code>Route</code> component. The
            child routes represent subsections within the parent routes.
          </li>
          <li>
        ...
        <p>
          ...
          application. By nesting routes, you can efficiently manage and
          navigate through different sections of your application.
        </p>
