    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          component's state because it keeps changing, but the component needs
          to "remember" the latest value.
        </p>
        <p>
        ...
        <p>
          Before we had Hooks, we could only add state in class components. If
          you wanted a button to update a number, or a form to store user input,
          you’d have to write more complicated code using classes. But with{" "}
...
export default ExampleComponent;`}
        ...
        <p>
          First, at the top of the file, we import the <code>useState</code>{" "}
          Hook from React. You always need to import Hooks like{" "}
          <code>useState</code> before you use them in your component.
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="jsx" style={docco}>
        ...
        <p>
          ...
          create something called a state variable. The <code>useState</code>{" "}
        ...
        <ul>
          <li>
            <code>count</code>: This is the state variable. It stores the
            current value of the counter, which starts at 0. Every time the
            state changes, React will remember the new value.
          </li>
          <li>
            <code>setCount</code>: This is the function that we use to update
            the value of <code>count</code>. Whenever you want to change the
            counter’s value, you call <code>setCount</code>.
          </li>
          <li>
            <code>useState(0)</code>: This tells React that <code>count</code>{" "}
            should start at 0. The 0 inside <code>useState()</code> is the
            initial state, meaning the first value that <code>count</code> will
            have when the component loads.
          </li>
        </ul>
        ...
        <p>
          ...
          then re-render the component to show the new value of{" "}
          <code>count</code> on the screen.
        </p>
        ...
        <p>
          This is how your component "remembers" things like the number of times
          a button has been clicked — through state.
        </p>
        ...
        <ul>
          <li>
            ...
            state created with <code>useState</code> only exists in the
            component where you declare it. Each component can have its own
            state that doesn’t interfere with other components.
          </li>
          <li>
            <strong>State triggers re-rendering:</strong> Anytime you use the
            function from <code>useState</code> (like <code>setCount</code>),
            React will update the component with the new value and re-render it
            on the screen.
          </li>
          <li>
...
{isOpen && <div>This is the menu!</div>}`}
        ...
        <p>
          <code>isOpen</code> is the state that keeps track of whether the menu
          is open.
          <br />
          <code>setIsOpen</code> toggles the state between true and false
        ...
        <ul>
          <li>
            <code>useState</code> lets your component "remember" and update
            values (like a counter or form input) over time.
          </li>
