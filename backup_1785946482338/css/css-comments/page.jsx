    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          explanations, provide context, or leave reminders for yourself or
          other developers working on the code. Comments are ignored by the
          browser and do not affect the styling of your web page. In this
          section, we'll explore the importance of comments and learn how to use
          them effectively in your CSS code. Let's begin!
        </p>
        ...
        <p>
          ...
          between these symbols is considered a comment and will be ignored by
...
*/
        ...
        <p>
          ...
          lines. Multi-line comments are useful when you need to provide
          detailed explanations, document complex code sections, or include
          references or credits for code snippets.
        </p>
...
*/
        ...
        <p>
          ...
          <code>.highlight</code>
          class. This means that the code within the comment block will be
          ignored by the browser. You can use this technique to experiment with
          different styles or to temporarily disable certain rules while
          troubleshooting.
        </p>
        ...
        <ul>
          <li>
            Use comments to explain complex or non-obvious sections of your
            code.
          </li>
          <li>
            Include comments to provide context or reasoning behind certain
        ...
        <p>
          ...
          editor and create a new CSS file. Let's explore the power of comments:
        </p>
        ...
        <ol>
          ...
          <li>
            Experiment with commenting out certain rules to see how it affects
