...
export const metadata = {
  title: "Mastering Flexbox in CSS | Learn Responsive Design",
  description:
    "Explore the power of Flexbox in CSS with our comprehensive guide. Learn how to create flexible and responsive layouts using flex properties, including flex-direction, flex-wrap, and alignment techniques.",
  keywords: [
    "CSS Flexbox",
    "responsive design",
    "flex layout",
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          space, align content, and control the order of items within a
          container. In this section, we'll explore the fascinating world of
          flex and learn how to use it effectively in your CSS designs. Let's
          embark on this flex adventure!
        </p>
        ...
        <p>
          ...
          container. With flex, you can create complex and responsive layouts
          that adapt to different screen sizes and devices. Here's an example:
        </p>
...
.item {
  flex: 1; /* Makes the item flexible and distributes space evenly */
        ...
        <p>
          ...
          <code>flex: 1</code>, which distributes the available space evenly
          among them.
        </p>

        <h3>Flex-Direction</h3>
        <p>
          Flex-direction controls the direction in which items are arranged
          within the container. It can have values like <code>row</code>{" "}
          (default), <code>column</code>,<code>row-reverse</code>, and{" "}
...
.container {
  ...
  flex-direction: column; /* Arranges items in a column */
        ...
        <p>
          ...
          arranges the items vertically in a column. You can experiment with
          other values to see how they affect the layout.
        </p>

        <h3>Flex-Wrap</h3>
        <p>
          Flex-wrap controls whether items should wrap to new lines when there's
          not enough space. It can have values like <code>nowrap</code>{" "}
          (default), <code>wrap</code>,<code>wrap-reverse</code>, and{" "}
...
.container {
  ...
  flex-wrap: wrap; /* Makes items wrap to new lines */
        ...
        <p>
          In the code above, we set <code>flex-wrap: wrap</code>, which makes
          the items wrap to new lines when there's not enough horizontal space.
        </p>

        <h3>Align-Items and Justify-Content</h3>
        <p>
          Align-items controls the vertical alignment of items within the
          container, while justify-content controls the horizontal distribution
          of items. Here's an example:
        </p>
...
.container {
  ...
  justify-content: center; /* Centers items horizontally */
        ...
        <ul>
          <li>
            <strong>Flexibility:</strong> Flex provides a flexible and
            responsive way to arrange content, making it easy to adapt to
        ...
        <ul>
          <li>
            <strong>Browser Support:</strong> Flex has good browser support, but
            there may be differences in how it behaves across different
            browsers. It's important to test your designs in multiple browsers
        ...
        <ol>
          ...
          <li>
            Refer to flex resources and tutorials to discover creative ways to
            use flex, such as creating responsive grids, centering content, or
            building complex layouts.
          </li>
        </ol>

        <p>
          Remember, flex is a powerful tool in CSS that gives you control over
          the layout and arrangement of items within a container. Choose flex
        ...
        <Button whereToGo={"css-grid-layout"} />
      </div>
    </div>
  );
};
