  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Ensure images and media elements are responsive by setting their
          maximum width to 100% of the container and using the appropriate CSS
          properties to control their size and aspect ratio.
        </p>

        <h3>Mobile-First Approach</h3>
        <p>
          Start designing for mobile devices first, then progressively enhance
          the layout and functionality for larger screens. This ensures a better
          user experience on smaller devices and prevents the need for excessive
...
<body>
  <div class="container">
    <p>This is a fluid layout that adjusts based on the size of the viewport.</p>
        ...
        <h3>Media Queries</h3>
        <p>
          This example uses media queries to apply different styles for
