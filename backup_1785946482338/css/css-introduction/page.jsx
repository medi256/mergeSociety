  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          CSS, or Cascading Style Sheets, is a fundamental part of web
          development that allows developers to create visually appealing and
          user-friendly websites. If you are already familiar with HTML,
          learning CSS will enable you to take your web development skills to
          the next level. In this tutorial, we will cover the basics of CSS, its
          history, and its role in web development.
        </p>

        <h2>History of CSS</h2>

        <p>
          CSS was developed in the mid-1990s as a way to separate the content
          and structure of a web page from its visual presentation. Before CSS,
          web developers used HTML tags to control the appearance of their
          pages, which led to inconsistent and messy code. Håkon Wium Lie and
          Bert Bos are considered the inventors of CSS, and the first version,
          CSS1, was published in 1996.
        </p>
        ...
        <p>
          ...
          HTML or XML document. It allows web developers to control the look and
          feel of their websites by specifying font styles, colors, layouts, and
          other visual elements. CSS is designed to be flexible and easy to use,
          making it a popular choice for both beginners and experienced
          developers.
        </p>
        ...
        <p>
          ...
          create a separate CSS file or include CSS rules directly within an
          HTML document. These rules define the appearance of specific elements
          or groups of elements, allowing developers to create consistent and
        ...
        <p>
          ...
          for developers to maintain and update their websites. Additionally,
          CSS allows developers to create responsive designs that adapt to
          different screen sizes and devices, ensuring that their websites look
        ...
        <p>
          ...
          and content of a web page, while CSS controls its appearance.
          JavaScript can be used to add interactivity and functionality to a
          website, allowing users to interact with elements on the page.
        </p>
        ...
        <p>
          ...
          create visually appealing and user-friendly websites. By mastering
          CSS, you will be able to control the appearance and layout of your web
          pages, create responsive designs, and combine CSS with HTML and
