    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          content from the border. Padding makes things easier to read, gives
          your design a balanced look, and creates a better experience for
          people using your website. In this section, we'll dive into padding in
          CSS and show you how to use it to style your elements!
        </p>
        <h2>Padding Property</h2>
        <p>
          The <code> padding</code> property in CSS lets you control the space
          around the content inside your boxes (like buttons or text). You can
          add padding to just one side (top, right, bottom, left) or all sides
...
div {
  padding-top: 20px; /* Adds 20px of padding to the top */
        ...
        <p>
          ...
          pixels, creating 20 pixels of space between the content and the top
          edge of the element's border. This is useful when you want to add
          extra space above the content, such as adding breathing room to a
          heading or separating it from other elements.
        </p>
        ...
        <p>
          ...
          Imagine a clear area to the right of the content, separating it from
          the border. This property controls the size of that space. Here's an
...
div {
  padding-right: 15px; /* Adds 15px of padding to the right */
        ...
        <p>
          In the code above, we set the <code>padding-right</code> property to
          15 pixels, creating 15 pixels of space between the content and the
          right edge of the element's border. This is useful when you want to
          add extra space to the right of the content, such as creating a margin
          between text and other elements on the right side.
        </p>
...
div {
  padding-bottom: 10px; /* Adds 10px of padding to the bottom */
        ...
        <p>
          In the code above, we set the <code>padding-bottom</code> property to
          10 pixels, creating 10 pixels of space between the content and the
          bottom edge of the element's border. This is useful when you want to
          add extra space below the content, such as creating separation between
          paragraphs or adding emphasis to a specific element.
        </p>

        <h2>Padding Left</h2>
        <p>
          The <code>padding-left</code> property lets you control the space on
          the left side of your box (like a button or text). Imagine a clear
          area to the left of the content, separating it from the border. This
          property controls the size of that space. Here's an example to see it
          in action:
        </p>
...
div {
  padding-left: 25px; /* Adds 25px of padding to the left */
        ...
        <p>
          ...
          edge of the element's border. This is useful when you want to add
          extra space to the left of the content, such as creating a margin
          between text and other elements on the left side.
        </p>

        <h2>Padding Shorthand</h2>
        <p>
          In CSS, you can also set padding for all sides at once using a
          shortcut. Imagine your box (like a button) has four sides: top, right,
          bottom, and left. This shortcut lets you control the padding for all
          those sides in one line of code, following the order top, right,
          bottom, left (think TRBL for short!). Here's an example to show you
          how it works:
        </p>
...
div {
  padding: 10px 20px; /* Adds 10px of padding to the top and bottom, and 20px of padding to the left and right */
        ...
        <p>
          ...
          <code>padding: 10px 20px 15px 30px</code>, to set padding for each
          side individually.
        </p>
        ...
        <p>
          ...
          relative to the width of the parent element. This means that the
          padding will adjust dynamically based on the size of the parent
...
div {
  padding: 5%; /* Adds 5% of the parent's width as padding */
        ...
        <p>
          ...
          padding will be 20 pixels on each side (5% of 400). This dynamic
          padding can be useful when you want the padding to scale
          proportionally with the parent element's size.
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            affects the spacing around the content. Try using different values
          ...
          <li>
            Try using the shorthand property to set padding for multiple sides
          ...
          <li>
            Refer to padding resources and tutorials to discover creative ways
            to use padding to enhance the readability, visual balance, and user
        ...
        <p>
          ...
          breathing room for your content, improves readability, and adds a
          sense of refinement to your designs. Choose padding values that align
          with your brand and enhance the overall user experience. Happy coding
          and happy designing!
        </p>
