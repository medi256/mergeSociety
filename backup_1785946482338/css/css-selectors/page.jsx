  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        <h1>CSS Selectors</h1>
        <p>
          Selectors are one of the most fundamental concepts in CSS. They are
...
/* This selector targets all <p> elements and makes their text color blue. */
        ...
        <p>
          ...
          <code>{`<p>`}</code>
          elements on the page and sets their text color to blue. This is a
          simple and straightforward way to apply styles to elements of a
          specific type.
        </p>
...
<div class="highlight">This div will also have a yellow background.</div>
        ...
        <h2>ID Selector</h2>
        <p>
          The ID selector is like a laser pointer that targets a specific
          element based on its unique ID. Each ID should be unique within a
          page, making it perfect for styling individual elements. For example,
          let's say you want to style the header of your web page:
        </p>
...
/* This selector targets all <a> elements with an "href" attribute starting with "https" and makes their text color green. */
        ...
        <p>
          ...
          based on their relationship with other elements. It allows you to
          apply styles to elements that are nested within other elements. For
          instance, let's say you want to style list items (
          <code> {`<li>`}</code>) that are descendants of unordered lists (
          <code> {`<ul>`}</code>):
        </p>
...
<ul>
  ...
  <li>Item 3</li>
        ...
        <ol>
          ...
          <li>
            Apply different selectors to target specific elements and change
            their styles, such as color, font-size, background-color, etc.
          </li>
          <li>
            Try combining multiple selectors to apply styles to specific groups
            of elements. For example, style all <code>{`<p>`}</code> elements
            with a class of "highlight".
          </li>
          <li>
            Experiment with attribute selectors to target elements based on
            their attributes and values. For example, style all images (
          ...
          <li>
            Refer to the documentation and examples provided in this component
