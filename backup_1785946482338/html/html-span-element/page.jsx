    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          allow you to apply styles or add functionality to specific parts of
          your content. Let's dive into the world of spans in HTML and learn how
        ...
        <p>
          ...
          divs, which are block-level elements, spans are inline and do not
          create line breaks before or after them. Spans are commonly used to
          apply styles or functionality to specific words, phrases, or small
          portions of text. Here's the basic structure of a span in HTML:
        </p>
        <pre>
          <code>
...
`}
        ...
        <p>
          In the code above, the <code>{`<span>`}</code> tag defines the
          beginning and end of the span. You can place text or other inline
          elements within the span to apply styles or functionality to them.
        </p>

        <h2>Using Spans for Styling</h2>
        <p>
          One of the primary uses of spans is to apply styles to specific parts
          of your text. By using CSS (Cascading Style Sheets), you can target
          spans and style the text within them. Here's an example:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="HTML" style={docco}>
...
`}
        ...
        <ul>
          <li>
            ...
            applying styles to specific words, phrases, or small portions of
            text. Use CSS to style the text within spans, such as changing the
            color, font, or adding background effects.
          </li>
          <li>
            <strong>Use spans for adding functionality:</strong> Spans can be
            used to add dynamic behavior or interactivity to specific parts of
            your content. Use JavaScript to target spans and trigger events or
            functionality.
          </li>
          <li>
          ...
          <li>
            <strong>Avoid using spans for block-level elements:</strong> Spans
            are inline elements, so they should not be used to group block-level
        ...
        <p>
          ...
          create a new HTML file. Experiment with creating spans, applying
          styles, and adding functionality. Here's a simple exercise to get you
          started:
        </p>
...
`}
          ...
          <li>
            Try adding functionality to spans using JavaScript. For instance,
            you can use JavaScript to detect when a user clicks on a span and
            trigger an event, such as displaying a popup or toggling a menu.
          </li>
        </ol>
        ...
        <p>
          ...
          more. Spans are versatile tools that allow you to target and
          manipulate specific parts of your content. Remember to use spans
          wisely, follow best practices, and always test your HTML and
          JavaScript code to ensure your spans work correctly in different
          browsers and devices. In the next lesson, we'll move on to inline
          elements in HTML. Stay tuned, and happy coding!
        </p>
