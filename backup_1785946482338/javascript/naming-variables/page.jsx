...
let isActive = true;
        ...
        <p>
          ...
          capitalizes the first letter of each word except the first one,
          without spaces or underscores. For example:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="javascript" style={docco}>
...
let isStudentActive = true;
        ...
        <p>
          ...
          <code>if</code>, <code>function</code>, <code>while</code>, and
          others.
        </p>
...
let isUserActive = true;  // "is" prefix for boolean variables
        ...
        <p>
          ...
          reflect their current usage. This practice maintains clarity and
...
// Example of using descriptive names and camelCase
 ...
 let isStudentActive = true;
        ...
        <p>
          ...
          Clear and consistent variable naming is a fundamental aspect of
