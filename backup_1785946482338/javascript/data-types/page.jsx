    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          use different types of data to store and work with information. Think
          of it like the different subjects you study at school, each requiring
        ...
        <p>
          ...
          values. These can be integers (whole numbers) or floating-point
          numbers (decimals). Numbers are essential for performing mathematical
...
console.log(totalPrice); // Output: 60`}
        ...
        <h3>String</h3>
        <p>
          The <strong>String</strong> data type is used to represent textual
          data. Strings are enclosed in single <code>'</code> or double{" "}
          <code>"</code> quotes. Strings are crucial for storing and
          manipulating text.
        </p>
        <pre>
          <code>
...
console.log(message); // Output: Hello, Console!`}
        ...
        <p>
          ...
          manipulate strings, combine them, or extract parts of them using
          various string methods in JavaScript. For example, you can concatenate
...
console.log(fullName); // Output: John Doe`}
        ...
        <p>
          Strings are often used for user input and output. For example, you
          might store a user's name and display a welcome message.
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="javascript" style={docco}>
...
console.log(isWorking); // Output: false`}
        ...
        <p>
          ...
          and are often used to make decisions in programs. For example, you
          might use a boolean to represent whether a user has completed a task
          or not.
        </p>
        <p>
          Booleans are used in decision-making. For instance, you might check if
          a user is subscribed to a newsletter before displaying certain
          content.
        </p>

        <h3>Undefined</h3>
        <p>
          The <strong>Undefined</strong> data type represents a variable that
          has been declared but not yet assigned a value. It indicates the
          absence of a value.
        </p>
        <pre>
          <code>
...
console.log(lastName); // Output: undefined`}
        ...
        <p>
          ...
          of any object value. It is explicitly assigned to a variable to
...
console.log(middleName); // Output: null`}
        ...
        <p>
          Null is often used to signify that a variable intentionally has no
          value or that a function deliberately returns no value. It's a way of
          saying "this variable is empty" in a clear manner.
        </p>

        <h3>Type Coercion</h3>
        <p>
          Type coercion is the process of converting a value from one data type
          to another. JavaScript often performs this conversion implicitly,
...
console.log(result); // Output: '55'`}
        ...
        <p>
          In the example above, JavaScript converts the number <code>5</code> to
          a string and concatenates it with the string <code>'5'</code>,
          resulting in <code>'55'</code>. Type coercion can also occur with
          other operations:
        </p>
        <pre>
          <code>
...
console.log(result); // Output: 3`}
        ...
        <p>
          Type coercion happens in many situations in JavaScript, especially
          when performing operations that involve different data types.
          JavaScript tries to be helpful by automatically converting values to
          the appropriate type needed for the operation. This can sometimes lead
          to unexpected results if you're not careful.
        </p>
...
console.log(example); // Output: '510'`}
        ...
        <p>
          ...
          JavaScript converts the string to a number and performs the
          subtraction.
        </p>
        <pre>
          <code>
...
console.log(example); // Output: 5`}
        ...
        <p>
          The <code>typeof</code> operator is used to determine the data type of
          a variable. This can be useful for debugging and understanding the
...
console.log(typeof isStudent); // Output: 'boolean'`}
        ...
        <p>
          Using the <code>typeof</code> operator helps you identify the data
          type of a variable, which can be particularly helpful when debugging
        ...
        <p>
          ...
          foundation of how we store and manipulate information in JavaScript.
          In our next lesson, we'll dive deeper into mathematical operations
          using operators.
        </p>
