...
const Prototypes = () => {
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          A prototype is like a blueprint or a set of instructions that objects
          in JavaScript can follow. Every object in JavaScript has a prototype,
          which is another object that the first object can inherit properties
          and methods from. This allows us to share common functionalities
          across multiple objects without duplicating code.
        </p>
  ...
  person.greet();  // Output: "Hello, my name is Alice"
        ...
        <p>
          ...
          <code>name</code> and a method <code>greet</code>. Now, what if we
          want to create another object that shares the same greet method but
          has a different name? We can use prototypes to do this.
        </p>

        <h3>Creating a New Object with a Prototype</h3>
        <p>
          We can create a new object and link it to the <code>person</code>{" "}
  ...
  anotherPerson.greet();  // Output: "Hello, my name is Bob"
        ...
        <p>
          ...
          <code>anotherPerson</code> inherits from the <code>person</code>{" "}
          object. Even though we didn’t explicitly define the <code>greet</code>{" "}
          method in <code>anotherPerson</code>, it still has access to it
          because it’s inheriting from <code>person</code>.
        </p>

        <h3>Understanding the Prototype Chain</h3>
        <p>
          The prototype chain is like a series of links. When you try to access
          a property or method on an object, JavaScript first looks at the
          object itself. If it doesn’t find it there, it moves up the prototype
          chain to see if the property or method exists in the object’s
          prototype.
        </p>
  ...
  player2.greet();  // Output: "Hello, I am player Bob"
        ...
        <p>
          ...
          <code>Player</code>. Both <code>player1</code> and{" "}
          <code>player2</code> can access the <code>greet</code> method without
          it being redefined for each one.
        </p>
        ...
        <p>
          ...
          <code>Object.prototype</code> unless you explicitly change the
          prototype chain.
        </p>
  ...
  console.log(simpleObject.toString());  // Output: "[object Object]"
        ...
        <p>
          ...
          how JavaScript handles inheritance and how objects share properties
          and methods. Prototypes allow for more efficient memory usage because
          methods and properties don’t need to be duplicated across every
          instance of an object.
        </p>

        <h2>Practice: Creating Your Own Prototypes</h2>
        <p>
          Try creating your own prototypes by defining a constructor function
          and adding methods to its prototype. For example, create a{" "}
          <code>Car</code> constructor with properties like <code>make</code>{" "}
          and <code>model</code>, and add methods to <code>Car.prototype</code>{" "}
          for actions like <code>start</code> and <code>stop</code>.
        </p>
  ...
  myCar.start();  // Output: "Toyota Corolla is starting."
        ...
        <p>
          By practicing with prototypes, you'll gain a deeper understanding of
          how inheritance works in JavaScript and how to efficiently manage
          shared functionality across multiple objects.
        </p>
