...
const DateMethod = () => {
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Handling dates and times is a common task in web development.
          JavaScript provides the <code>Date</code> object to work with dates
          and times easily. In this lesson, we'll cover the basic methods you
          need to know to handle dates and times in your code.
        </p>

        <h2>What is the JavaScript Date Object?</h2>
        <p>
          The <code>Date</code> object in JavaScript is used to represent dates
          and times. You can think of it as a digital calendar and clock
          combined, which allows you to get and set dates and times.
        </p>
        ...
        <p>
          To get the current date and time, simply create a new{" "}
          <code>Date</code> object without any arguments:
        </p>
  ...
  // Output: "Mon Aug 19 2024 10:35:20 GMT-0400 (Eastern Daylight Time)"
        ...
        <ul>
          ...
          <li>
            <code>7</code> – The month (August; remember, months start from 0,
        ...
        <p>
          Use <code>getFullYear()</code> to get the year from a{" "}
  ...
  // Output: 7 (August)
        ...
        <p>
          This is like looking at the month on your calendar. Remember to add 1
  ...
  // Output: 1 (Monday)
        ...
        <p>
          This is like checking what day of the week it is. Remember, Sunday is
          0, and Saturday is 6.
        </p>
  ...
  // Output: 35
        ...
        <p>
          You can also use the <code>Date</code> object to display dates and
          times on your webpage. Here’s a simple example:
        </p>
  ...
  dateElement.textContent = "Current date and time: " + now.toLocaleString();
        ...
        <p>
          ...
          date and time. We then select a <code>&lt;p&gt;</code> element from
          the DOM and update its text content to display the current date and
          time. This helps show how you can use JavaScript’s Date object to
          dynamically update your webpage with current information.
        </p>
        ...
        <p>
          ...
          the methods we’ve discussed to get and display the year, month, day,
          and hour. Finally, set the year to the next year and display the
          updated date.
        </p>
  ...
  console.log("Updated Year:", today.getFullYear());
        ...
        <p>
          ...
          JavaScript’s built-in methods. It’s a great way to get comfortable
          with date and time operations.
        </p>
