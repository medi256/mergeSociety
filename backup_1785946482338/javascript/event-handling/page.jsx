    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          attributes. Here is the basic syntax for adding an event listener
        ...
        <p>
          <strong>element</strong>: The HTML element you want to attach the
          event to (e.g., <code>button</code>, <code>div</code>).
          <br />
          <strong>event</strong>: The type of event you want to listen for
          (e.g., <code>onclick</code>, <code>onmouseover</code>).
          <br />
          <strong>function()</strong>: The JavaScript function that will be
...
// Code to execute when the event occurs
        ...
        <h3>Example</h3>
        <p>
          Here’s an example of how to use the <code>addEventListener</code>{" "}
...
alert('Button clicked!');
        ...
        <p>
          In this example, we first select the button using its ID, then attach
          an event listener to it. This listener waits for a click event and
          shows an alert message when the button is clicked.
        </p>
        <p>
          This approach is more versatile and keeps your HTML and JavaScript
          code separate, making it easier to update and maintain.
        </p>
        ...
        <ul>
          ...
          <li>
            <code>mouseover</code>: Triggered when the mouse pointer moves over
            an element.
          </li>
          <li>
        ...
        <h3>Syntax</h3>
        <p>
          To handle a click event, use the <code>click</code> event type with
...
paragraph.style.color = 'blue';
        ...
        <p>
          In this example, clicking the button changes the color of the
          paragraph to blue.
        </p>
...
// Code to execute when the mouse moves over the element
        ...
        <h3>Example</h3>
        <p>
          Here’s how to use the mouseover event to change the background color
          of a paragraph:
        </p>
        <pre>
          <code>
...
// Code to execute when the mouse moves out of the element
        ...
        <h3>Example</h3>
        <p>
          Here’s how to use the mouseout event to change the background color of
          a paragraph:
        </p>
        <pre>
          <code>
...
paragraph.style.backgroundColor = 'transparent';
        ...
        <h3>Syntax</h3>
        <p>
          To handle a keydown event, use the <code>keydown</code> event type
          with the <code>addEventListener</code> method:
        </p>
        <pre>
          <code>
...
alert('Key pressed: ' + event.key);
        ...
        <p>
          In this example, pressing any key will display an alert showing the
        ...
        <h3>Syntax</h3>
        <p>
          To handle a keyup event, use the <code>keyup</code> event type with
          the <code>addEventListener</code> method:
        </p>
        <pre>
          <code>
...
alert('Key released: ' + event.key);
        ...
        <p>
          In this example, releasing any key will display an alert showing the
