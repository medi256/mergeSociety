  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          In JavaScript, scope refers to the area of a program where a variable
          is accessible. Think of scope as the visibility of variables: where
          you can see and use them. It's like having different rooms in a house
          where certain items are stored. Depending on the room you’re in, you
          might have access to different items.
        </p>
        <p>
        ...
        <p>
          ...
          your code. These variables are defined outside of any function or
          block and are available throughout the entire program.
        </p>
        <pre>
          <code>
...
`}
        ...
        <p>
          ...
          specific function. These variables are defined inside a function and
          are not visible outside of that function. This helps to keep your code
...
`}
        ...
        <p>
          ...
          function but not outside of it, which causes an error when we try to
          log it outside the function.
        </p>

        <h2>Block Scope</h2>
        <p>
          Block scope refers to variables that are accessible only within the
          block of code (i.e., inside curly braces <code>{`{}`}</code>) where
          they are defined. This type of scope was introduced with{" "}
          <code>let</code> and <code>const</code> in ES6 (ECMAScript 2015).
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="javascript" style={docco}>
...
`}
        ...
        <ul>
          <li>
            <strong>Global Scope:</strong> Variables are accessible from
            anywhere in your code. Be cautious with global variables as they can
            be modified from anywhere, potentially causing unintended side
            effects. For example, if multiple functions accidentally change the
            same global variable, it might lead to unpredictable behavior in
            your application.
          </li>
          <li>
            <strong>Local Scope:</strong> Variables are accessible only within
            the function where they are defined. This helps in keeping functions
          ...
          <li>
            <strong>Block Scope:</strong> Variables are accessible only within
            the block (e.g., <code>if</code> statements, loops) where they are
            defined. This provides more granular control over variable
            visibility and helps avoid issues in complex code structures. For
            instance, a variable inside a loop or conditional statement won’t be
