...
export const metadata = {
  ...
  keywords: [
    ...
    "async functions javascript project",
    "weather data javascript project",
    "css styling project",
...
const WeatherApp = () => {
  return (
    <div className="lesson-wrapper">
      ...
      >
        <h1>Building a Weather App with API</h1>

        <h2 className="project-info">
          <span className="project-title">
            <Link href={"/about"}>Written by Massa Medi</Link>
          </span>
          <time className="project-date" dateTime="2025-01-9">
            | January 9, 2025
          </time>
        </h2>

        <p>
          Welcome to the beginner-friendly tutorial on building a Weather App
          with API! In this project, we'll create a weather app that fetches
          real-time weather data from an API and displays it on your webpage.
          This project is an excellent way to learn how to work with APIs,
          handle async functions, and display data on your webpage.
        </p>
        ...
        <div>
          ...
          <p>
            ...
            files. You can name it "weather-app".
          </p>
        ...
        <p>
          Let's start by building the HTML structure for our weather app. HTML
          is like the foundation of our app.
        </p>
...
.hide {
  display: none;
        ...
        <ul>
          ...
          <li>
            <code>#weather-container h2, #weather-container p</code>: Adds
            margin to the city name, temperature, and description.
          </li>
          <li>
        ...
        <ol className="space-y-6">
          ...
          <li>
            <strong>2. Get Your API Key:</strong> Once you're logged in, go to
            the "API keys" section in your account dashboard. You should see a
            default API key. If not, generate a new one by clicking the
            "Generate" button.
          </li>
          <li>
  ...
  if (city) {
    ...
    alert('Please enter a city name.');
        ...
        <p>
          ...
          submission behavior using <code>e.preventDefault()</code>, trim the
          city input, and call the <code>fetchWeatherData</code> function if the
          city is not empty. If the city is empty, we show an alert.
        </p>
...
async function fetchWeatherData(city) {
  ...
  try {
    ...
    alert(error.message);
        ...
        <p>
          In this function, we use the <code>fetch</code> function to make an
          API request to the OpenWeatherMap API. We use <code>async/await</code>{" "}
          to handle the asynchronous request. If the response is successful, we
          parse the JSON data and call the <code>displayWeatherData</code>{" "}
          function to display the weather data. If the response is not
          successful, we throw an error and show an alert.
        </p>
  ...
  #weather-container h2, #weather-container p {
    font-size: 0.9rem;
        ...
        <ul>
          ...
          <li>
            <code>#weather-container h2, #weather-container p</code>: Adjusts
            the font size of the city name, temperature, and description for
        ...
        <p>
          Feel free to customize and expand your weather app further. You can
          add more features, improve the design, or even create a mobile
