    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          JavaScript. These statements allow our programs to make decisions
          based on specific conditions we define.
        </p>
        <p>
          Think of a conditional statement like making decisions in real life.
          You decide what to wear based on the weather, right? Similarly,
          JavaScript uses conditional statements to change how our code behaves
        ...
        <ul>
          ...
          <li>
            <code>&gt;</code>: Checks if the value on the left is greater than
        ...
        <p>
          These operators help us create conditions that tell our code what to
          do based on different inputs and situations.
        </p>
...
`}
        ...
        <p>
          Let's consider a real-world example: determining if a user is old
          enough to vote.
        </p>
        <pre>
          <code>
...
`}
        ...
        <p>
          ...
          <code>else if</code> statement allows you to specify a new condition
          if the previous condition is false, creating a chain of conditions.
        </p>
...
`}
        ...
        <p>
          Let's apply this to another real-world example: classifying a number
...
`}
        ...
        <p>
          In this case, depending on the value of <code>number</code>, one of
          the messages "The number is positive.", "The number is negative.", or
          "The number is zero." will be displayed.
        </p>

        <h2>switch Statements</h2>
        <p>
          The <code>switch</code> statement provides another way to handle
          multiple conditions in JavaScript. It's useful when you have a
          variable or expression that can have different values, and you want to
          execute different blocks of code based on those values.
        </p>
...
`}
        ...
        <p>
          The <code>switch</code> statement evaluates the{" "}
          <code>expression</code> and executes the code block associated with
          the first matching <code>case</code>. If no matches are found, it
          executes the code in the <code>default</code> block.
        </p>
        <p>
          Let's illustrate this with an example: displaying a message based on
          the day of the week.
        </p>
        <pre>
          <code>
...
`}
        ...
        <p>
          ...
          <code>day</code> is set to <code>'Monday'</code>, the message "Start
          of the work week." is printed.
        </p>
        <p>
        ...
        <ul>
          <li>
            ...
            statement. It evaluates the <code>expression</code> and compares it
            to the values in the <code>case</code> statements.
          </li>
          <li>
            <b>case value1:</b> This is the first case in the switch statement.
            If the evaluated <code>expression</code> matches the{" "}
            <code>value1</code>, the code block below it is executed.
          </li>
          <li>
            <b>break;</b> This statement is used to break out of the switch
            statement. If the <code>expression</code> matches a{" "}
            <code>case</code>, the code below it is executed until a{" "}
            <code>break</code> statement is encountered. This prevents the code
        ...
        <p>
          Remember to always include a <code>break</code> statement after the
          code block of each <code>case</code> to prevent the code from falling
        ...
        <ul>
          ...
          <li>
            <b>Color Determination:</b> Determine the color of an object based
            on its RGB values.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <b>Website Navigation:</b> Conditionally display different content
            or navigation options based on user roles or preferences.
          </li>
          <li>
            <b>Game Development:</b> Implement game logic using conditional
            statements to handle different game states, such as checking for
            wins or losses.
          </li>
        </ul>
        ...
        <p>
          ...
          create dynamic and responsive applications. They allow us to control
          the flow of our programs based on various conditions.
        </p>
        <p>
          Practice using these statements in your own projects to become more
          familiar with their usage. Experiment with different conditions and
          see how they affect the behavior of your code. The more you practice,
          the more comfortable you'll become with JavaScript's conditional
          statements.
        </p>
