    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          tricks is to add two numbers together. After the robot adds the
          numbers, it can give you the result. This is similar to how functions
          can return values in JavaScript.
        </p>
        <p>
        ...
        <p>
          ...
          statement. Let's look at an example where our robot adds two numbers
...
function addNumbers(a, b) {
  ...
  return sum;
        ...
        <p>
          ...
          use the result in other parts of our code. Let's see how we can use
          the returned value:
        </p>
        <pre>
          <code>
...
console.log(result); // Output: 8
        ...
        <p>
          ...
          length of a toy car, and the robot tells you the length is 10 cm.
          Here, the robot has performed a task (measuring) and returned a value
          (10 cm).
        </p>
        <p>
          In JavaScript, functions can perform tasks and return values in a
          similar way. The <code>return</code> statement allows a function to
          send a result back to where it was called.
        </p>
...
console.log(isEven(10)); // Output: true
        ...
        <p>
          ...
          statement, we can perform operations in functions and use the results
        ...
        <p>
          Practice creating functions that return different types of values to
          get comfortable with this essential concept in JavaScript!
        </p>
