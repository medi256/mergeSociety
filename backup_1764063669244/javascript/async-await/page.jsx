    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          <code>async</code> and <code>await</code>. They work together to
          handle asynchronous operations in a cleaner and more readable way than
...
async function fetchData() {
  ...
  return data;
        ...
        <p>
          In this example, <code>fetchData</code> is an async function. Inside
          it, we use <code>await</code> to pause the execution until the promise
          is resolved. Once resolved, the function returns the data.
        </p>

        <h2>Using Async/Await with Error Handling</h2>
        <p>
          You can use <code>try</code> and <code>catch</code> blocks to handle
          errors when using async/await. This makes it easy to manage errors in
...
getData(); // Call the function to see the result
        ...
        <p>
          ...
          function, <code>getData</code> uses <code>await</code> to wait for it
          to finish before logging the result.
        </p>
