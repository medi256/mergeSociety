    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          asterisk (*) character and can be used to apply styles globally. In
          this section, we'll explore the wonderful world of the universal
          selector and learn how to use it effectively in your CSS designs.
          Let's begin!
        </p>
        ...
        <p>
          ...
          matches all elements within the document. It allows you to apply
          styles that affect every element, regardless of their type or
...
* {
  color: blue; /* Sets the color of all elements to blue */
        ...
        <h3>Global Styles</h3>
        <p>
          The universal selector is useful for applying global styles that
          affect all elements on the page. This can include setting font styles,
...
* {
  ...
  padding: 0; /* Removes padding from all elements */
        ...
        <p>
          ...
          done to ensure consistency and avoid browser inconsistencies. Here's
          an example:
        </p>
...
* {
  ...
  border: none; /* Removes borders from all elements */
        ...
        <p>
          ...
          selectors to apply styles to specific elements while still targeting
          all elements on the page. Here's an example:
        </p>
...
* .highlight {
  background-color: yellow; /* Adds a yellow background to all elements with the "highlight" class */
        ...
        <p>
          Using the universal selector offers several advantages for your
          designs:
        </p>

        <ul>
          <li>
            <strong>Global Styling:</strong> The universal selector allows you
            to apply styles consistently across all elements on the page,
          ...
          <li>
            ...
            selector with other selectors, you can achieve a fine level of
            control over the specificity of your styles.
          </li>
        </ul>
        ...
        <ul>
          <li>
            ...
            targets all elements, which can lead to unintended consequences if
            not used carefully. It's important to be mindful of its impact on
            the entire page.
          </li>
          <li>
        ...
        <p>
          ...
          your code editor and create a new HTML file. Let's explore the
          wonderful world of the universal selector:
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            styles, colors, or margins, and observe how it affects all elements
            on the page.
          </li>
          <li>
            Experiment with combining the universal selector with other
            selectors, such as class or ID selectors, to create more specific
            styles.
          </li>
          <li>
