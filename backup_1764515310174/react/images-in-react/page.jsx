    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          understand, like where to place your images, how to import them, and
          how to display them inside your components. Let's walk through
        ...
        <ul>
          <li>
            ...
            like images, that won’t change as your application runs. Images
            placed here can be accessed directly from the HTML file.
          </li>
          <li>
            <strong>The src folder:</strong> This folder is where you write your
            components and logic. Images placed here will need to be imported
            into your components before being used.
          </li>
        </ul>

        <h3>Where Should You Store Your Images?</h3>
        <p>
          For most cases, you’ll want to store your images in the{" "}
          <code>src</code> folder, because you’ll likely use them in your
          components.
        </p>

        <h2>2. Adding an Image to Your Project</h2>
        <p>
          To demonstrate how to work with images in React, let's walk through
          the process of adding an image to a component.
        </p>
        ...
        <p>
          In React, to use an image in your JSX code, you first need to import
          it. Here’s how you can import the image into a component:
        </p>
        <pre>
          <code>
...
export default App;`}
        ...
        <ul>
          ...
          <li>
            ...
            <code>&lt;img&gt;</code> tag and set the <code>src</code> attribute
            to the image we imported.
          </li>
          <li>
            <strong>The alt attribute:</strong> This is for accessibility. If
            the image fails to load, the text inside the <code>alt</code>{" "}
            attribute will be shown instead. It’s also helpful for screen
            readers.
          </li>
        </ul>
        ...
        <p>
          ...
          <code>public</code> folder. This is useful when you want your images
          to be available to the browser directly, without having to import them
          in your components.
        </p>
        ...
        <p>
          When you place images in the <code>public</code> folder, you don’t
          need to import them. You can reference them by their URL relative to
          the <code>public</code> folder, like this:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="jsx" style={docco}>
...
export default App;`}
        ...
        <p>
          Sometimes, you might want to display images based on certain
          conditions or data. In these cases, you can use dynamic image paths.
          Here's an example:
        </p>
        <pre>
          <code>
