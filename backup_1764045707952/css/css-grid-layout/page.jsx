    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          Perhaps every time you try to think of a solution, you become tired
          and give up.
        </p>
        <p>
          If so, stay tuned as I reveal a new method for resolving these kinds
          of problems with minimal or no stress.
        </p>
        ...
        <p>
          First we'll learn what CSS Grid is and what it's meant to do. Then
          we'll go through the features of CSS grid, reasons why we should study
          it, and the benefits it brings to our projects. Finally, we'll discuss
        ...
        <p>
          ...
          responsive items on the web. The Grid items are arranged in columns,
          and you can easily position rows without having to mess around with
          the HTML code.
        </p>
        ...
        <p>
          The CSS grid makes your markup cleaner (in your HTML code) and gives
          you a lot more flexibility. This is partly because you don’t have to
          change the markup (HTML code) to change the position of an item using
          the CSS grid.
        </p>
        ...
        <p>
          ...
          By using the CSS grid gap property, the spacing of two elements is
          much easier than using the CSS margin and padding properties which
        ...
        <p>
          ...
          implement the CSS grid container property by setting the container to
          a display property of grid or in-line grid.
        </p>
...
grid-template-rows: 50px 50px;
        ...
        <p>
          The code above shows that we have a total of two rows and those two
          rows are 50px high.
        </p>

        <p>
          Note that we can also assign the column and row property to our HTML
          code at once by simply using grid-template. Grid-template is another
          way of representing the grid-template column and grid-template-row.
        </p>
...
grid-template: 50px 50px / 100px auto 100px;
        ...
        <p>
          To use the grid-template property, you will have to assign the value
          to the row first before assigning the column's value, just like the
...
column-gap: 20px;
        ...
        <p>
          From the code above, you can see that a gap of 20px was assigned to
          the column.
        </p>
...
justify-content: center;
        ...
        <h2>Space-around</h2>
        <p>
          This property distributes the items in the container evenly, where
          each item in the container has an equal amount of space from the next
          container.
        </p>
...
justify-content: space-around;
        ...
        <h2>Space-between</h2>
        <p>
          Just like the space-around property, space-between distributes the
          items in the container evenly, where each item in the container has an
          equal amount of space from the next one in the container. It takes up
...
align-content: space-around;
        ...
        <p>
          Just like the space-around property, Space-between distributes the
          items in the container evenly, where each item in the container has an
          equal amount of space from the next one in the container, and takes up
          the entire width of the container in the vertical direction.
        </p>
...
align-content: space-evenly;
        ...
        <h2>Conclusion</h2>
        <p>
          In today's article, we studied what CSS Grid Layout is all about, why
          we should learn it, and the properties of CSS grid.
        </p>
