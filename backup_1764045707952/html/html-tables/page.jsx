  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Hello there! In this lesson, we'll be exploring tables - a powerful
          tool for presenting structured data in a tabular format. Tables allow
          you to organize and display data in rows and columns, making it easier
          for users to understand and compare information. Let's dive into the
          world of tables in HTML and learn how to create and customize tables
          effectively.
        </p>

        <h2>Creating a Basic Table in HTML</h2>
        <p>
          In HTML, tables are created using the <code>{`<table>`}</code> tag.
          The <code>{`<table>`}</code>
  ...
  <thead>
    ...
    `}
        ...
        <p>
          ...
          headers of the table. They are typically bold or highlighted to
          indicate their importance. Table rows <code>{`(<tr>)`}</code> contain
          the individual rows of data, and table cells
...
<table>
    ...
    <tbody>
        ...
        <p>
          ...
          <code>{`<th>`}</code>, and
          <code>{`<td>`}</code>, you can apply styles such as borders,
          background colors, padding, and more.
        </p>
        ...
        <ul>
          <li>
            <strong>Use tables for structured data:</strong> Tables are ideal
            for presenting data that can be logically organized into rows and
            columns, such as lists, statistics, or product information.
          </li>
          <li>
            <strong>
          ...
          <li>
            <strong>
              Use <code>{`<th>`}</code> for headers and <code>{`<td>`}</code>{" "}
              for cells:
            </strong>
          ...
          <li>
            <strong>Keep tables semantic:</strong> Use tables only for
            presenting structured data. Avoid using tables for layout purposes.
        ...
        <p>
          ...
          create a new HTML file. Experiment with creating tables, adding
          headers, rows, and cells, and customizing their appearance using
          attributes. Here's a simple exercise to get you started:
        </p>

        <ol>
          <li>
            Create a new HTML file and save it as "tables.html" in your
            workspace folder.
          </li>
          <li>
     ...
     <tbody>
         ...
         <tr>
          ...
          <li>
            ...
            "border," "cellpadding," or "cellspacing." For instance, you can add
            a border around the table or adjust the spacing between cells.
          </li>
        </ol>
        ...
        <p>
          ...
          presenting structured data in a clear and organized manner. Remember
          to use tables wisely, follow best practices, and always test your HTML
          code to ensure your tables render correctly in different browsers and
          devices. In the next lesson, we'll move on to semantic HTML. Stay
