...
alert("Form submitted successfully!");
        ...
        <p>
          ...
          successfully!" will appear. The user will need to click OK to
          continue.
        </p>
        ...
        <p>
          The <code>confirm</code> method shows a pop-up box with a message, an
          OK button, and a Cancel button. It’s used to ask the user for
        ...
        <p>
          <strong>Explanation:</strong> The <code>confirm</code> method takes
          one argument, <code>message</code>, which is the text you want to
          display in the confirmation box. It returns <code>true</code> if the
          user clicks OK and <code>false</code> if they click Cancel.
        </p>
        <p>
...
alert("Action cancelled.");
        ...
        <p>
          The <code>prompt</code> method shows a pop-up box that asks the user
          for input. It includes a message, a text input field, an OK button,
          and a Cancel button.
        </p>
        <p>
          <strong>Syntax:</strong>
        ...
        <p>
          ...
          arguments: <code>message</code>, which is the text you want to show,
          and <code>defaultValue</code> (optional), which is the text that
          appears in the input field by default. It returns the text entered by
          the user if they click OK, or <code>null</code> if they click Cancel.
        </p>
...
alert("No name entered.");
        ...
        <p>
          ...
          If they provide a name and click OK, a greeting will appear with their
