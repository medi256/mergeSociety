    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          Think of them like a quick shortcut for writing functions. They help
          you write less code and make your code look neat.
        </p>

        <h3>Traditional Function Syntax</h3>
        <p>
          Before we dive into arrow functions, let’s look at a basic example of
...
const sayHello = name => 'Hello, ' + name + '!';
        ...
        <ul>
          <li>
            ...
            parentheses <code>(name)</code>. If there’s only one parameter, we
            can leave out the parentheses. For example,{" "}
          ...
          <li>
            <strong>Body:</strong> If the function only has a single line of
            code, we don’t need curly braces <code>{}</code> or the{" "}
            <code>return</code> keyword. The result of the single line is
...
console.log(greetUser('Alice')); // Output: Welcome, Alice!
        ...
        <p>
          This function takes one input, <code>name</code>, and returns a
          greeting message that includes the name. It’s another simple example
          where the function is written in a compact form.
        </p>
...
console.log(isEven(7)); // Output: false
        ...
        <p>
          ...
          <code>true</code> if the number is even, and <code>false</code> if it
          is not. The arrow function makes it easy to perform this check in a
        ...
        <p>
          ...
          JavaScript. They help you write less code and keep your functions
          clean and readable. Remember, if your function only has a single line
          of code, you can write it in a shorter form without curly braces and{" "}
        ...
        <p>
          ...
          with them. They are a valuable tool in JavaScript and can help you
