    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          explore how to efficiently deploy your React applications using
        ...
        <p>
          ...
          available for deploying your React application. Each option provides
          its own set of tools and capabilities, simplifying the process of
          making your application accessible by handling server setup, scaling,
          and maintenance.
        </p>
        ...
        <ul>
          <li>
            ...
            seamless way to deploy your React application, handling server
            setup, scaling, and maintenance, allowing you to focus on building
            your application.
          </li>
          <li>
          ...
          <li>
            <strong>Custom Domains:</strong> They allow you to use custom
            domains, enhancing the professionalism and personalization of your
            project.
          </li>
        </ul>
        ...
        <ol>
          <li>
            <strong>Netlify:</strong> A widely used platform for deploying
            static sites and web applications, offering features like continuous
        ...
        <ol>
          <li>
            <strong>Stop the Live Server:</strong> If your live server is
            running in VSCode, stop it. This ensures there are no issues while
          ...
          <li>
            ...
            <code>npm run build</code>, a new folder named <code>build</code>{" "}
            will appear in your project directory. This folder contains all the
            necessary files for deployment, including HTML, CSS, JavaScript, and
            other assets. You can think of this folder as a self-contained
            version of your application, ready to be uploaded to a web server.
          </li>
        </ol>
        ...
        <ol>
          ...
          <li>
            <strong>Drag and Drop the Build Folder:</strong> After logging in,
            go to the "Sites" page and click on "New site from Git." Ignore the
          ...
          <li>
            <strong>Configure Settings:</strong> Netlify will automatically
            start deploying your site. You can configure additional settings
            such as custom domains and continuous deployment. Custom domains
            allow you to use a personalized URL for your site, enhancing its
            professionalism. Continuous deployment ensures that your site is
            automatically updated whenever you make changes to your source code.
          </li>
          <li>
            ...
            your deployed React application using this URL. You can also
            customize the URL by configuring a custom domain in the Netlify
            dashboard.
          </li>
        </ol>
        ...
        <ol>
          <li>
            ...
            <a href="https://vercel.com/">Vercel</a> and sign up for an account
            if you don't already have one. You can sign up using your email
            address or by connecting your GitHub, GitLab, or Bitbucket account.
            Once signed up, log in to your account.
          </li>
          <li>
            <strong>Drag and Drop the Build Folder:</strong> After logging in,
            go to the "Import Project" page. Instead of using Git integration,
            drag and drop the <code>build</code> folder into the Vercel
            interface. Vercel will automatically detect your build folder and
          ...
          <li>
            ...
            custom domains and continuous deployment. Custom domains allow you
            to use a personalized URL for your site, enhancing its
            professionalism. Continuous deployment ensures that your site is
            automatically updated whenever you make changes to your source code.
          </li>
          <li>
            <strong>Access Your Deployed Site:</strong> Once the deployment is
            complete, Vercel will provide a URL for your site. You can access
            your deployed React application using this URL. You can also
            customize the URL by configuring a custom domain in the Vercel
            dashboard.
          </li>
        </ol>
        ...
        <ol>
          <li>
            ...
            GitHub username is <code>username</code> and your repository is
            named <code>my-react-app</code>, the URL for your deployed site will
            be <code>https://username.github.io/my-react-app</code>.
          </li>
          <li>
            ...
            contents of the <code>build</code> folder (not the folder itself,
            but its contents) into the repository. Commit the changes by
            providing a commit message and clicking "Commit changes."
          </li>
          <li>
            <strong>Configure GitHub Pages:</strong> In your repository
            settings, scroll down to the "GitHub Pages" section. Here, you can
            select the branch and directory you want to deploy from. Select the{" "}
        ...
        <ul>
          ...
          <li>
            ...
            GitHub repository, making it a great choice for open-source
            projects, documentation, or personal websites.
          </li>
          <li>
            Each deployment option has its own set of features and capabilities.
            Choose the option that best suits your project requirements and
            needs.
          </li>
        </ul>
        <p>
          Deploying your React application is an important step towards making
          it accessible to users. By choosing the right deployment option, you
          can ensure a seamless and scalable deployment process.
        </p>

        <Button whereToGo={"/projects"} />
      </div>
    </div>
  );
};
