  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          CSS filters are a set of visual effects that can be applied to
          elements in your webpage to alter their appearance. These effects can
          be used to enhance images, create interesting backgrounds, and add a
          touch of creativity to your design.
        </p>
        ...
        <p>
          Using CSS filters can enhance the visual appeal of your webpage and
          make it more engaging for users. Filters can be used to create
          stunning backgrounds, add depth to images, and highlight important
          content.
        </p>
        ...
        <p>
          ...
          used to create artistic effects, simulate depth and texture, and
          improve the overall design aesthetic.
        </p>
...
.image {
  filter: grayscale(100%);
        ...
        <p>
          ...
          element. You can specify a percentage value to increase or decrease
          the brightness.
        </p>
        <pre>
          <code>
...
.image {
  filter: brightness(150%);
        ...
        <h3>contrast()</h3>
        <p>
          The <code>contrast()</code> filter adjusts the contrast of the
          element. You can specify a percentage value to increase or decrease
          the contrast.
        </p>
        <pre>
