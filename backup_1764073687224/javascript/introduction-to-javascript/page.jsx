    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          versatile and powerful programming language that serves as the
          backbone of modern web development. It is one of the core technologies
          of the World Wide Web, alongside HTML and CSS. With JavaScript,
          developers can create dynamic, interactive, and immersive web
        ...
        <p>
          ...
          JavaScript is more than just a scripting language; it is a
          full-fledged programming language with a rich set of features and
          capabilities.
        </p>
        ...
        <p>
          ...
          Netscape Communications Corporation. Initially developed in just 10
          days under the name Mocha, it was later renamed to LiveScript and
          finally to JavaScript. The name "JavaScript" is a bit misleading, as
          the language has little to do with Java. It was chosen for marketing
          reasons, and the language quickly gained popularity.
        </p>
        <p>
          Since its inception, JavaScript has evolved significantly. It has
          grown from a simple scripting language to a powerful, feature-rich
          programming language. The language continues to evolve, with regular
          updates and new features added to keep it modern and efficient. The
          latest version, ECMAScript 2022, introduces exciting new capabilities
          that further enhance the language's versatility.
        </p>
        ...
        <p>
          ...
          front-end and back-end development, simplifying the development
          process.
        </p>
        ...
        <p>
          Or consider a dynamic news website where new articles are loaded as
          the user scrolls down the page. JavaScript can fetch the additional
          content from the server and update the webpage without requiring a
          full page reload. This creates a seamless and responsive browsing
          experience.
        </p>

        <h2>Getting Started with JavaScript</h2>
        <p>
          As you embark on your JavaScript journey, you'll start with the
