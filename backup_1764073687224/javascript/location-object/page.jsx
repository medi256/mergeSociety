  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          The Location object is a part of the BOM that represents the current
          URL of the webpage. It provides information about the URL, such as the
          protocol, hostname, pathname, and more. The Location object also
          allows you to manipulate the URL, which can be useful for navigating
        ...
        <p>
          ...
          you're accessing the Location object associated with the current
          browser window or tab. This is why we often use the syntax{" "}
        ...
        <ul>
          <li>
            ...
            webpage, including the protocol, hostname, pathname, and query
            string.
          </li>
          <li>
            <code>protocol</code>: This property returns the protocol part of
            the URL, such as "http:" or "https:".
          </li>
          <li>
            <code>hostname</code>: This property returns the hostname part of
            the URL, such as "www.example.com".
          </li>
          <li>
            <code>pathname</code>: This property returns the pathname part of
            the URL, such as "/path/to/page".
          </li>
          <li>
          ...
          <li>
            <code>hash</code>: This property returns the fragment identifier
            part of the URL, such as "#anchor".
          </li>
        </ul>
        <p>
        ...
        <ul>
          ...
          <li>
            <code>reload()</code>: This method reloads the current URL, which
            can be useful for updating the page after making changes.
          </li>
        </ul>
        <p>
        ...
        <p>
          Let's see some examples of how we can use the Location object. We'll
          use JavaScript code to get information about the current URL and to
...
// window.location.reload();
        ...
        <p>
          ...
          Location object to get information about the current URL. Uncomment
          the lines with <code>window.location.assign</code>,{" "}
        ...
        <p>
          ...
          to manipulate the URL and navigate between pages. The Location object
          is an important part of the BOM, and understanding how to use it can
          help you build more dynamic and interactive web applications.
        </p>
        <p>
