...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dgyofctwi/image/upload/v1762771676/best_apps_iraybe_a7fwyd.jpg",
        width: 1200,
        height: 630,
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <figure className="blog-image">
          <img
            src="https://res.cloudinary.com/dgyofctwi/image/upload/v1762771676/best_apps_iraybe_a7fwyd.jpg"
