    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          toolbox. If it needs a tool that isn't in its toolbox, it won't be
          able to find or use it.
        </p>
        <p>
        ...
        <h2>Global Scope</h2>
        <p>
          A variable declared in the global scope is like a tool that's
          available to every robot in your house. Any function or code block in
          your program can access this variable. Let's look at an example:
        </p>
        <pre>
          <code>
...
fixRobot(); // Output: Using: Wrench
        ...
        <p>
          ...
          global scope. The function <code>fixRobot</code> can access and use
          the <code>tool</code> variable because it's globally available.
        </p>
        <p>
          Another way to think about global scope is to imagine a classroom
          where the teacher writes important information on the whiteboard. All
          students in the class can see and use the information on the
          whiteboard. Similarly, globally scoped variables are available to all
        ...
        <p>
          ...
          can't be accessed from outside the robot. These variables are said to
          be in the local scope.
        </p>
...
console.log(tool); // Error: tool is not defined
        ...
        <p>
          ...
          available to that student. Similarly, locally scoped variables are
          only available within the function they are declared in.
        </p>
...
upgradeRobot(); // Output: Upgrading with: Welding Torch
        ...
        <p>
          In this example, both functions have a variable named{" "}
          <code>tool</code> in their local scope. Each function uses its own{" "}
          <code>tool</code> without any conflicts because they are scoped
          locally.
        </p>
        <p>
        ...
        <p>
          Sometimes, you may have functions inside other functions. This is
          called nested functions. In such cases, the inner function can access
          variables from its own scope as well as the outer function's scope.
        </p>
...
outerFunction();
        ...
        <p>
          ...
          cannot access <code>innerTool</code> because it's only available
          within <code>innerFunction</code>'s local scope.
        </p>
        <p>
          To continue with our classroom analogy, imagine the teacher has a
          special notepad that only they can access. If the teacher writes a
          note in this notepad, only they can see and use it. However, if the
          teacher shares this note with a student, the student can also see and
          use it. Similarly, nested functions can access variables from their
          own scope and the scope of the function they are nested within.
        </p>
        ...
        <p>
          Keep practicing with different scenarios to get a solid grasp of
          scope. As you write more JavaScript code, understanding scope will
