    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          to display this data on our webpage. To make it simple, we'll use a
          fun and easy API: the Dog CEO's Dog API, which gives us random dog
          images. Imagine it like having a magic box that gives you a new dog
          picture every time you ask for it!
        </p>
        ...
        <p>
          First, let’s set up a basic HTML file. This file will contain a place
          to show our dog image. Think of this like setting up a blank photo
          frame where we will put our picture later.
        </p>
        <pre>
          <code>
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>Display Data with JavaScript:</strong> Once we have the
            data, we update our HTML elements to show this data. This makes our
            webpage dynamic and interactive.
          </li>
        </ul>
        <p>
          With these skills, you can now fetch and display data from APIs,
          making your web pages more engaging and responsive to real-time
          information.
        </p>
        <h2>7. Practice Challenge</h2>
        <p>
          Try using a different API to fetch and display other types of data,
          such as random quotes or fun facts. This will help you get comfortable
          with working with different kinds of data and APIs.
        </p>
