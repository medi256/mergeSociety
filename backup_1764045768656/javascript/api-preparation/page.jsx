  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          APIs come in different shapes and sizes. Just like there are many
          types of tools in a toolbox, there are various types of APIs depending
          on how and where they are used. Let’s explore the most common types
          and how they might come into play in your projects.
        </p>
        ...
        <p>
          <strong>Real-world example:</strong> Think of Web APIs like a waiter
          at a restaurant. You tell the waiter what you want, and they go to the
        ...
        <ul>
          <li>
            <strong>Library APIs:</strong> Think of these as specialized tools
            or gadgets within a toolbox. When you use a library like React or
            jQuery, these libraries come with their own set of APIs to help you
            build specific features. For example, React’s API helps you manage
            your app’s user interface.
          </li>
          <li>
            <strong>Operating System APIs:</strong> These are like the basic
            instructions your computer needs to work with apps. They let
            programs interact with your operating system (like Windows or
            macOS). For example, if a program needs to access your camera or
            files, it uses the Operating System API to do so.
          </li>
        </ul>

        <p>
          For now, we’ll keep our focus on Web APIs, as they are the most
          relevant for building web apps.
        </p>

        <h2>2. Who Creates APIs? (Free vs. Paid)</h2>
        <p>
          APIs are created by developers or companies who want to share their
          data or services with others. Some of these APIs are free, while
          others come with a cost. Let’s break it down:
        </p>

        <h3>Free APIs</h3>
        <p>
          Many APIs are free to use, which is great for getting started.
          However, even free APIs often have some limits on how much you can use
          them. Think of it like having a free membership to a gym but only
          being allowed to work out a few times each month.
        </p>

        <p>
          <strong>Example:</strong> The <strong>OpenWeather API</strong> is a
          free API that provides weather data. You can use it to get the current
          weather or forecasts for different locations. But if you need to make
          a lot of requests quickly, you might hit a limit and need to upgrade
          to a paid plan.
        </p>
        ...
        <p>
          ...
          offer more advanced features or higher usage limits. Think of this
          like a premium gym membership that gives you access to special classes
          or equipment.
        </p>

        <p>
          <strong>Example:</strong> <strong>Stripe</strong> is a popular API for
          handling online payments. If you’re building an e-commerce site and
          want to accept payments, Stripe provides the tools you need. However,
          it charges fees based on the number of transactions or other usage.
        </p>
        ...
        <p>
          ...
          requests to get data. Think of it like a house address where you send
          a letter. To get data from an API, you need to send your request to
          the right endpoint address.
        </p>

        <p>
          <strong>Example:</strong> Imagine you want to get weather data from
          the OpenWeather API. You’d send your request to this endpoint address:
        </p>
        ...
        <p>
          API providers give you a list of endpoints in their documentation.
          Each endpoint serves a specific purpose, such as getting weather data,
          searching for movies, or retrieving user information.
        </p>

        <h2>4. What is an API Key?</h2>
        <p>
          An API key is like a secret password or a VIP pass that lets you
          access an API. Even if an API is free, you often need to sign up and
          get an API key. This key helps the API provider track who is using
          their service and how much they’re using it.
        </p>

        <p>
          <strong>Imagine it like this:</strong> If you want to enter an
          exclusive event, you need an invitation or a special ticket.
          Similarly, an API key is your “invitation” to use the API’s features.
        </p>

        <p>
          <strong>Why do APIs use keys?</strong> API keys help control access
          and prevent misuse. They ensure that no single user overwhelms the API
          with too many requests, which could slow down or disrupt the service
          for everyone else.
        </p>
        ...
        <ul>
          <li>
            <strong>Endpoints:</strong> The different addresses (URLs) you can
            use to get specific types of data.
          </li>
          <li>
            <strong>Parameters:</strong> The extra pieces of information you
            need to include in your requests, like the city name for weather
            data.
          </li>
          <li>
        ...
        <p>
          ...
          documentation will show you how to request weather data, what
          parameters you need (like city or coordinates), and what the response
          will look like.
        </p>

        <h2>6. Practical Example (Introducing Fetch)</h2>
        <p>
          Now that you understand the basics, it’s time to see how this all
          comes together in code. We’ll use the <strong>fetch</strong> method in
        ...
        <ul>
          <li>
            There are different types of APIs, with Web APIs being the most
          ...
          <li>
            Endpoints are specific addresses where you send requests to get
            data.
          </li>
