  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Imagine you’re at a restaurant. You (the customer) look at the menu
          and decide what you want to order. However, you don’t go into the
          kitchen to make the food yourself. Instead, you tell the waiter (the
          messenger) your order. The waiter then takes your request to the
          kitchen, where the chefs prepare your meal. Once the meal is ready,
        ...
        <p>
          In the digital world, APIs help different software systems
          communicate. For example, when you use an app on your phone to check
          the weather, that app doesn't store all the weather data itself.
          Instead, it sends a request to a weather service through an API. The
          weather service processes the request and sends the weather
        ...
        <p>
          ...
          to know how the weather service works or where the data comes from.
          All you care about is that you get the weather information you
          requested, and the API handles all the behind-the-scenes work.
        </p>
        ...
        <p>
          ...
          need to know how to communicate directly with every other service,
          which would be extremely difficult and inefficient. APIs provide a{" "}
          <strong>standard way</strong> for applications to talk to each other,
          just like the waiter provides a standard way for you to communicate
          with the kitchen in a restaurant.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            reused by many different applications. For example, a weather API
            can be used by hundreds of different apps to display weather
            information.
          </li>
          <li>
            ...
            scratch. For instance, instead of building a whole payment system,
            an app might use a payment API like PayPal or Stripe.
          </li>
          <li>
        ...
        <p>
          Many websites and apps allow you to log in using your Google or
          Facebook account instead of creating a new username and password. This
          works through an API. When you click "Log in with Google," the app
          sends a request through the Google API to verify your identity. Once
          Google confirms who you are, the app logs you in.
        </p>
        ...
        <p>
          ...
          PayPal’s API, which handles the transaction and sends back
          confirmation that your payment was successful.
        </p>

        <h3>4. Maps and Location Services</h3>
        <p>
          If you’ve ever used Google Maps or Uber, you’ve interacted with an
          API. When you search for a location, the app sends a request to a
          mapping API, which finds the location data and sends it back to the
          app. You just see the result, but behind the scenes, the API is making
          sure the app gets the information it needs.
        </p>
        ...
        <p>
          ...
          everything from social media platforms to online shopping, weather
          apps, and more. While you don’t always see them, they’re constantly
          working in the background, making sure that different systems can
        ...
        <ul>
          ...
          <li>
            <strong>They make things simpler</strong> for developers by
            providing a standard way to request and send information.
          </li>
          <li>
            <strong>We use APIs all the time</strong> when we log in to apps,
            make online payments, or use social media.{" "}
          </li>
        </ul>

        <p>
          Now that you understand the basics of what an API is, we’ll soon dive
          into how to use them in your code to fetch data from different
          services.
        </p>
