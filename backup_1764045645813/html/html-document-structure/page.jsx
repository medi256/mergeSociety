  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Hello there! In this lesson, we'll dive deep into the basic structure
          of an HTML document - the foundation upon which every web page is
          built. We'll explore the <code>{`<!DOCTYPE>`}</code> declaration, the{" "}
        ...
        <p>
          The <code>{`<!DOCTYPE>`}</code> declaration is the very first thing
          that appears in an HTML document. It tells web browsers about the
          version of HTML being used and how the document should be interpreted.
          Here's an example:
        </p>
...
<!DOCTYPE html>
        ...
        <p>
          ...
          browser that we are using HTML5. This declaration is crucial because
          it sets the standards and rules that the browser will follow when
          rendering your HTML document.
        </p>
        ...
        <p>
          ...
          document. It wraps all the other elements and represents the entire
...
<html>
  ...
        ...
        <p>
          The <code>{`<head>`}</code> and <code>{`<body>`}</code> elements are
          two important children of the
        ...
        <ul>
          <li>
            ...
            external resources, and instructions for the web browser. It does
            not contain any visible content on the web page itself. Here's an
            example:
            <pre>
              <code>
                <SyntaxHighlighter language="HTML" style={docco}>
  ...
  <script src="script.js"></script>
        ...
        `}
            ...
            <p>
              ...
              <code>{`<script>`}</code> element to include an external
              JavaScript file.
            </p>
          </li>
          <li>
            ...
            your web page, such as headings, paragraphs, images, forms, and
...
<body>
  ...
  <form>
    ...
    <input type="text" id="name" name="name">
        ...
        <p>
          Now, let's put all the pieces together to create a basic HTML
          document:
        </p>
        <pre>
          <code>
  ...
  <body>
    ...
    <p>This is the main content of my web page.</p>
        ...
        <p>
          ...
          declaration, followed by the <code>{`<html>`}</code> element. Within
          the <code>{`<html>`}</code> element, we have the
        ...
        <ul>
          <li>
            ...
            declaration to ensure consistent rendering across different
            browsers.
          </li>
          <li>
          ...
          <li>
            ...
            tags, such as character encoding, viewport settings, and keywords
            for search engines.
          </li>
        </ul>
        ...
        <h2>Practice Time!</h2>
        <p>
          Now, {` let's `} put your knowledge into practice! Open your code
          editor and create a new HTML file. Experiment with creating basic HTML
        ...
        <ol>
          ...
          <li>
            ...
            <code>{`<head>`}</code> element to set a meaningful title for your
            web page.
          </li>
          <li>
            Add content to the <code>{`<body>`}</code> element, such as
            headings, paragraphs, images, forms, or other elements. Feel free to
            be creative!
          </li>
        </ol>
        ...
        <p>
          ...
          <code>{`<body>`}</code>
          elements. Understanding and implementing this structure is essential
          for creating well-formed and accessible HTML documents. Remember to
          follow best practices, test your code across different browsers, and
          always consider the user experience when designing your web pages. In
          the next lesson, we'll continue our journey by exploring buttons in
          HTML. Stay tuned, and happy coding!
        </p>
