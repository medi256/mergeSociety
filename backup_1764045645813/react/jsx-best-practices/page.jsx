  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          In JSX, every component must return a single element. This doesn’t
          mean you can only have one HTML element, but that all your HTML
          elements must be wrapped in one “parent” container.
        </p>
        <p>
          For example, if you try to return two sibling elements without a
          parent container, you will get an error:
        </p>
...
`}
        ...
        <p>
          For example, you can display a JavaScript variable inside JSX like
          this:
        </p>
...
`}
        ...
        <p>
          ...
          reserved word in JavaScript. Similarly, `onclick` becomes `onClick`,
        ...
        <p>
          ...
          or HTML. In JSX, you use curly braces `{}` and `/* */` to add
          comments.
        </p>
...
`}
        ...
        <p>
          One of the best practices in JSX is to keep your code clean and easy
          to read. Break long lines into multiple lines to make your code easier
          to understand.
        </p>
        <p>
          For example, instead of writing a long JSX element in one line, break
          it into multiple lines like this:
        </p>
...
`}
        ...
        <p>
          ...
          little strange at first, but once you get the hang of it, it will
          become second nature. The most important things to remember are:
        </p>
        <ul>
          <li>Always wrap JSX elements in a single parent container.</li>
          <li>All tags must be properly closed, even self-closing tags.</li>
          <li>
            JSX is case-sensitive—HTML tags are lowercase, while custom
          ...
          <li>
            Write clean, readable code by breaking long lines into multiple
            lines.
          </li>
        </ul>
        ...
        <p>
          Now that you’re familiar with JSX syntax and best practices, let’s
          move on to exploring **Attributes in JSX**. This will help you
          understand how to make your JSX elements more dynamic by adding
          properties like `className`, `src`, `href`, and more.
        </p>
