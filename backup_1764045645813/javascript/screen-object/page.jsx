  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Think of the Screen object as a way to get information about the
          user's screen, which can be useful for designing and developing web
          pages that look great on different devices.
        </p>

        <h2>Properties of the Screen Object</h2>
        <p>
          The Screen object has several properties that provide information
          about the user's screen. Here are some of the most important ones:
        </p>
        <ul>
          <li>
          ...
          <li>
            <code>availWidth</code>: This property returns the width of the
            screen in pixels, minus the width of any toolbars or other features
            that take up space on the screen.
          </li>
          <li>
            <code>colorDepth</code>: This property returns the color depth of
            the screen, which is the number of bits used to represent the color
            of each pixel.
          </li>
          <li>
          ...
          <li>
            <code>pixelDepth</code>: This property returns the pixel depth of
            the screen, which is the number of bits used to represent the color
            of each pixel.
          </li>
          <li>
        ...
        <p>
          These properties can be used to get information about the user's
          screen, which can be useful for designing and developing web pages
          that look great on different devices.
        </p>
...
console.log(screenAvailWidth);
        ...
        <p>
          ...
          and log various properties of the user's screen. Here's what's
        ...
        <ul>
          ...
          <li>
            We use <code>screen.width</code> to get the total width of the
            screen in pixels and store it in the <code>screenWidth</code>{" "}
            variable. The value is logged to the console.
          </li>
          <li>
            The <code>screen.colorDepth</code> property returns the number of
            bits used to represent the color of each pixel, and this value is
            stored in the <code>screenColorDepth</code> variable and logged to
            the console.
          </li>
          <li>
        ...
        <p>
          ...
          dynamically. For instance, let's say we want to display the screen
          width inside a paragraph on our webpage.
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="HTML" style={docco}>
...
paragraph.textContent = 'Screen Width:'+ screenWidth +'pixels';
        ...
        <p>
          The Screen object is an important part of the BOM, and understanding
          how to use it can help you design and develop web pages that look
