...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/css/css-units",
  },
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          consistent manner. In this section, we'll explore the fascinating
          world of units in CSS and learn how to use them effectively to style
          your elements. Let's embark on this unit adventure!
        </p>

        <h2>Length Units</h2>
        <p>
          Length units are used to specify sizes, distances, and positions in
          CSS. They provide a way to measure and define various aspects of your
        ...
        <ul>
          <li>
            ...
            digital display. It represents a single dot on the screen. Pixels
            are commonly used for specifying sizes, margins, padding, and
            positions. For example, you can set the width of an element to 300
            pixels to make it 300 pixels wide.
          </li>
          <li>
            <strong>Percentages (%)</strong>: Percentages are relative units
            that are calculated based on the size of another element. They are
            often used for creating responsive designs that scale
            proportionally. For instance, setting the width of an element to 50%
          ...
          <li>
            ...
            relative to the font size of the root element (<code>html</code>).
            It provides a consistent reference point across the entire document.
            For example, setting the margin of an element to 2rem will add a
            margin of 2 times the root font size around the element.
          </li>
        </ul>
...
div {
  ...
  font-size: 1.5rem; /* Sets the font size to 1.5 times the root font size */
        ...
        <p>
          ...
          width, margin, padding, and font size of a div element. Pixels (px)
          provide absolute measurements, while percentages (%) and rems (rem)
          offer relative measurements. By using a combination of these units,
          you can create flexible and responsive designs that adapt to different
          screen sizes and font sizes.
        </p>
        ...
        <ul>
          <li>
            <strong>Seconds (s)</strong>: Represents a single second. For
            example, setting the duration of an animation to 2s will make it
            last for 2 seconds.
          </li>
          <li>
            <strong>Milliseconds (ms)</strong>: Represents a thousandth of a
            second. Milliseconds are commonly used for shorter durations, such
            as 300ms for a subtle transition effect.
          </li>
        </ul>
...
.fade-in {
  transition: opacity 0.5s ease; /* Sets a 0.5-second transition for the opacity property */
        ...
        <p>
          ...
          transition effect. The transition property smoothly changes the
          opacity of the element over 0.5 seconds, creating a fade-in effect.
          You can adjust the duration to control the speed and smoothness of
          your animations.
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            rems, to specify sizes, margins, padding, and font sizes. Observe
            how they affect the layout and appearance of your elements. Try
            using larger and smaller values to see the impact on the design.
          </li>
        </ol>
