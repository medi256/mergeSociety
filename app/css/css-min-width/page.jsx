...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/css/css-min-width",
  },
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Min-width is a powerful property in CSS that allows you to set a
          minimum width for an element. It helps create responsive and flexible
          designs that adapt to different screen sizes. In this section, we'll
          explore the wonderful world of min-width and learn how to use it
        ...
        <p>
          ...
          starts to expand or wrap. It ensures that the element doesn't become
          too narrow, making it useful for creating responsive designs that work
          well on various devices, from small mobile screens to large desktop
...
div {
  min-width: 300px; /* Sets the minimum width to 300 pixels */
        ...
        <p>
          Min-width is commonly used to create responsive layouts and ensure
          that elements don't become too narrow on larger screens. For example,
          you can set a minimum width for a container to prevent it from
          becoming too skinny on wider screens. This helps maintain a balanced
...
.container {
  min-width: 600px; /* Sets the minimum width to 600 pixels */
        ...
        <p>
          ...
          doesn't become too narrow, creating a comfortable viewing experience
          for users. It's especially useful for elements that need to maintain a
          certain width, such as navigation menus or sidebars.
        </p>
        ...
        <ul>
          <li>
            <strong>Responsive Design:</strong> Min-width helps create
          ...
          <li>
            ...
            becoming too narrow and causing content to wrap or become
            unreadable.
          </li>
        </ul>
        ...
        <h2>Practice Time!</h2>
        <p>
          Now it's time to experiment with min-width in CSS! Open your code
        ...
        <ol>
          ...
          <li>
            Apply different min-width values to your elements and observe how
