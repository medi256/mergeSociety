    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          format the layout of web pages. It plays a crucial role in enhancing
          the visual appeal and user experience of websites. Understanding CSS
          syntax is fundamental to creating effective and stylish web
          interfaces.
        </p>

        <h2>Basic Structure of CSS Syntax</h2>
        <p>
          The fundamental structure of CSS syntax involves three main
          components: selectors, properties, and values.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            specific class attribute. Classes are used to style multiple
            elements with the same style rules. For instance,
            <code>.header</code> selects all elements with the class "header".
          </li>
          <li>
            <strong>ID Selectors</strong>: These target elements with a unique
            ID. IDs are used to style specific, individual elements. For
            example,
        ...
        <h3>Properties</h3>
        <p>
          Properties are the characteristics that you want to style or modify
          for the selected elements. Each property defines a specific aspect of
          an element's appearance or behavior. Here are some commonly used
          properties:
        </p>
        <ul>
          <li>
            <strong>Color Properties</strong>: These properties define the color
            of various elements, such as text, backgrounds, and borders.
            Examples include <code>color</code>,<code>background-color</code>,
            and
          ...
          <li>
            ...
            Examples include <code>font-family</code>,<code>font-size</code>,
            and <code>font-weight</code>.
          </li>
          <li>
        ...
        <ul>
          ...
          <li>
            <strong>URL Values</strong>: These values are used to link to
            external resources, such as images or fonts. For example,
...
h1 {
  ...
  text-align: center;
        ...
        <p>
          ...
          <code> {`<h1>`}</code> elements on the page. Inside the curly braces,
          we have two property-value pairs: <code>color: red</code> and
          <code>font-size: 24px</code>. This rule sets the text color of
          <code> {`<h1>`}</code> elements to red and their font size to 24
          pixels.
        </p>
        ...
        <ul>
          ...
          <li>
            <strong>CSS Variables</strong>: Variables allow you to store and
            reuse values throughout your stylesheet, making it easier to
            maintain and update styles.
          </li>
          <li>
        ...
        <p>
          ...
          and techniques that will empower you to create stunning and responsive
          web designs.
        </p>
