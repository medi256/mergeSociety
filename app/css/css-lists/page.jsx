    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          appealing and functional designs. Lists are commonly used for
          presenting information, navigation, content organization, and more. In
          this section, we'll explore the fascinating world of list styling and
          learn how to use CSS to transform your lists into beautiful and
          user-friendly elements. Let's embark on this list styling adventure!
        </p>

        <h2>Understanding List Styling</h2>
        <p>
          List styling involves applying CSS properties to lists, list items,
          and their markers to enhance their appearance and improve the user
          experience. Lists can be styled in numerous ways, including changing
          the marker style, modifying the spacing between list items, adding
          decorative effects, and even creating entirely custom markers. The{" "}
          <code>list-style-type</code> property is one of the key properties
          used for list styling. Let's explore it in depth:
        </p>

        <h3>list-style-type Property</h3>
        <p>
          The <code>list-style-type</code> property allows you to specify the
          type of marker used for list items. It can be applied to both
          unordered lists (<code>ul</code>) and ordered lists (<code>ol</code>).
          Here are some commonly used values for
        ...
        <ul>
          ...
          <li>
            ...
            marker. It is often used for nested lists or to create a more open
            and airy appearance.
          </li>
          <li>
          ...
          <li>
            <strong>lower-alpha:</strong> This value displays lowercase letters
            as markers, starting from a, b, c, and so on. It creates an
            alphabetical list.
          </li>
          <li>
          ...
          <li>
            ...
            items, resulting in a clean and minimalist look. No bullets,
            numbers, or other markers will be displayed, allowing for a seamless
...
ol {
  list-style-type: lower-alpha; /* Changes the marker style to lowercase letters */
        ...
        <p>
          Experiment with the various values to see how they are displayed in
          your browser.
        </p>
        ...
        <p>
          ...
          properties that can be used to style lists, such as{" "}
          <code>padding</code>, <code>margin</code>, and
          <code>list-style-image</code>. Let's explore some of these properties:
        </p>

        <h3>Padding and Margin</h3>
        <p>
          Padding and margin can be used to adjust the spacing around list
          items. Padding controls the space inside the list item, while margin
          controls the space outside the list item. These properties can be used
          to create indentation, add breathing room between list items, and
          improve the overall layout of your lists.
        </p>
...
li {
  ...
  margin-bottom: 10px; /* Adds bottom margin for spacing between list items */
        ...
        <p>
          The <code>list-style-image</code> property allows you to use an image
          as the marker for list items. This property can be used to create
          unique and custom list styles. Here's an example:
        </p>
...
ul {
  list-style-image: url('custom-marker.png'); /* Uses an image as the marker */
        ...
        <p>
          In the code above, we used the <code>list-style-image</code> property
          to specify a custom image as the marker for the unordered list. You
          can replace 'custom-marker.png' with the path to your own image file.
        </p>
        <h3>Note</h3>
        <p>
          The same way we uploaded images to our background-image is the way we
          do it for the list-style-type. You just need a URL.
        </p>
        ...
        <ul>
          <li>
            <strong>Visual Appeal:</strong> List styling allows you to enhance
            the appearance of your lists, making them more visually appealing
            and engaging. You can experiment with different marker styles,
            colors, and spacing options to create lists that complement your
            overall design aesthetic.
          </li>
          <li>
            <strong>Readability:</strong> Proper list styling improves
            readability by providing clear markers, adequate spacing, and a
            well-organized layout. This makes it easier for users to scan and
            understand the information presented in the list.
          </li>
          <li>
            <strong>User Experience:</strong> List styling can greatly improve
            the user experience. Well-styled lists guide users through content,
        ...
        <ol>
          <li>
            ...
            ) and ordered lists (<code>ol</code>) to serve as containers for
            your list styling experiments.
          </li>
          <li>
          ...
          <li>
            Experiment with padding and margin to adjust the spacing between
            list items and create a visually balanced layout. Try using
            different values for each side to achieve the desired indentation
            and spacing.
          </li>
          <li>
            Explore the <code>list-style-image</code> property to use custom
            images as markers. Play with different image options to create
            unique and creative lists.
          </li>
          <li>
            ...
            adding interactive effects, or using pseudo-classes to style
            specific list items.
          </li>
        </ol>
