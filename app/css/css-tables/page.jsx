...
td {
  border: 1px solid #ddd; /* Adds borders to table cells */
      ...
      <p>
        The tr:nth-child(even) selector is used to target and style every other
        row in a table. This selector allows you to apply styles to alternating
        rows, creating a striped or zebra-striped effect. Here's an example:
      </p>
...
tr:nth-child(even) {
  background-color: #eee; /* Adds a background color to every other row */
      ...
      <ul>
        ...
        <li>
          **`odd`:** Target all odd-numbered rows, similar to how `even` works.
        </li>
      </ul>
