...
.container {
  ...
  flex-direction: column; /* Arranges items in a column */
      ...
      <p>
        ...
        not enough space. It can have values like <code>nowrap</code> (default),{" "}
        <code>wrap</code>,<code>wrap-reverse</code>, and <code>initial</code>.
        Here's an example:
      </p>
...
.container {
  ...
  flex-wrap: wrap; /* Makes items wrap to new lines */
      ...
      <p>
        In the code above, we set <code>flex-wrap: wrap</code>, which makes the
