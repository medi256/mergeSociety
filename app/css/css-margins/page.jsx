...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/css/css-margins",
  },
  ...
  openGraph: {
    ...
    description:
      "Explore how CSS margins create space around elements, improve layout and readability, and enhance the user experience with this beginner-friendly guide.",
    url: "https://mergesociety.com/css-margins",
  },
};
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          enhance the overall user experience. In this section, we'll explore
          the fascinating world of margins in CSS and learn how to use them
...
div {
  margin: 10px; /* Adds 10px of margin to all sides */
        ...
        <p>
          ...
          pixels, creating a uniform margin of 10 pixels around the div element.
          This means that there will be 10 pixels of space between the element
          and its neighboring elements or the edges of the page. Margins help
          create breathing room and separation between elements, improving the
          overall layout and readability of your designs.
        </p>
...
div {
  margin-top: 20px; /* Adds 20px of margin to the top */
        ...
        <p>
          ...
          pixels, creating 20 pixels of space between the element and the top
          edge of its container or the top edge of the page. This is useful when
          you want to add extra space above the element, such as adding
          separation between a heading and the content below it.
        </p>

        <h2>Margin Right</h2>
        <p>
          The <code>margin-right</code> property allows you to add margin
          specifically to the right side of an element. This creates space
          between the element and the right edge of its container or the right
...
div {
  margin-right: 15px; /* Adds 15px of margin to the right */
        ...
        <p>
          ...
          edge of its container or the right edge of the page. This is useful
          when you want to add extra space to the right of the element, such as
...
div {
  margin-bottom: 10px; /* Adds 10px of margin to the bottom */
        ...
        <p>
          In the code above, we set the <code>margin-bottom</code> property to
          10 pixels, creating 10 pixels of space between the element and the
          bottom edge of its container or the bottom edge of the page. This is
          useful when you want to add extra space below the element, such as
          creating separation between paragraphs or adding emphasis to a
          specific element.
        </p>
        ...
        <p>
          ...
          specifically to the left side of an element. This creates space
          between the element and the left edge of its container or the left
          edge of the page. Here's an example:
        </p>
...
div {
  margin-left: 25px; /* Adds 25px of margin to the left */
        ...
        <p>
          ...
          edge of its container or the left edge of the page. This is useful
          when you want to add extra space to the left of the element, such as
          creating a margin between the element and other elements on the left
          side.
        </p>

        <h2>Margin Shorthand</h2>
        <p>
          CSS provides a shorthand property for margins that allows you to
          specify margins for multiple sides in a single declaration. This
          shorthand property follows the order of top, right, bottom, and left
          (TRBL). Here's an example:
        </p>
...
div {
  margin: 10px 20px; /* Adds 10px of margin to the top and bottom, and 20px of margin to the left and right */
        ...
        <p>
          In the code above, we used the <code>margin</code> shorthand property
          to set 10 pixels of margin for the top and bottom sides and 20 pixels
          of margin for the left and right sides of the div element. This
          shorthand property makes your code more concise and easier to read.
          You can also use different values for each side, such as{" "}
        ...
        <p>
          Margins can also be negative, allowing you to overlap elements or
          create unique layouts. Negative margins move elements closer to each
          other or to the edges of the page. Here's an example:
        </p>
...
div {
  margin: -10px; /* Moves the element 10px closer to its neighboring elements or the edges of the page */
        ...
        <p>
          In the code above, we set the <code>margin</code> property to -10
          pixels, moving the element 10 pixels closer to its neighboring
          elements or the edges of the page. Negative margins can be useful for
          creating overlapping effects or achieving specific layout designs.
          Just be cautious when using negative margins, as they can sometimes
...
div {
  margin: 5%; /* Adds 5% of the parent's width as margin */
        ...
        <p>
          ...
          margin will be 20 pixels on each side (5% of 400). This dynamic margin
          can be useful when you want the margins to scale proportionally with
        ...
        <ol>
          ...
          <li>
            ...
            affects the spacing around the element. Try using different values
          ...
          <li>
            Try using the shorthand property to set margins for multiple sides
            in a concise manner. Observe how the different values affect the
        ...
        <p>
          Remember, margins play a crucial role in creating visually appealing
          and user-friendly designs. They help create breathing room between
          elements, improve readability, and add a sense of balance to your
          layouts. Choose margin values that align with your brand and enhance
          the overall user experience. Happy coding and happy designing!
        </p>
