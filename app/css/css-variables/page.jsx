    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          properties once and then reference them throughout your styles. In
          this section, we'll explore the wonderful world of variables and learn
          how to use them effectively in your CSS designs. Let's begin!
        </p>
...
:root {
  ...
  --font-size: 16px; /* Defines a variable for the font size */
        ...
        <p>
          Variables can be used in various ways to enhance your CSS designs.
        ...
        <p>
          ...
          color, or any other color, you can ensure consistency and easily
          update colors across your entire design. Here's an example:
        </p>
...
.container {
  padding: var(--spacing); /* Uses the defined spacing value */
        ...
        <ul>
          <li>
            <strong>Browser Support:</strong> Variables have good browser
            support, but older browsers may not support them. It's important to
          ...
          <li>
            ...
            used judiciously. Overusing variables can make your stylesheet
        ...
        <h2>Practice Time!</h2>
        <p>
          Now it's time to experiment with variables in CSS! Open your code
        ...
        <ol>
          ...
          <li>
            Refer to variable resources and tutorials to discover creative ways
            to use variables, such as creating theme-based designs, maintaining
            color consistency, or building responsive layouts.
          </li>
        </ol>
