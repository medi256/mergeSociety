...
p {
  word-spacing: 5px; /* Adds 5 pixels of space between each word */
      ...
      <p>
        The <code>letter-spacing</code> property allows you to adjust the space
        between individual letters in your text. You can use positive or
        negative values to increase or decrease the spacing. Here's an example:
      </p>
...
p {
  line-height: 1.5; /* Sets the line height to 1.5 times the font size */
      ...
      <p>
        ...
        <code>right</code>, <code>center</code>, or <code>justify</code>. Here's
        an example:
      </p>
...
div {
  text-align: justify; /* Justifies the text within the container */
      ...
      <p>
        ...
        and create a new HTML file. Let's explore the wonderful world of text
        styling:
      </p>
