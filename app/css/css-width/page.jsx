  ...
  return (
    <div className="lesson-container">
      ...
      <p>
        ...
        we'll explore the fascinating world of width in CSS and learn how to use
        it effectively to style your elements. Let's embark on this width
        adventure!
      </p>
...
div {
  width: 300px; /* Sets the width to 300 pixels */
      ...
      <p>
        Using percentages for width allows you to set the width relative to the
        width of the parent element. This means that the width will adjust
...
div {
  width: 50%; /* Sets the width to 50% of the parent's width */
      ...
      <p>
        In the code above, we set the <code>width</code> property to 50%, making
        the div element half the width of its parent element. This is useful
        when you want the element to scale proportionally with the parent
        element's size. For example, if the parent element has a width of 800
        pixels, the child element with a width of 50% will be 400 pixels wide.
        Percentages for width are commonly used to create flexible layouts that
        adapt to different screen sizes or to create responsive designs.
      </p>
...
img {
  width: auto; /* Sets the width based on the image's original size */
      ...
      <p>
        ...
        and create a new HTML file. Let's explore the wonderful world of width:
      </p>
