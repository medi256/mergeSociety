    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          learn how to use the <code>color</code> property to style your text
        ...
        <p>
          The <code>color</code> property is a fundamental tool in CSS that
          allows you to specify the color of text and other elements. It
          determines the color of the text content within an element. For
          example:
        </p>
...
p {
  color: red; /* Sets the text color of paragraphs to red */
        ...
        <p>
          ...
          remember and use. These keywords represent common color names, making
          it convenient to specify colors without memorizing complex color
...
div {
  color: blue; /* Keyword for blue color */
        ...
        <p>
          ...
          <code>green</code>, and more, provide a simple and intuitive way to
          add color to your designs. They are widely recognized and easy to
          remember, making them a popular choice for specifying colors.
        </p>

        <h2>Hexadecimal Colors</h2>
        <p>
          Hexadecimal colors, often referred to as hex colors, offer a more
          precise and versatile way to specify colors. Hex colors use a
          six-digit combination of letters and numbers preceded by a pound sign
...
div {
  color: rgb(0, 255, 0); /* Green */
        ...
        <p>
          In the code above, <code>rgb(255, 0, 0)</code> represents red, with
          the maximum value of red (255), no green (0), and no blue (0). RGB
          colors allow for fine-grained control over the color composition,
          enabling you to create endless color variations.
        </p>
        <p>
...
div {
  color: hsl(120, 50%, 75%); /* Light Green */
        ...
        <p>
          In the code above, <code>hsl(0, 100%, 50%)</code> represents red, with
          a hue of 0 (red), 100% saturation, and 50% lightness. HSL colors offer
          a more intuitive way to specify colors, as you can easily adjust the
          hue, saturation, and lightness to create the desired color.
        </p>
        <p>
        ...
        <h2>Color Opacity</h2>
        <p>
          Color opacity refers to the transparency or opacity of a color. You
          can control the opacity of a color using the <code>rgba()</code>{" "}
          function. The opacity value ranges from 0 (fully transparent) to 1
...
p {
  color: rgba(255, 0, 0, 0.5); /* Semi-transparent red */
        ...
        <h2>Note</h2>
        <p>
          You can use any type of color you know. Try changing those colors —
          try black, blue, orange, or any other color. If you're a beginner, you
          only need to use color names; you don't have to deal with other color
          values. As you master CSS, you will become familiar with these other
          color values. The reason we mention them is to make you aware that
          they do exist. So, if you encounter them in someone's code, you won't
          be surprised.
        </p>
        ...
        <p>
          ...
          design. Different colors evoke different emotions and can influence
          the user's perception of your website. Here are some common color
          associations:
        </p>

        <ul>
          <li>
            <strong>Red:</strong> Passion, energy, excitement, and urgency. Red
            is often associated with boldness and can be used to grab attention.
          </li>
          <li>
          ...
          <li>
            <strong>Green:</strong> Nature, growth, harmony, and freshness.
            Green is often associated with environmental awareness and health.
          </li>
          <li>
            <strong>Yellow:</strong> Happiness, optimism, caution, and
            creativity. Yellow is a bright and cheerful color that can be used
        ...
        <ol>
          ...
          <li>
            ...
            generators, to discover new colors and create beautiful color
