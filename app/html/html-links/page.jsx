  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        <h1>Links in HTML</h1>
        <p>
          Welcome back, aspiring web developer! In this lesson, we'll be
          exploring one of the most fundamental elements of the web - links.
          Links, also known as hyperlinks, are what make the web interactive and
          allow users to navigate from one web page to another. Let's dive into
          the world of links in HTML and learn how to create and customize them
          effectively.
        </p>
...
<a href="https://www.example.com">Click me!</a>
        ...
        is used to specify the URL or web address that the link should point to.`}
          ...
          the visible text of the link, often called the link text or anchor
          text. This is the text that users will see and click on.
        </p>
        ...
        <p>
          ...
          make them stand out. While we won't dive into CSS styles in this
          lesson, it's important to know that you can use CSS to change the
          color, underline style, or even add background colors to your links.
        </p>

        <h2>Opening Links in New Tabs or Windows</h2>
        <p>
          By default, clicking on a link will open the linked web page in the
          same browser tab or window. However, you can specify that the link
          should be opened in a new tab or window, providing a better user
          experience in certain cases. Here's how you can do that:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="HTML" style={docco}>
...
<a href="https://www.example.com" target="_blank">
  Open in a new tab
        ...
        <ul>
          ...
          <li>
            <strong>Make links visually distinct:</strong> Ensure that links
            stand out from the surrounding text. Users should be able to easily
            identify clickable elements on your web page. You can use color,
            underlines, or other visual cues to indicate that text is a
            clickable link.
          </li>
          <li>
            <strong>Use meaningful URLs:</strong> The URL specified in the
            "href" attribute should be meaningful and relevant to the link text.
            Avoid using misleading or cryptic URLs that may confuse users.
          </li>
          <li>
...
<a href="https://www.example.com">
  Visit my favorite website!
          ...
          <li>
            Specify that a link should be opened in a new tab or window using
            the "target" attribute. For instance,
            <br />
            <pre>
              <code>
                <SyntaxHighlighter language="HTML" style={docco}>
...
<a href="https://www.example.com" target="_blank">
  Open in a new tab
        ...
        <p>
          ...
          should be opened. Links are an essential part of the web, allowing
          users to navigate between web pages and explore different websites.
          Remember to use links wisely, follow best practices, and always test
          your links to ensure a smooth user experience. In the next lesson,
          we'll move on to attributes and learn what attributes are and their
          usecase. Stay tuned, and happy coding!
        </p>
