    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          content and create rich, interactive experiences on your web pages.
        ...
        <p>
          ...
          external content is displayed seamlessly. The{" "}
          <code>{`<iframe>`}</code>
        ...
        <ul>
          <li>
            ...
            element requires the {` "src" `} attribute to indicate the URL of
            the external content you want to embed. Make sure to provide a valid
            and accessible URL for the content.
          </li>
          <li>
            ...
            <code>{`<iframe>`}</code> element. This ensures that the content
            fits well within your web page layout.
          </li>
          <li>
            <strong>Provide alternative content:</strong>{" "}
            {` It's a good practice to `}
            include alternative content within the <code>{`<iframe>`}</code>{" "}
            using the <code>{`<p>`}</code>
  ...
  <p>Alternative content: Follow us on Social Media!</p>
        ...
        <ul>
          <li>
            ...
            excessively on your web page. Only use it when necessary, such as
            for embedding videos, maps, or interactive content.
          </li>
          <li>
            ...
            <code>{`<iframe>`}</code> content. This ensures a seamless
            experience for users who have disabled iframes or have slow internet
            connections.
          </li>
          <li>
            <strong>Consider performance and security:</strong> Embedding
            external content can impact the performance and security of your web
            page. Choose lightweight content, and ensure that the source of the
            content is trusted and secure.
          </li>
        </ul>
        ...
        <p>
          ...
          editor and create a new HTML file. Experiment with embedding external
          content using the
          <code>{`<iframe>`}</code> element.{" "}
        ...
        <ol>
          <li>
            Create a new HTML file and save it as "iframe.html" in your
            workspace folder.
          </li>
          <li>
          ...
          <li>
            Experiment with the "sandbox" attribute to control the permissions
        ...
        <p>
          ...
          you to enhance your web pages with external content. Remember to use
          it wisely, provide meaningful alternative content, and consider
          performance and security implications. In the next lesson,{" "}
          {` we'll
