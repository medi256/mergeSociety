...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/html/html-dropdown-menu",
  },
  openGraph: {
    title:
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          <code>{`<summary>`}</code> tags, and some related tags in HTML.
          Dropdown menus are interactive elements that allow users to select
          options from a list, while the <code>{`<details>`}</code> and{" "}
          <code>{`<summary>`}</code>
          tags are used to create collapsible content sections. These elements
          enhance the user experience by providing dynamic and interactive
          content on your website. Let's explore how to create and use these
        ...
        <p>
          ...
          navigation menus. They allow users to select one or more options from
          a list of choices. Dropdown menus are often used for tasks like
          selecting a country, choosing a color, selecting multiple options, or
          filtering data. They provide a compact and user-friendly way to
        ...
        <p>
          ...
          <code>{`<select>`}</code> element. The <code>{`<select>`}</code>{" "}
          element represents a dropdown list from which users can choose one or
          more options. {`Here's the basic structure of a dropdown menu:`}
        </p>
        <pre>
          <code>
...
<select>
  ...
  <option value="option3">Option 3</option>
        ...
        <p>
          ...
          the <code>{`<summary>`}</code> tag represents the heading or summary
          of the content. When users click on the summary, the content within
          the <code>{`<details>`}</code> tag is revealed. {`Here's an example:`}
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="HTML" style={docco}>
...
<details>
  ...
  <p>This is the additional content that will be revealed when the user clicks the summary.</p>
        ...
        <p>
          ...
          <code>{`<summary> `}</code> tag represents the heading or summary of
          the content. Clicking on the summary will toggle the visibility of the
        ...
        <ul>
          <li>
            ...
            pre-defined options for an <code>{`<input>`}</code> element. It
            allows users to select from a list of suggestions as they type,
            enhancing the usability of text input fields.
          </li>
          <li>
            <strong>
              <code>{`<optgroup>`}</code>:
          ...
          <li>
            ...
            The <code>{`<option>`}</code> tag represents a single option within
            a dropdown menu. It includes a label and a value that will be
            submitted when the option is selected.
          </li>
        </ul>
  ...
  <option value="green">Green</option>
        ...
        <ul>
          ...
          <li>
            ...
            and collapsible content are accessible to users with disabilities.
            Use the "aria-label" attribute to provide a descriptive label for
            screen readers, and consider using the "aria-expanded" attribute to
            indicate the current state of collapsible content.
          </li>
          <li>
        ...
        <p>
          ...
          collapsible content, and using related tags. Here's a simple exercise
          to get you started:
        </p>
        ...
        <ol>
          ...
          <li>
            ...
            <code>{`<details>`}</code> and
            <code>{`<summary>`}</code> tags. Include a summary that invites
            users to click to reveal additional information.
          </li>
          <li>
        ...
        <p>
          ...
          elements play a crucial role in creating interactive and dynamic
          content on your website. Remember to use them wisely, provide clear
          and descriptive labels, and ensure accessibility. In the next lesson,
          we'll continue our journey by exploring responsive web design and how
          to make your website adaptable to different screen sizes and devices.
