...
<input type="password" id="password">
        ...
        <li>
          ...
          from a list. The "type" attribute is set to "checkbox." For instance,
          <br />
          <pre>
            <code>
              <SyntaxHighlighter language="HTML" style={docco}>
...
<input type="radio" id="option1">
      ...
      <ul>
        <li>
          <strong>Placeholder:</strong> The "placeholder" attribute specifies a
...
<input type="text" value="John Doe">
        ...
        <li>
          <strong>Required:</strong> The "required" attribute specifies that the
...
<textarea col="30" rows="10">Write something</textarea>
          ...
          <p>
            Now the text "Write something" above will display like a hint in the
            text field. It can be used as the placeholder in{" "}
