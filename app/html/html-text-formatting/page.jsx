  ...
  return (
    <div className="lesson-container">
      ...
      <p>
        ...
        highlight, and style your text in various ways, making your content more
        engaging and visually appealing. Let's dive right in and learn about the
        different text formatting options available in HTML.
      </p>
...
<p>
  ...
  and <ins>inserted</ins> text.
     ...
     `}
      ...
      <p>
        The <code>{`<sup>`}</code> and <code>{`<sub>`}</code> tags are used for
        superscript and subscript text, respectively. Superscript text appears
        slightly above the baseline, while subscript text appears slightly below
        it. These tags are commonly used for footnotes, mathematical
        expressions, or scientific notations. Here's an example:
      </p>
      <pre>
        <code>
          <SyntaxHighlighter language="HTML" style={docco}>
...
The formula is H<sub>2</sub>O.
      ...
      <p>
        In the above code, "30o" will be displayed as superscript, and "2" will
        be displayed as subscript.
      </p>
...
The <abbr title="World Wide Web">WWW</abbr> is a global information system.
      ...
      <ul>
        ...
        <li>
          <strong>Consider readability:</strong> Text formatting should improve
          the readability of your content. Make sure the formatted text is still
          easy to read and doesn't distract or confuse readers.
        </li>
      </ul>
