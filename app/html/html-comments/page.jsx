    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          feature that allows you to include notes, explanations, or
          instructions in your HTML code. Comments are ignored by web browsers,
          meaning they won't be displayed on the web page itself. Comments are
          useful for providing additional information, documenting your code, or
          temporarily disabling certain parts of your code during development or
          testing. Let's dive into the world of comments in HTML and learn how
          to use them effectively.
        </p>

        <h2>What Are Comments in HTML?</h2>
        <p>
          Comments in HTML are special constructs that allow you to include
          notes, explanations, or instructions within your HTML code. Comments
          are denoted by specific delimiters, and they are not rendered or
          displayed on the web page. Comments are primarily intended for
          providing information or instructions to other developers who may work
          on the code.
        </p>

        <h2>Creating Comments in HTML</h2>
        <p>
          Comments in HTML are created using special delimiters that indicate
          the beginning and end of the comment. Here's the basic structure of an
          HTML comment:
        </p>
        <pre>
          <code>
...
<!-- This is a comment -->
        ...
        <ul>
          <li>
            ...
            explanations, instructions, or additional information about your
            code. This helps other developers understand your code and its
            functionality.
          </li>
          <li>
            <strong>Temporary Disabling:</strong> Comments can be used to
            temporarily disable certain parts of your HTML code during
            development or testing. This allows you to test different scenarios
            or disable specific features without deleting the code entirely.
          </li>
          <li>
            ...
            notes, ask questions, or provide feedback within the HTML code
            itself.
          </li>
        </ul>
...
<!-- Note to other developers: This section requires additional testing and validation -->
        ...
        <ul>
          <li>
            ...
            your HTML code. This helps other developers understand and
          ...
          <li>
            <strong>Update and remove outdated comments:</strong> Ensure that
            your comments remain accurate and relevant. Remove comments that are
            no longer applicable to avoid confusion for other developers.
          </li>
        </ul>
        ...
        <p>
          ...
          your HTML code, or temporarily disabling certain parts. Here's a
...
<!-- This feature is under development and will be enabled soon -->.
        ...
        <p>
          ...
          providing additional information, documenting your code, or
          temporarily disabling certain parts. Remember to use comments wisely,
          keep them concise and relevant, and always consider the audience who
          may read and benefit from your comments. In the next lesson, we'll
          continue our journey by exploring the Structure of an HTML Document.
