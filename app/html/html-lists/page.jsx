  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        <h1>Lists in HTML</h1>
        <p>
          Hello there! In this lesson, we'll be exploring lists in HTML. Lists
          are a fundamental part of web content, allowing you to present
          information in a structured and organized manner. HTML provides two
          main types of lists: unordered lists (bulleted lists) and ordered
          lists (numbered lists). Let's dive right in and learn how to create
          and customize lists in HTML.
        </p>
...
<ul>
  ...
  <li>Item 3</li>
        ...
        <h2>Ordered Lists</h2>
        <p>
          Ordered lists, also known as numbered lists, are used when the order
          of the items in the list matters. Each item in an ordered list is
          marked with a number. Here's how you can create an ordered list:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="HTML" style={docco}>
...
<ol>
  ...
  <li>Item 3</li>
        ...
        <h2>Nested Lists</h2>
        <p>
          You can create nested lists in HTML by placing one list inside
          another. This allows you to create hierarchical or multi-level lists.
  ...
  <li>Item 3</li>
        ...
        <ul>
          <li>
            ...
            for presenting information in a clear and organized manner. They
            help readers quickly scan and understand your content.
          </li>
          <li>
            <strong>Choose the right list type:</strong> Use unordered lists
            when the order of items doesn't matter, and use ordered lists when
...
<ol>
  <li>Step 1: Preheat the oven.</li>
        ...
        <p>
          ...
          versatile tool for presenting information in a structured and
          organized way. Remember to use lists wisely, follow best practices,
          and always consider the readability of your content. In the next
          lesson, we'll move on to links and learn how to create hyperlinks in
