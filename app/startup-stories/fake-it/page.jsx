...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/fakeit-800x445_zlq56h_dgu41v.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/fakeit-800x445_zlq56h_dgu41v.jpg",
    ],
  },
        ...
        <ul>
          <li>
            <Link href="/startup-stories/pony-ma">
              How Tencent Quietly Built a Digital Empire
            </Link>
          </li>
          <li>
