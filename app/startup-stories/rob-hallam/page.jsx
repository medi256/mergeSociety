...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/audio_1761559288875_xtxud_zqk8xg_xpu5s0.webp",
        width: 800,
        height: 400,
...
export const jsonLd = {
  ...
  image:
    "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/audio_1761559288875_xtxud_zqk8xg_xpu5s0.webp",
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <figure className="article-figure">
          <Image
            src="/mergesociety/audio_1761559288875_xtxud_zqk8xg_xpu5s0.webp"
        ...
        <section aria-label="Who I Am and Why This Journey">
          ...
          <p>
            ...
            myself I would <Link href="/startup-stories/indie-dev">build in public</Link>. That is why you are reading this.
