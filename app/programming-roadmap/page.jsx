...
export const metadata = {
  ...
  keywords: [
    ...
    "programming skills 2025",
    "tech career roadmap",
    "developer job preparation",
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dhgjhspsp/image/upload/v1751962787/Programmer_roadmap_w5gy7z.png",
        width: 1200,
        height: 630,
...
export const roadmapStructuredData = {
  ...
  hasCredential: {
    ...
    description: "Comprehensive full stack development skills certification",
  },
  offers: {
    "@type": "Offer",
    name: "Free Programming Roadmaps",
    description: "Free access to comprehensive programming language roadmaps",
    price: "0",
    priceCurrency: "USD",
  },
  aggregateRating: {
