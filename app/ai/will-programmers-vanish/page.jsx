...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/programming-jobs_xlchqy_x6fx4p.jpg",
        width: 1200,
        height: 630,
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <Image
          src={"/mergesociety/programming-jobs_xlchqy_x6fx4p.jpg"}
