...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/ai-mcp_sseuxt_ajwoxg.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/ai-mcp_sseuxt_ajwoxg.jpg",
    ],
  },
  ...
  jsonLd: {
    ...
    headline:
      "The Rise of Model Context Protocol (MCP): Why Every Developer Is Talking About It",
    image: "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/ai-mcp_sseuxt_ajwoxg.jpg",
