...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/rise_of_ai_raoqb3_fmmfwu.webp",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/rise_of_ai_raoqb3_fmmfwu.webp",
    ],
  },
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <Image
          src={"/mergesociety/rise_of_ai_raoqb3_fmmfwu.webp"}
          alt="Visual representation of AI evolution from rule-based systems to cosmic intelligence"
          width={600}
          height={400}
          priority
