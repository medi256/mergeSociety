...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dgyofctwi/image/upload/v1762768287/pexels-tara-winstead-8849295_hlz6r3_qri1oi.jpg",
        width: 1200,
        height: 630,
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <figure className="blog-image">
          <img
            src="https://res.cloudinary.com/dgyofctwi/image/upload/v1762768287/pexels-tara-winstead-8849295_hlz6r3_qri1oi.jpg"
