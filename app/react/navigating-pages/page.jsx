...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/react/navigating-pages",
  },
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          between different routes and rendering the appropriate components
          based on the current route. It involves handling user interactions,
          such as clicking on links, and updating the URL to reflect the current
          route.
        </p>
        ...
        <ul>
          <li>
            <strong>Seamless User Experience:</strong> Page navigation provides
            a seamless user experience by allowing users to navigate between
            different pages without full page reloads.
          </li>
          <li>
            <strong>Dynamic Routing:</strong> React Router enables dynamic
            routing by rendering different components based on the current
            route. This makes your application more interactive and responsive
            to user actions.
          </li>
          <li>
        ...
        <ol>
          <li>
            <strong>Define Routes:</strong> Create a <code>Router</code>{" "}
            component and define your routes using the <code>Route</code>{" "}
            component.
          </li>
          <li>
            <strong>Use Links:</strong> Within your components, use the{" "}
            <code>Link</code> component to create clickable links that navigate
            to different routes.
          </li>
          <li>
...
`}
        ...
        <p>
          ...
          <code>/</code>) and another for the about page (<code>/about</code>).
          We use the <code>element</code> prop to specify the component that
        ...
        <p>
          Now, let's use the <code>Link</code> component to create clickable
          links that navigate between pages:
        </p>
...
`}
        ...
        <p>
          ...
          <code>react-router-dom</code>. We use the <code>Link</code> component
          to create a clickable link that navigates to the about page (
...
`}
        ...
        <p>
          In this code, we import the <code>useNavigate</code> hook to access
          the <code>navigate</code> function. We use the <code>navigate</code>{" "}
          function to programmatically navigate to different routes. For
          example, <code>navigate('/')</code> navigates to the homepage, and{" "}
...
`}
        ...
        <ul>
          ...
          <li>
            <strong>Use Links:</strong> We use the <code>Link</code> component
            to create clickable links that navigate between pages.
          </li>
          <li>
            <strong>Programmatic Navigation:</strong> We use the{" "}
            <code>navigate</code> function from the <code>useNavigate</code>{" "}
            hook to programmatically navigate to different routes. The{" "}
            <code>useNavigate</code> hook provides a way to navigate
            programmatically and also allows us to go back in the browser
            history using negative values.
          </li>
        </ul>
        ...
        <p>
          ...
          transition between pages without full page reloads, resulting in a
          more intuitive and engaging user experience. The{" "}
          <code>useNavigate</code> hook enhances this experience by providing a
          way to programmatically navigate and manipulate the browser history.
        </p>
