  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          In JSX, attributes work similarly to HTML. These attributes allow you
          to modify the behavior or appearance of elements, like adding links,
          setting styles, or adding an image source. However, there are some
          differences between HTML attributes and JSX attributes, so let's
...
`}
        ...
        <p>
          Notice how JSX and HTML are almost the same in this case. You still
          use attributes like <strong>src</strong> for images and{" "}
          <strong>alt</strong> for alternative text.
        </p>

        <strong>2. Differences Between HTML and JSX Attributes</strong>
        <p>
          While JSX looks a lot like HTML, there are some differences,
          especially in how attributes are written. One major difference is that
          in JSX, some HTML attributes have different names. Let's look at a
          common example:
        </p>
...
`}
        ...
        <p>
          This is because <strong>class</strong> is a reserved word in
          JavaScript. To avoid confusion, JSX uses <strong>className</strong>{" "}
          instead of <strong>class</strong>. This is one of the most important
          things to remember when adding classes to JSX elements.
        </p>

        <strong>3. CamelCase for Attributes</strong>
        <p>
          Another key difference in JSX is how certain attributes are written.
          In HTML, you might be used to writing attributes in lowercase, like{" "}
...
`}
        ...
        <p>
          For example, if you want to dynamically set the source of an image,
          you can do this:
        </p>
...
`}
        ...
        <p>
          The <strong>imageUrl</strong> inside the <strong>src</strong>{" "}
          attribute tells JSX to use the value of the <strong>imageUrl</strong>{" "}
          variable. This allows you to make your JSX more flexible and dynamic.
        </p>

        <strong>5. Self-Closing Tags</strong>
        <p>
          In HTML, some tags, like <strong>img</strong> and{" "}
          <strong>input</strong>, are self-closing. This means they don’t need a
          separate closing tag like <strong>&lt;/img&gt;</strong>. JSX follows
          the same rule, but you must always add a slash (<strong>/</strong>) at
          the end of the tag to close it properly.
        </p>
