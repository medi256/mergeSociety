    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          example, you might want to show a message like "Welcome back!" if a
          user is logged in, but show a "Please log in" message if they’re not
          logged in. It’s like making decisions in your app: "If this happens,
          show this; otherwise, show that."
        </p>
...
export default ConditionalRenderingExample;
      `}
        ...
        <p>
          In this example, we have a variable called <code>isLoggedIn</code>{" "}
          that holds a boolean value (either true or false). If{" "}
          <code>isLoggedIn</code> is true, React will display "Welcome back!".
          If <code>isLoggedIn</code> is false, React will display "Please log
          in."
        </p>
...
export default ConditionalRenderingExample;
      `}
        ...
        <p>
          The ternary operator checks if <code>isLoggedIn</code> is true. If
          true, it displays "Welcome back!". If false, it displays "Please log
          in." This approach is shorter and useful for simple conditions.
        </p>
...
export default ConditionalRenderingExample;
      `}
        ...
        <p>
          You can also use functions to handle complex conditional rendering.
...
export default ConditionalRenderingExample;
      `}
        ...
        <p>
          Here, we check two conditions: if the user is logged in and if they
          have messages. The output depends on both conditions.
        </p>

        <h3>6. Conditional Rendering with null</h3>
        <p>
          Sometimes, you don’t want to show anything when a condition is false.
          In React, you can return <code>null</code> to render nothing.
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="jsx" style={docco}>
...
export default ConditionalRenderingExample;
      `}
        ...
        <p>
          If <code>showWarning</code> is false, nothing will be displayed for
          that part of the component.
        </p>

        <h2>Why Conditional Rendering is Important</h2>
        <p>
          Conditional rendering lets you create dynamic, interactive UIs. You
          can show or hide parts of the UI, display error messages, or handle
          different states like loading or success.
        </p>

        <h2>Summary</h2>
        <p>
          Conditional rendering in React lets you control what users see based
          on specific conditions. You can use <strong>if statements</strong>,
          the <strong>ternary operator</strong>, the{" "}
          <strong>logical AND</strong>, or <strong>functions</strong> to manage
          what appears in your UI. These methods are essential for building
