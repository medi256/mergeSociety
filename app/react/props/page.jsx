    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          different data to the same component, and it will react accordingly
          (pun intended!). This way, we avoid duplicating code and can create
        ...
        <ul>
          ...
          <li>
            ...
            Specifically, they allow parent components to pass data down to
            child components, which is essential for structuring complex
            applications.
          </li>
          <li>
...
export default App;
        ...
        <ul>
          ...
          <li>
            <strong>App Component:</strong> In the <code>App</code> component,
            we use the <code>Greeting</code> component twice, passing a
            different <code>name</code> prop each time. In one case, we pass
            "Alice", and in another, we pass "Bob". This results in two
            personalized greetings being displayed.
          </li>
        </ul>
        ...
        <p>
          ...
          reason for this is to maintain a one-way data flow in React, which is
          a core principle of the framework.
        </p>
        <p>
          ...
          them. If the child could change the props, it would create
          unpredictable behavior, making it difficult to understand how data is
          being managed.
        </p>
        ...
        <p>
          ...
          <strong>default props</strong> come in handy. Default props allow you
          to set a fallback value that will be used if no value is provided for
          that prop.
        </p>
...
export default App;
        ...
        <p>
          ...
          <code>Greeting</code> component, it will default to "Guest". This
          makes the component more robust and prevents errors if a prop is
        ...
        <ul>
          <li>
            <strong>Props:</strong> Props are passed from a parent component to
            a child component and are <strong>read-only</strong>. They cannot be
            changed by the child component.
          </li>
          <li>
            <strong>State:</strong> State is used to manage data that belongs to
            the component itself and can change over time. When state changes,
        ...
        <p>
          Props aren’t limited to just data like strings or numbers. You can
          also pass functions as props, which is useful when you want to allow a
          child component to trigger actions or communicate back to the parent
          component.
        </p>
...
export default App;
        ...
        <p>
          ...
          as a prop (called <code>handleClick</code>). When the button is
          clicked, it calls this function, which triggers an alert. This shows
          how you can pass functions as props to allow child components to
          interact with their parent components.
        </p>
        ...
        <ul>
          ...
          <li>
            You can set default props in case a value is not passed by the
            parent component.
          </li>
          <li>
