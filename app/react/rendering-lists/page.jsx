...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/react/rendering-lists",
  },
...
const RenderingLists = () => {
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          array is just a special way to store multiple items in one place in
          our code. Think of it like a container that can hold many things.
        </p>

        <h2>Step 1: Making a List</h2>
        <p>
          Let's start by making a simple list in our code. We'll create a list
          of fruits using an array. Here's how we do it:
        </p>
        <pre>
          <code>
        ...
        <ul>
          <li>
            <strong>const fruits =</strong> means we're creating a new list
            called "fruits"
          </li>
          <li>
          ...
          <li>
            Each item is wrapped in quotes (because they're text) and separated
            by commas
          </li>
        </ul>
        <p>
        ...
        <p>
          Now that we have our list, we want to show it on our webpage. In
          React, we use a special technique called "mapping" to do this. Mapping
          is like giving React instructions for each item in our list.
        </p>
  ...
  {fruits.map((fruit) => (
    <li>{fruit}</li>
        ...
        <p>
          This might look confusing at first, so let's break it down step by
          step:
        </p>
        <ul>
          <li>
        ...
        <p>
          Now, let's see how this looks in a full React component. A component
          is like a building block for your webpage. Here's our FruitList
          component:
        </p>
        <pre>
          <code>
...
export default FruitList;`}
        ...
        <ul>
          ...
          <li>
            Inside, we have an <code>&lt;h2&gt;</code> for the title "My
            Favorite Fruits".
          </li>
          <li>
        ...
        <ul>
          <li>
            Change the fruits in the list. Add your own favorite fruits or
            remove some.
          </li>
          <li>
          ...
          <li>
            Add more details to each item. For example, you could make each
            fruit an object with a name and a color:
          </li>
          <pre>
            <code>
  ...
  { name: 'Orange', color: 'Orange' }
          ...
          <p>
            Then, you'd need to update your map function to show both the name
            and color:
          </p>
          <pre>
            <code>
  ...
  <li key={fruit.name}>{fruit.name} - {fruit.color}</li>
        ...
        <p>
          ...
          you'll understand them. Don't be afraid to experiment and make
        ...
        <p>
          ...
          item in the list. They're crucial when your list might change, like
