    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          writing and editing code. While you can technically use any text
          editor (like Notepad or TextEdit) to write code, a code editor comes
          with features that make coding a lot easier and more efficient.
        </p>
        <p>
          ...
          level. Similarly, a code editor is packed with tools that help you
          write clean, error-free code quickly. It makes your job much easier!
        </p>

        <h2>Why We Recommend VS Code (Visual Studio Code)</h2>
        <p>
          There are many code editors out there, but we highly recommend{" "}
          <strong>Visual Studio Code (VS Code) </strong> , especially if you’re
          a beginner. Here’s why:
        </p>
        <ul>
          <li>
            <strong>Beginner-friendly:</strong> VS Code is simple to use and
            easy to set up, making it perfect for those just getting started.
          </li>
          <li>
            <strong>Free:</strong> It’s completely free to download and use,
            with no hidden costs.
          </li>
          <li>
            <strong>Helpful features:</strong> It comes with great features like
            <strong> syntax highlighting</strong> (which makes your code
            colorful and easier to read) and <strong> auto-completion</strong>{" "}
            (which helps you type faster by suggesting code as you write).
          </li>
          <li>
            <strong>Extensions:</strong> You can add extra tools called
            "extensions" to make VS Code even more powerful. For example,
            there’s an extension for React that helps you write React code more
            efficiently.
          </li>
          <li>
            <strong>Cross-platform:</strong> Whether you’re using Windows,
            macOS, or Linux, VS Code works on all of them.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            On the website, you’ll see a big blue button that says **Download
            for Windows** (or macOS/Linux, depending on your system). Click the
            button to start downloading the installer.
          </li>
        </ul>
        ...
        <p>
          When you first open VS Code, you might feel a bit overwhelmed by all
          the buttons and options. But don’t worry! Let’s break down the key
          areas you’ll be using as a beginner:
        </p>
        <ul>
          <li>
            <strong>Explorer:</strong> This is where you’ll see all the files
            and folders in your project. It’s like the file manager on your
            computer, but it’s built into VS Code.
          </li>
          <li>
            <strong>Editor:</strong> This is the main area where you’ll write
            your code. Each file you open will appear as a tab in this space, so
          ...
          <li>
            <strong>Extensions:</strong> On the left-hand side, you’ll see an
            icon that looks like four squares. This is where you can browse and
            install extensions to add more functionality to VS Code.
          </li>
        </ul>
        ...
        <p>
          ...
          **extensions**. Think of extensions as extra tools or features that
          can help you code more efficiently. For React, we recommend installing
