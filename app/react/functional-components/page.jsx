  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Think of components like building blocks for your website—just like
          how you can build complex structures with Lego blocks. Each component
        ...
        <p>
          By breaking your app into smaller components, you make your code
        ...
        <ul>
          <li>
            ...
            functions, which makes them a great choice for beginners. We'll
            focus on these!
          </li>
          <li>
            <strong>Class Components:</strong> These were used before functional
            components, but they are more complicated. Don't worry about them
            for now—we'll stick to functional components.
          </li>
        </ul>
        ...
        <p>
          First, choose a name for your component. One important rule is that
          the component name must always start with a capital letter. For this
...
return <h1>Hello, friend!</h1>;
        ...
        <ul>
          <li>
            ...
            <strong>Welcome</strong>. This function will generate some content
            for us.
          </li>
          <li>
            <code>return</code> tells React what to display on the screen. In
            this case, we're returning an HTML element—a big heading (
            <code>&lt;h1&gt;</code>) that says "Hello, friend!"
          </li>
        </ul>
        <p>
          Whenever we use the <code>Welcome</code> component, it will display
          this heading.
        </p>
        ...
        <p>
          ...
          <strong>export</strong> it. Exporting a component is like packing it
          up in a box so that you can easily move it around and use it anywhere
          in your project. Here's how you do that:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="jsx" style={docco}>
...
export default App;`}
        ...
        <ul>
          <li>
            <code>import React from 'react';</code> is always needed when
            writing React components.
          </li>
          <li>
            <code>import Welcome from './Welcome';</code> brings the{" "}
            <code>Welcome</code> component we created earlier into this file.
            The <code>./</code> means that the <code>Welcome</code> component is
            in the same folder.
          </li>
          <li>
            <code>&lt;Welcome /&gt;</code> is how we use the{" "}
            <code>Welcome</code> component. This looks similar to an HTML tag
            but represents the component we created.
          </li>
        </ul>
        ...
        <ul>
          ...
          <li>
            It helps React understand that this is a component, not just a
            regular function.
          </li>
          <li>
...
<p>Welcome to our app!</p>
        ...
        <h2>Practice Time!</h2>
        <p>
          Let's create another simple component to practice. This time, we'll
...
export default App;`}
        ...
        <ul>
          ...
          <li>
            Wrap multiple elements in a container (like a{" "}
            <code>&lt;div&gt;</code>) when returning them from a component.
          </li>
        </ul>
        <p>
