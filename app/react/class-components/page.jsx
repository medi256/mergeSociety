...
export default Welcome;
      `}
        ...
        <ul>
          <li>
            <strong>Importing React and Component:</strong> We start by
            importing React and Component from the 'react' library. Component is
            a class provided by React that we extend to create our own
            component.
          </li>
          <li>
            ...
            Welcome class inherits properties and methods from React's
            Component.
          </li>
          <li>
            <strong>The render Method:</strong> Every Class Component must have
            a <code>render</code> method. This method returns the JSX that
            defines what the component will display. In this example, it simply
            returns a <code>&lt;div&gt;</code> with a heading.
          </li>
          <li>
            <strong>Exporting the Component:</strong> We use{" "}
            <code>export default</code> to make our component available for use
        ...
        <p>
          One of the main features of Class Components is state. State is used
          to store information that can change over time and affect how the
          component behaves or looks.
        </p>
...
export default Counter;
      `}
        ...
        <ul>
          <li>
            <strong>Constructor Method:</strong> The constructor method is used
            to initialize the component's state. We call
          ...
          <li>
            ...
            where we store the component's data. In this case, we start with
            count set to 0.
          </li>
          <li>
            <strong>Updating State:</strong> We use <code>this.setState</code>{" "}
            to update the state. When <code>this.setState</code>
            is called, React re-renders the component with the new state. Here,
            the increment method increases the count by 1.
          </li>
          <li>
            <strong>Rendering State:</strong> Inside the render method, we
            access the state using <code>this.state.count</code>
            and display it in the <code>&lt;h1&gt;</code> tag. The button uses
            an <code>onClick</code> event to call the increment method when
            clicked.
          </li>
        </ul>
...
export default LifecycleExample;
      `}
        ...
        <ul>
          <li>
            <strong>Lifecycle Method:</strong> <code>componentDidMount</code> is
            a lifecycle method that runs after the component has been rendered
            to the DOM. It’s often used to fetch data or perform setup tasks.
          </li>
        </ul>
        ...
        <p>
          ...
          before Functional Components and Hooks were introduced. They use
          classes and have features like state and lifecycle methods. Although
          you will mainly work with Functional Components in modern React
          development, understanding Class Components is useful for reading and
