...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/react/hooks-intro",
  },
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <ul>
          <li>
            Manage <strong>state</strong> (data that can change over time, like
            a counter or a form input).
          </li>
          <li>
        ...
        <p>
          Hooks make it possible to write components in a simpler, more
          organized way using functions instead of classes.
        </p>
        ...
        <p>
          Before Hooks were created, you would have to write this button
          component using a class to manage the state, and that made things a
          little harder to understand, especially for beginners. Class
          components involve more setup, extra keywords, and different rules you
          have to follow.
        </p>
        ...
        <p>
          But with Hooks, React gave us an easier and cleaner way to manage
          things like state and side effects in functional components, which are
        ...
        <ul>
          ...
          <li>
            ...
            component is created, updated, or removed. It’s useful for things
            like fetching data from the server or cleaning up resources like
            timers.
          </li>
          <li>
            <strong>useContext</strong>: This helps your component share data
            across different parts of your app without passing props down
        ...
        <ul>
          ...
          <li>
            Hooks give functional components the same powers that class
            components have, without the confusing <code>this</code> keyword or
        ...
        <ul>
          <li>
            ...
            that can change over time, like the text a user types in a form or
            the number of clicks on a button. Before Hooks, you had to use class
          ...
          <li>
            ...
            component to do something when it first appears on the screen, or
            when something changes. These actions, like fetching data from an
            API or setting up a timer, are called side effects. With the{" "}
          ...
          <li>
            ...
            Instead of passing this data through every component in the tree
            using props (which can get messy), you can use the{" "}
            <code>useContext</code> Hook to make this data available wherever
            you need it, without passing it through every level manually.
          </li>
        </ul>
        ...
        <p>
          ...
          and dynamic React apps. We’ll start with the <code>useState</code>{" "}
