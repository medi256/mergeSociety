...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/react/context-api",
  },
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          In our previous lesson, we learned that <code>useContext</code> is
          like a loudspeaker that lets us share information with many parts of
          our React app at once. We used it to share our school name across
          different components.
        </p>

        <h2>Introducing the Context API</h2>
        <p>
          The Context API is the bigger system that makes{" "}
          <code>useContext</code> work. It's like the entire announcement system
          in our school, not just the loudspeaker. Let's break it down:
        </p>
        <ul>
          <li>
...
export default SchoolContext;`}
        ...
        <p>
          This creates our <code>SchoolContext</code>, which will hold our
          school information.
        </p>

        <h3>Step 2: Make the Announcement (Provider)</h3>
        <p>
          Now, we need to use the Provider to make our announcement. We'll do
          this in our main App component:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="jsx" style={docco}>
...
<Footer schoolInfo={schoolInfo} />
        ...
        <p>
          ...
          overuse Context. If you only need to pass information to one or two
          components, regular props might be simpler.
        </p>

        <h2>Conclusion</h2>
        <p>
          The Context API, with its <code>createContext</code> function,{" "}
          <code>Provider</code> component, and <code>useContext</code> hook,
          gives us a powerful way to share information across our React app.
          It's like setting up an announcement system for our code, making sure
          every part of our app can easily access the information it needs.
        </p>
        <p>
          By expanding on our school website example, we've seen how Context
          allows us to pass complex data (like our <code>schoolInfo</code>{" "}
          object) through our component tree without having to manually pass
