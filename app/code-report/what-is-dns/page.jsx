...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/gkhjkg_hkj_kgn74b_bcf5ss.webp",
        width: 1200,
        height: 630,
      ...
      <article className="lesson-container">
        ...
        <section className="faq-section">
          ...
          <p>
            ...
            repeated lookups don’t need to send requests up the <Link href="/code-report/dns-records">DNS hierarchy</Link>
            every time.
          </p>
