...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dhgjhspsp/image/upload/v1752850382/softwareVScomputerscience_zuymum.webp",
        width: 1200,
        height: 630,
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <figure className="blog-image">
          <Image
            src="https://res.cloudinary.com/dhgjhspsp/image/upload/v1752850382/softwareVScomputerscience_zuymum.webp"
