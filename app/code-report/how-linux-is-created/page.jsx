...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dhgjhspsp/image/upload/v1759326194/audio_1759326035386_cek358_cdskna.webp",
        width: 800,
        height: 400,
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <figure className="article-figure">
          <Image
            src="https://res.cloudinary.com/dhgjhspsp/image/upload/v1759326194/audio_1759326035386_cek358_cdskna.webp"
