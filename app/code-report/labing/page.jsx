...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/alex-knight-2EJCSULRwC8-unsplash_cpovif_u5j7ff.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/alex-knight-2EJCSULRwC8-unsplash_cpovif_u5j7ff.jpg",
    ],
  },
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <ul>
          <li>
            <Link href="/code-report/rest-api">What is REST API</Link>
          </li>
          <li>
          ...
          <li>
            <Link href="/code-report/vpn-explained">What is a VPN</Link>
          </li>
        </ul>
        <CommentSection />
      </article>
