...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://res.cloudinary.com/dhgjhspsp/image/upload/v1756228930/audio_1756224766523_5ki8jf_rtels1.webp",
        width: 1200,
        height: 675,
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <figure className="article-figure">
          <Image
            src="https://res.cloudinary.com/dhgjhspsp/image/upload/v1756228930/audio_1756224766523_5ki8jf_rtels1.webp"
