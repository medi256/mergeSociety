...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/markus-spiske-iar-afB0QQw-unsplash_eifg9s_od6qtp.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/markus-spiske-iar-afB0QQw-unsplash_eifg9s_od6qtp.jpg",
    ],
  },
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <ul>
          <li>
            <Link href="/code-report/algorithms-explained">
              Explore more of Algorithms
            </Link>
          </li>
          <li>
