...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/Books_to_learn_Programming.webp",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/Books_to_learn_Programming.webp",
    ],
        ...
        <section>
          ...
          <section>
            ...
            <p>
              ...
              move to <Link href="/code-report/algorithms">data science</Link>, web backends, or scripting to automate your
              laptop.
            </p>
            <p>
            ...
            <ul>
              ...
              <li>
                <p>
                  ...
                  blends DOM manipulation with <Link href="/css/css-forms">user interface design</Link> and gives
        ...
        <section>
          ...
          <section>
            ...
            <p>
              ...
              <Link href="/code-report/mongodb-explained">horizontal scaling</Link>, and models like key-value, document, and
