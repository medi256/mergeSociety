...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "/mergesociety/rubaitul-azad-cijiWIwsMB8-unsplash_fbusr1_auqweh.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "/mergesociety/rubaitul-azad-cijiWIwsMB8-unsplash_fbusr1_auqweh.jpg",
    ],
  },
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <figure className="blog-image">
          <Image
            src="/mergesociety/rubaitul-azad-cijiWIwsMB8-unsplash_fbusr1_auqweh.jpg"
            alt="MongoDB database architecture visualization"
            width={600}
            height={400}
            priority
