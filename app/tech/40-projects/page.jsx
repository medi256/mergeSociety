...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/van-tay-media--S2-AKdWQoQ-unsplash_cmx2em_mdjbmx.jpg",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    images: [
      "https://afeoolopdqmqjcvsgdxc.supabase.co/storage/v1/object/public/mergesociety/van-tay-media--S2-AKdWQoQ-unsplash_cmx2em_mdjbmx.jpg",
    ],
  },
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <ul>
          ...
          <li>
            <Link href="/tech/javascript-features">
              15 Game Changing JavaScript Framework
            </Link>
          </li>
          <li>
