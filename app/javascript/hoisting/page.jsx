...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/javascript/hoisting",
  },
  openGraph: {
    title:
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          compile phase. This means you can use variables and functions before
          you declare them in your code.
        </p>
        <p>
          However, hoisting can sometimes lead to unexpected behavior,
          especially for beginners. Understanding how hoisting works and
          following best practices can help you write clearer and more
          predictable code.
        </p>
...
`}
        ...
        <p>
          In this example, the declaration of <code>myVar</code> is hoisted to
          the top, but its initialization (assignment of the value{" "}
        ...
        <h3>
          Best Practice: Use <code>let</code> and <code>const</code> for
          Variable Declarations
        </h3>
        <p>
          To avoid issues with hoisting, it's recommended to use{" "}
          <code>let</code> and <code>const</code> instead of <code>var</code>.
          Variables declared with <code>let</code> and <code>const</code> are
          not hoisted to the top of their scope in the same way as{" "}
          <code>var</code>.
        </p>
        <pre>
          <code>
...
`}
        ...
        <p>
          In this example, the <code>sayHello</code> function can be called
          before it is defined because the entire function definition is hoisted
...
`}
        ...
        <p>
          ...
          box (like hoisting variables to the top). However, just because the
          item is in the box doesn't mean you can use it immediately. You have
          to ask the teacher (initialize the variable) to get your item back.
          Using <code>let</code> and <code>const</code> is like having a rule
          that you can't even see the box until the teacher specifically tells
          you about your lost item.
        </p>
        ...
        <p>
          ...
          <code>const</code>, and declaring functions before calling them, you
          can write more predictable and error-free code.
        </p>
