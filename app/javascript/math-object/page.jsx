  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          The <code>Math</code> object is built into JavaScript and offers
          methods and constants for mathematical operations. Think of it as a
          recipe book where each recipe helps you solve different math problems.
        </p>
...
// Output: 2.718281828459045
        ...
        <p>
          <code>Math.abs()</code> returns the absolute value of a number, which
          is the number without its sign. It’s like measuring how far a number
          is from zero.
        </p>
...
// Output: -5
        ...
        <p>
          ...
          (inclusive) and 1 (exclusive). It’s like drawing a random value from a
          hat.
        </p>
...
// Output: 25
        ...
        <p>
          ...
          finding which number multiplied by itself gives you the original
          number.
        </p>
...
// Output: 5
        ...
        <p>
          ...
          types of math problems. Just as you use different recipes for
          different dishes, you use different methods and properties for
