      ...
      <div className="lesson-container">
        <section>
          ...
          <p>
            ...
            finished my homework." Or, "I'll have ice cream OR cake for
            dessert." Logical operators help us express these kinds of decisions
            in our code.
          </p>

          <h3>The AND Operator (&&)</h3>
          <p>
            The AND operator checks if multiple conditions are all true. It's
            like a strict parent who only says "yes" if all the rules are
            followed.
          </p>
          <p>
            In JavaScript, we use two ampersands (&&) for the AND operator.
            Here's how it works:
          </p>
          <pre>
            <code>
...
console.log("Can I buy the toy?", canBuyToy); // Output: Can I buy the toy? true
          ...
          <p>
            The AND operator is incredibly useful when you need to check
            multiple conditions at once. You might use it to verify if a user
            has both entered the correct password AND has the right permissions
            to access a feature, or to check if a game character has enough
            health AND enough mana to cast a spell.
          </p>

          <h3>The OR Operator (||)</h3>
          <p>
            The OR operator checks if at least one of multiple conditions is
            true. It's like a lenient friend who's happy if any of the options
            work out.
          </p>
          <p>
...
console.log("The chosen color is:", finalColor); // Output: The chosen color is: blue
          ...
          <p>
            ...
            several conditions is met. You might use it to check if a user has
            any of several types of membership, or to see if there's any
            available slot in a schedule.
          </p>

          <h3>The NOT Operator (!)</h3>
          <p>
            The NOT operator is like a rebel - it flips the truth value of
            whatever comes after it. If something is true, it makes it false,
            and if something is false, it makes it true.
          </p>
          <p>
...
console.log("Should we go to the beach?", goToBeach); // Output: Should we go to the beach? true
        ...
        <section>
          ...
          <p>
            ...
            examples using these logical operators. Here are some ideas to get
            you started:
          </p>
          <ul>
            <li>
              Create a simple game where a character can only use a special
              ability if they have enough mana AND their health is above a
              certain level.
            </li>
            <li>
            ...
            <li>
              Make a login system where a user can access an area if they have
              the correct password OR if they're an admin.
            </li>
            <li>
              Create a school grading program that gives a student a passing
              grade if they've completed all assignments OR if they've scored
              above 90% on the final exam.
            </li>
          </ul>

          <p>
            Remember, every skilled programmer started exactly where you are
            now. Don't be discouraged if things don't work perfectly right away
            – mistakes are an important part of learning. Keep experimenting,
            stay curious, and most importantly, have fun with your coding
            adventures!
          </p>
