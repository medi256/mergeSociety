  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          Imagine you have a list of tasks to do. Instead of writing the same
          code for each task, you can use a loop to do it for you. There are
          different types of loops in JavaScript, and each one has its own way
          of working. Let's take a look at them.
        </p>

        <h2>for Loops</h2>
        <p>
          The <code>for</code> loop is one of the most common loops in
          JavaScript. It lets us run a piece of code a set number of times. The{" "}
...
`}
        ...
        <ul>
          ...
          <li>
            <b>Condition:</b> The loop keeps running as long as this condition
            is true. It checks this before each loop.
          </li>
          <li>
        ...
        <p>
          ...
          set the timer to 10 seconds. The initialization is setting the timer
          to 10. The condition is checking if the timer is above 0, and the
          increment is counting down by 1 second each time.
        </p>
        <p>
...
`}
        ...
        <p>
          In this example, the loop starts with <code>i</code> set to 1. The
          loop runs as long as <code>i</code> is less than or equal to 5. After
          each loop, <code>i</code> is increased by 1. The loop prints the value
          of <code>i</code> in each round.
        </p>
        ...
        <h2>while Loops</h2>
        <p>
          The <code>while</code> loop is another type of loop. It keeps running
          as long as a condition is true. Unlike the <code>for</code> loop, the{" "}
...
`}
        ...
        <ul>
          <li>
            <b>Condition:</b> The loop keeps running as long as this condition
            is true. It checks the condition before each loop.
          </li>
        </ul>
        <p>
          Think of a <code>while</code> loop like a traffic light. The light
          stays green as long as there are no cars waiting. The condition is
          whether there are cars waiting. If the condition is true (no cars
          waiting), the light stays green.
        </p>
        <p>
          Here's an example that prints the numbers from 1 to 5 using a{" "}
...
`}
        ...
        <p>
          The <code>do-while</code> loop is like the <code>while</code> loop,
          but it always runs the code block at least once before checking the
...
`}
        ...
        <p>
          In this example, the code block inside the <code>do</code> section
          runs first, printing the value of <code>i</code>. After that, the
          condition is checked. If it's true, the loop runs again.
        </p>
        <p>Breaking it down:</p>
        <ul>
          <li>
...
`}
        ...
        <p>
          Here's an example where we go through the properties of an object
          using a <code>for...in</code> loop:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="javascript" style={docco}>
...
`}
        ...
        <p>
          Think of a <code>for...of</code> loop like reading a book. Each page
          is an element, and you go through each page one by one. The loop
          variable is the current page you are reading.
        </p>
        <p>
...
`}
        ...
        <p>
          ...
          about the different types of loops and how they work, you'll be able
          to write better and shorter code.
        </p>
        <p>
