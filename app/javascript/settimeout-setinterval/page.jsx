  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          JavaScript allows us to perform tasks after a certain time has passed
          or to repeat tasks continuously at regular intervals. To do this, we
          use two special functions: <code>setTimeout</code> and{" "}
        ...
        <p>
          ...
          setting an alarm: the task won’t happen immediately, but it will
          happen after the time you set has passed.
        </p>
...
setTimeout(function, delay);
        ...
        <ul>
          ...
          <li>
            <code>delay</code>: This is the time (in milliseconds) to wait
            before running the function. 1 second = 1000 milliseconds.
          </li>
        </ul>
...
setTimeout(function() {
  console.log("2 seconds have passed!");
        ...
        <ul>
          ...
          <li>
            Then, <code>setTimeout</code> waits for 2 seconds (2000
            milliseconds) before running the second <code>console.log</code>{" "}
            that displays "2 seconds have passed!".
          </li>
        </ul>

        <p>
          This shows how <code>setTimeout</code> delays a task without stopping
          the rest of the code from running. The delayed task runs later, once
          the timer is up.
        </p>
        ...
        <p>
          ...
          comes in. It’s like setting an alarm that keeps ringing every 5
          minutes until you stop it.
        </p>
...
setInterval(function, interval);
        ...
        <ul>
          ...
          <li>
            <code>interval</code>: This is the time (in milliseconds) between
            each repetition of the function.
          </li>
        </ul>
...
setInterval(function() {
  console.log("3 seconds have passed!");
        ...
        <p>
          ...
          intervals. It doesn’t stop by itself—you need to manually stop it if
          you want it to end.
        </p>
