    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          separate boxes for each song, you put them all in one big box. This
          big box helps you keep your songs organized in one place. In
          JavaScript, an array is like that big box. It's a special variable
          that can hold a collection of items (called elements) together. These
          items can be anything: numbers, strings, or even other arrays.
        </p>
        <p>
          Just like you can add, remove, or find a specific song in your box,
          you can perform similar operations on elements in an array. Each
          element in an array can be accessed by its position, known as its
          index.
        </p>
...
console.log(fruits); // Output: ['apple', 'banana', 'cherry']
    `}
        ...
        <p>
          ...
          contains three string elements: 'apple', 'banana', and 'cherry'. You
          can also create arrays with different types of elements:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="javascript" style={docco}>
...
console.log(mixedArray); // Output: [1, 'hello', true, 3.14]
    `}
        ...
        <p>
          Each element in an array has a position, which is called its index.
          The index of an array starts from 0, meaning the first element is at
          index 0, the second element is at index 1, and so on. Let's see how to
          access elements:
        </p>
        <pre>
          <code>
...
console.log(colors[2]); // Output: blue
    `}
        ...
        <p>
          Here, <code>colors[0]</code> gives us 'red', and{" "}
          <code>colors[2]</code> gives us 'blue'. The square brackets{" "}
          <code>[]</code> are used to access the elements by their index.
        </p>
...
console.log(fruits); // Output: ['apple', 'blueberry', 'cherry']
    `}
        ...
        <p>
          Here, we changed the value of the second element (index 1) from
          'banana' to 'blueberry'.
        </p>
...
console.log(fruits); // Output: ['apple', 'banana', 'cherry', 'date', 'elderberry', 'fig']
    `}
        ...
        <p>
          In this example, we used <code>push()</code> to add 'date' to the end
          of the <code>fruits</code> array. The <code>push()</code> method can
          also add multiple elements at once, as shown with 'elderberry' and
          'fig'.
        </p>
...
console.log(fruits); // Output: ['banana', 'cherry']
    `}
        ...
        <p>
          ...
          <code>shift()</code> method returns the removed element, which we
          stored in the <code>firstFruit</code> variable.
        </p>
        ...
        <p>
          A <code>for</code> loop is a way to repeat an action for each element
...
// cherry
    `}
        ...
        <p>
          A <code>for...of</code> loop is another way to iterate over the
          elements of an array. Here's an example:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="javascript" style={docco}>
...
// cherry
    `}
        ...
        <h2>Conclusion</h2>
        <p>
          Arrays are a powerful way to organize and work with collections of
          data in JavaScript. They allow you to store multiple values in a
