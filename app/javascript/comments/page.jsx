    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          leave notes, JavaScript allows us to add comments to our code.
          Comments are lines of text that are ignored by the computer when the
          code runs. They act like hidden messages for you or other programmers
          who might read your code in the future.
        </p>
        ...
        <ul>
          ...
          <li>
            {" "}
            <b>Improve Readability</b>: Code with comments is like a
            well-written story – it has a clear flow and makes sense to the
            reader. Comments break down complex parts and add context.
          </li>
          <li>
            <b>Documentation</b>: Comments can serve as documentation within
            your code, explaining the purpose of different functions, variables,
            or code blocks.
          </li>
          <li>
            {" "}
            <b>Debugging</b>: Adding comments as you write code can help you
            identify and fix errors (debugging) more efficiently. Comments can
            act as reminders or notes about specific parts of the code.
          </li>
        </ul>
...
let message = "Hello, world!";
        ...
        <ul>
          ...
          <li>
            {" "}
            Everything between /* and */ will be considered a comment, even if
...
let age = 25;
        ...
        <p>
          <b>Remember</b>: Comments are for humans, not computers. Write them in
          a way that is easy to understand for anyone reading your code.
        </p>
