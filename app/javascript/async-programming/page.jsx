    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          steps in a recipe. This is called <code>synchronous</code>{" "}
          programming, where each step waits for the previous one to finish
          before moving on. However, not everything can or should happen one by
          one. For example, imagine you’re cooking and you need to boil water.
          While waiting for the water to boil, you can chop vegetables. You
          don’t have to stop everything and wait for the water before moving to
          the next task.
        </p>
...
`}
        ...
        <p>
          ...
          for the longer tasks to complete. Once those tasks are done,
          JavaScript comes back to them and completes the necessary actions.
        </p>
...
`}
        ...
        <ul>
          ...
          <li>
            ...
            complete this task. Instead, it moves on to the next task right
            away.
          </li>
          <li>
            <strong>Task 3</strong> runs immediately after Task 1 without
            waiting for Task 2 to finish, printing "Task 3: Continue without
            waiting".
          </li>
          <li>
            Once 2 seconds have passed, Task 2 finally executes, printing "Task
            2: Delayed by 2 seconds".
          </li>
        </ul>

        <p>
          Notice how Task 3 happens immediately, even though Task 2 has a delay.
          This is how asynchronous programming works: certain tasks can happen
          in the background, and JavaScript doesn’t have to wait for them to
          finish before moving on to other things.
        </p>
        ...
        <p>
          ...
          JavaScript to handle these time-consuming tasks in the background
          while keeping the rest of the program running smoothly.
        </p>

        <h2>Real-Life Example: Making a Meal</h2>
        <p>
          Let’s imagine you’re cooking dinner. Some tasks take time, like
          boiling water or baking something in the oven. You don’t just stand
          there waiting for the water to boil—you do other things, like chopping
        ...
        <p>
          A <code>single-threaded</code> language like JavaScript handles one
          task at a time. In contrast, a <code>multi-threaded</code> language
          can handle multiple tasks at once. Even though JavaScript is
        ...
        <p>
          In the upcoming sections, we will dive into <code>how</code>{" "}
          JavaScript handles these asynchronous tasks behind the scenes using
        ...
        <p>
          But for now, remember that asynchronous programming allows JavaScript
          to handle tasks that take time without stopping everything else,
          making your web applications faster and more responsive.
        </p>
