...
export const metadata = {
  title: "JavaScript Objects: A Comprehensive Guide",
  description:
    "Explore the world of objects in JavaScript. Learn how to create, access, and manipulate objects efficiently. This tutorial will guide you through object creation, properties, methods, and various ways to interact with objects. Discover the power of objects in building dynamic applications.",
  keywords: [
    "javascript",
    "objects",
    "javascript objects",
  ...
  alternates: {
    canonical: "https://mergesociety.com/javascript/objects",
  },

  openGraph: {
    title: "JavaScript Objects: The Ultimate Guide",
    description:
      "Master the art of objects in JavaScript. This comprehensive guide will teach you how to create objects, access and modify properties, use methods, and combine objects. Learn to manage complex data structures and create dynamic applications.",
  },
};
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          manage and use them. Imagine an object like a real-world thing, such
          as a car. A car has different features, like its color, model, and
          year. Similarly, in JavaScript, an object can have different
          properties.
        </p>
        <p>
          Think of an object as a box (the object) where you can keep different
          items (properties). Each item has a name (key) and a value. For
          example, a box might have a label that says "Car Color" and inside it,
          you have a value like "Red."
        </p>
...
color: 'red'      // This is a property with key 'color' and value 'red'
    ...
    `}
        ...
        <p>
          You can get the values of properties in an object in two ways: using
          dot notation or bracket notation.
        </p>

        <h3>Dot Notation</h3>
        <p>
          Dot notation is simple and direct. You use a dot <code>.</code>{" "}
...
console.log(carMake);     // Output: Toyota
    `}
        ...
        <p>
          Here, <code>car.make</code> retrieves the value of the{" "}
          <code>make</code> property from the <code>car</code> object.
        </p>
...
console.log(car.hasOwnProperty('owner')); // Output: false
    `}
        ...
        <p>
          ...
          <code>for...in</code> loop. This loop allows you to access each
          property name and its value. Here’s an example:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="javascript" style={docco}>
...
console.log(key + ': ' + car[key]); // Log each property name and value
    ...
    `}
        ...
        <p>
          The loop iterates over each property in the <code>car</code> object
          and logs the property name (key) and its value.
        </p>

        <h2>Combining Objects</h2>
        <p>
          Sometimes you might want to combine properties from two objects. You
          can do this using the <code>Object.assign()</code> method or the
...
// Output: { make: 'Toyota', model: 'Corolla', year: 2020, color: 'red' }
    `}
        ...
        <p>
          ...
          from <code>carDetails</code> and <code>carSpecs</code> into a new
          object <code>combinedCar</code>.
        </p>
