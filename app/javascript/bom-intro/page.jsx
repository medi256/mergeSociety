  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          The BOM represents everything about the browser itself, like the
          window, the current URL, and the history of pages you’ve visited.
          While the DOM deals with the content of the web page, the BOM helps
        ...
        <p>
          ...
          with the browser environment. Let’s take a closer look at some of
          these key components:
        </p>
        <ul>
          <li>
            <b>Window Object:</b> This is like the main dashboard of your
            browser. It represents the browser window and provides methods to
            interact with it, such as displaying alerts, confirming actions, and
        ...
        <p>
          The BOM allows you to create interactive and dynamic experiences
          beyond the content of the web page. Here are a few examples of what
          you can do with the BOM:
        </p>
        <ul>
          <li>
        ...
        <p>
          ...
          gives you information about your surroundings (the browser) and lets
          you control things outside the spaceship.
        </p>

        <h2>The Difference Between the DOM and BOM</h2>
        <p>
          Now that we understand what the BOM is, it’s important to understand
          the difference between the DOM and the BOM:
        </p>
        <ul>
          <li>
            <b>DOM (Document Object Model):</b> The DOM is like the blueprint of
            a house. It represents the structure of a web page, including
            elements like headings, paragraphs, and images. It's all about the
            content and structure of the web page.
          </li>
          <li>
            <b>BOM (Browser Object Model):</b> The BOM is like the control panel
            of the house. It represents the browser's environment in which the
            web page exists. It includes things like the window, location,
            history, and screen, which are not part of the web page's content
            but are related to the browser itself.
          </li>
        </ul>

        <h2>Conclusion</h2>
        <p>
          The BOM is like the control panel of your web browser spaceship,
          giving you tools to interact with the browser environment and enhance
          user experiences. While the DOM focuses on the content and structure
          of the web page, the BOM opens up possibilities beyond the page
          itself, allowing you to create more dynamic and interactive web
          applications. So, buckle up and get ready to explore the vast universe
          of the BOM!
        </p>
