    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        <section>
          ...
          <p>
            In JavaScript, we use two equal signs (==) for the equality
...
// This is true because == converts the string '5' to a number before comparing
          ...
          <p>
            This operator is like the equality operator's stricter sibling. It
            not only checks if the values are equal, but also if they're of the
            same type (like both being numbers, or both being strings).
          </p>
          <p>
            In JavaScript, we use three equal signs (===) for the strict
            equality operator. Here's how it works:
          </p>
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
...
console.log("completeString === true:", completeString === true);   // Output: completeString === true: false
          ...
          <p>
            ...
            it helps prevent bugs that can occur when different types of data
            are unexpectedly treated as equal. It's often recommended to use ===
...
// This is false because != converts the string '5' to a number before comparing
          ...
          <p>
            The inequality operator is useful when you need to check if two
            values are not the same. You might use it to verify if a user's
            input is different from an expected value, or to check if a game
            state has changed.
          </p>

          <h3>The Greater Than {` (>) `} and Less Than (&lt;) Operators</h3>
          <p>
            These operators help us compare numbers to see which one is bigger
            or smaller. It's like having a balance scale to weigh two items.
          </p>
          <p>
...
console.log("Is the weight within the limit?", withinWeightLimit); // Output: Is the weight within the limit? true
          ...
          <p>
            ...
            conditions. As you practice using these operators, you'll see how
            they can be combined with what you learned about arithmetic
            operators to solve more complex problems and create more interactive
            programs!
          </p>
        </section>
        ...
        <section>
          ...
          <ul>
            <li>
              Logical Operators: These are for combining multiple conditions,
        ...
        <section>
          ...
          <ul>
            <li>
              Create a simple quiz game where you compare the user's answer to
              the correct answer.
            </li>
            <li>
            ...
            <li>
              ...
              based on the temperature (e.g., "It's freezing!" if the
