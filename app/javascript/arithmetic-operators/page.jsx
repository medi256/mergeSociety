    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <section>
          ...
          <p>
            Imagine you're in a kitchen. You have ingredients (these are like
            your data in JavaScript), and you want to do things with them.
            Operators are like the kitchen tools that help you work with these
            ingredients.
          </p>
          <p>
            In JavaScript, operators are special symbols or keywords that tell
            the computer to perform specific actions with our data. They're like
            the magic wands of coding!
          </p>
          <p>
            For example, just like you use a knife to cut vegetables or a spoon
            to mix ingredients, in JavaScript, you use operators to combine
            numbers, compare values, or assign data to variables. These
            operators are the basic tools that allow you to manipulate and work
            with information in your code.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            Each type of operator serves a different purpose, just like
            different kitchen tools. Arithmetic operators are like your
            measuring cups and scales, helping you with numbers. Comparison
        ...
        <section>
          ...
          <p>
            ...
            life, it's like combining items. For example, if you have 3 apples
            and someone gives you 2 more, you now have 5 apples in total.
          </p>
          <p>
...
console.log("Result:", result); // Output: Result: -5
          ...
          <p>
            The subtraction operator is crucial for many types of calculations
            in programming. You might use it to calculate the remaining lives in
            a game, the balance in a bank account after a withdrawal, or the
          ...
          <p>
            In JavaScript, we use the asterisk (*) for multiplication. Here's
            how it works:
          </p>
          <pre>
            <code>
...
console.log("Product:", product); // Output: Product: 24
          ...
          <p>
            ...
            to calculate the total price of multiple items, determine the area
            of a rectangle, or figure out compound interest in a financial
            application.
          </p>

          <h3>The Division Operator (/)</h3>
          <p>
            This splits numbers into equal parts. In real life, it's like
            sharing a pizza equally among friends. If you have 8 slices of pizza
            and 4 friends, each friend gets 8 / 4 = 2 slices.
          </p>
          <p>
...
console.log("Fraction:", fraction); // Output: Fraction: 0.5
          ...
          <p>
            Division is essential in many programming scenarios. You might use
            it to calculate averages, determine the percentage of completed
            tasks, or split a bill among friends in a restaurant app.
          </p>

          <p>
            These arithmetic operators are just the beginning of your JavaScript
            journey! As you practice and become more comfortable with them,
            you'll see how they can be combined to perform more complex
            calculations. Remember, the key to mastering these concepts is
            practice and experimentation. Don't be afraid to try out different
        ...
        <section>
          ...
          <ul>
            ...
            <li>
              Logical Operators: These are for making decisions in your code,
              like "If I have enough money AND the store is open, I'll buy the
              toy."
            </li>
            <li>
              Assignment Operators: These are handy shortcuts for changing
              values, like quickly adding points to your score in a game.
            </li>
          </ul>
          <p>
        ...
        <section>
          ...
          <ul>
            <li>
              Calculate how much money you'll have left after buying some
              treats.
            </li>
            ...
            <li>
              Calculate the area of your room (length * width) and then figure
              out how many small rugs (each 2 square meters) would fit in it.
            </li>
          </ul>
          <p>
            Remember, every great programmer started where you are now. The more
            you practice, the better you'll get. Don't worry if you make
            mistakes – they're a normal part of learning. Keep experimenting and
            have fun with it!
          </p>
