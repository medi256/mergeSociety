  ...
  return (
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          The History object is like a record of the pages you've visited in
          your current browsing session. Think of it as a list of web pages that
          the browser keeps track of as you move from one page to another. With
          the History object, you can go back to the previous page you visited
          or go forward to a page you navigated away from.
        </p>
        <p>
        ...
        <ul>
          <li>
            <code>back()</code>: This method takes you to the previous page in
            the session history. It's like clicking the back button in your
            browser.
          </li>
          <li>
            <code>forward()</code>: This method takes you to the next page in
            the session history. It's like clicking the forward button in your
            browser.
          </li>
          <li>
            <code>go()</code>: This method allows you to go to a specific page
            in the session history. You can tell it how many pages to move back
            or forward. For example, <code>history.go(-1)</code> takes you to
            the previous page, and <code>history.go(1)</code> takes you to the
            next page.
          </li>
        </ul>
...
<button onclick="goToPage(-1)">Go to Previous Page</button>
        ...
        <p>
          ...
          navigate through the session history. The <code>goBack()</code>{" "}
          function moves to the previous page, the <code>goForward()</code>{" "}
          function moves to the next page, and the <code>goToPage()</code>{" "}
          function moves to a specific page in the history based on the number
          you provide.
        </p>
        ...
        <p>
          ...
          navigate through the session history and manipulate history entries.
          The History object is an important part of the BOM, and understanding
          how to use it can help you build more dynamic and interactive web
          applications.
        </p>
        <p>
