...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/javascript/json",
  },
...
const JSON = () => {
    ...
    <div className="lesson-wrapper">
      ...
      <div className="lesson-container">
        ...
        <p>
          ...
          objects and arrays. It looks very similar to JavaScript object
          literals, which is one reason it's so intuitive for JavaScript
          developers to use.
        </p>
    ...
    "address": {
      ...
      "city": "Anytown"
        ...
        <p>
          ...
          and the values can be strings, numbers, booleans, arrays, or even
          other objects.
        </p>

        <h2>Why JSON is Important</h2>
        <p>
          JSON is important because it's the standard format for data exchange
          in web development. When you request data from a server (e.g., using
          an API), the response is often in JSON format. Similarly, when you
          send data to a server, it's often sent as JSON.
        </p>

        <h3>Analogy: JSON as a Package</h3>
        <p>
          Think of JSON as a package you send or receive in the mail. The
          package contains information organized in a way that's easy to
          understand. When you open the package (i.e., parse the JSON), you can
          easily access and use the information inside.
        </p>
        ...
        <h3>
          1. Converting JavaScript Objects to JSON:{" "}
  ...
  // Output: '{"name":"Alice","age":25,"isStudent":true}'
        ...
        <p>
          In this example, we have a JavaScript object <code>user</code>. When
          we pass it to <code>JSON.stringify()</code>, it returns a JSON string
  ...
  console.log(user.age);   // Output: 28
        ...
        <p>
          JSON is used in many scenarios in web development. Here are a few
          common use cases:
        </p>
  ...
  fetch('https://api.example.com/data')
    ...
    .then(data => {
      console.log(data);
        ...
        <p>
          In this example, the <code>fetch()</code> method retrieves data from
          an API, and <code>response.json()</code> automatically parses the JSON
        ...
        <ul>
          ...
          <li>
            JSON does not support functions or special objects like Date, Map,
            or Set.
          </li>
          <li>
