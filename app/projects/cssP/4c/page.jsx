...
export const metadata = {
  ...
  keywords: [
    ...
    "css projects",
    "learn css through practicing",
    "beginner css html project step by step",
    "css html projects",
  ],
  alternates: {
    canonical: "https://mergesociety.com/projects/cssP/4c",
  },
      ...
      <article className="lesson-container">
        ...
        <div>
          ...
          <p>
            ...
            our code. We recommend{" "}
            <Link href="/react/code-editor-setup">Visual Studio Code</Link>{" "}
            because it's free and beginner-friendly!
          </p>
          <ol>
            <li>
...
.plan button:hover {
  background-color: #0056b3;
        ...
        <p>
          ...
          adding responsive design using CSS{" "}
          <Link href="/css/css-responsive-design">media queries</Link>.
        </p>
        <ol className="space-y-6">
          <li>
            <strong>1. Open "styles.css":</strong> Open the "styles.css" file in
  ...
  .plan {
    margin-bottom: 20px;
        ...
        <p>
          ...
          view the pricing table on different devices, you'll see the layout
        ...
        <p>
          Let's add the final touches to our responsive pricing table to ensure
  ...
  transition: transform 0.3s ease;
        ...
        <p>
          ...
          Pricing Table." You've learned how to create a fully responsive
