...
const PortfolioLayout = () => {
  ...
  const tutorialSteps = [
      ...
      content: (
        <>
          ...
          <ul>
            ...
            <li>
              Think of HTML as the skeleton of your website (the structure) and
              CSS as the skin and clothes (the style).
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              No previous coding experience required - we'll explain everything
              step by step!
            </li>
          </ul>
        </>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <p>
            First, we need a special program to write our code. While you could
            use Notepad or TextEdit, we recommend Visual Studio Code (VS Code)
            because it's free and helps you write code better:
          </p>
          <ol>
            <li>
          ...
          <ol>
            <li>Open VS Code</li>
            <li>
              Click on File → Open Folder (Windows) or File → Open... (Mac)
            </li>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                The name "index.html" is special - web servers look for this
                file automatically
              </li>
              <li>
                Double-check your spelling - computers are very picky about
                exact names!
              </li>
            </ul>
          </div>
    ...
    {
      title: "Building Your HTML Structure",
      content: (
        <>
          <h3>📝 Writing Your First HTML Code</h3>
          <ScrollToTop />
          <p>
            Now that we have our files ready, let's write the basic HTML
            structure for your portfolio. HTML is like building blocks - we'll
            add each piece step by step.
          </p>
...
<body>
    ...
    {
      title: "Adding Your Portfolio Content",
      content: (
        <>
          <ScrollToTop />
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ScrollToTop />
          <p>
            Now that we have our content, let's make it look professional with
            CSS. We'll style each section step by step.
          </p>
    ...
    },
    {
      ...
      content: (
        <>
          ...
          <ScrollToTop />
          <p>
            You've successfully built a personal portfolio website using HTML
            and CSS! You've learned how to structure content, style it, and make
            it responsive.
          </p>
          <p>
