...
export const metadata = {
  ...
  keywords: [
    "portfolio website CSS project for beginners",
    "HTML and CSS portfolio website tutorial",
    "personal portfolio website tutorial",
    "building a portfolio website from scratch",
    "creating a portfolio website with CSS",
    "Styling project with  CSS",
  ...
  return (
    <div className="project-container">
      <article style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
        ...
        >
          Style Your Personal Portfolio with CSS
        </h1>
        ...
        <p>
          ...
          language, so that even if you're new to web development, you'll be
          able to follow along and create your own portfolio.
        </p>
        ...
        <ol>
          ...
          <li>
            Find and select your "my-portfolio" folder, then click "Open".
          </li>
        </ol>
        <p>
...
<body>
    ...
    <p class="bio">A passionate developer focused on creating interactive websites</p>
        ...
        <p>
          This section will include your name, job title (e.g., "Web
          Developer"), and a brief bio about yourself.
        </p>
        <ul>
          <li>
    ...
    <ul class="skills-list">
        ...
        <ul>
          <li>
            The <code>&lt;section&gt;</code> tag is used to group related
            content together.
          </li>
          <li>
          ...
          <li>
            ...
            <code>&lt;li&gt;</code> (list item) tags are used to display the
            list of skills.
          </li>
          <li>
    ...
    <div class="project-grid">
        ...
        <ul>
          ...
          <li>
            ...
            project, with an <code>&lt;h3&gt;</code> tag for the project title
            and a <code>&lt;p&gt;</code> tag for the project description.
          </li>
          <li>
    ...
    <p>LinkedIn: your-linkedin-profile</p>
        ...
        <p>
          Remember, this is your portfolio, so make sure the content reflects
...
.skills-list li {
    ...
    font-size: 0.9rem;
        ...
        <ul>
          ...
          <li>
            <code>{`.skills-list`}</code> styles the list of skills, removing
            the default list style and displaying the items in a flexible,
            wrapping layout.
          </li>
          <li>
...
.project p {
    color: #666;
        ...
        <ul>
          <li>
            <code>{`.project-grid`}</code> uses the CSS grid layout to display
            the project items in a grid.
          </li>
          <li>
            ...
            available space, with a minimum width of 250px for each project
            item.
          </li>
          <li>
          ...
          <li>
            <code>{`.project`}</code> styles the individual project items,
            giving them a white background, rounded corners, and a subtle
            shadow.
          </li>
          <li>
            <code>{`.project h3`}</code> and <code>{`.project p`}</code> style
            the project title and description, respectively.
          </li>
        </ul>
...
footer p {
    margin-bottom: 10px;
        ...
        <p>
          To ensure your portfolio looks great on different devices, follow
          these steps:
        </p>
        <ol>
          <li>
...
footer p {
    margin-bottom: 10px;
        ...
        <h2>Conclusion</h2>
        <p>
          Congratulations! You've now created a basic portfolio website using
          HTML and CSS. This tutorial has provided you with a solid foundation
          to build upon. Remember, this is just the beginning - you can continue
          to customize and expand your portfolio as you learn more.
        </p>
        <p>
