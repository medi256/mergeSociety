...
export const metadata = {
  ...
  alternates: {
    canonical: "https://mergesociety.com/projects/cssP/6c",
  },
  ...
  return (
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        <h1>Creating a CSS Animation for Button Hover Effects</h1>
...
.btn:hover {
  background-color: #0056b3;
        ...
        <ul>
          ...
          <li>
            <code>.btn:hover</code>: Changes the background color of the button
            on hover.
          </li>
          <li>
