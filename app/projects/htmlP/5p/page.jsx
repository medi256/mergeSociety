...
const PhotoGallery = () => {
  ...
  const tutorialSteps = [
    {
      title: "Let's Start Building Our Photo Gallery!",
      content: (
        <>
          <h2>Welcome to Your First Photo Gallery Project! 📸</h2>
          <ScrollToTop />
          <p>
            Hey there! Today, we're going to build something really cool - your
            very own photo gallery! Think of it like creating a digital photo
            album where you can show off your favorite pictures with nice
            descriptions.
          </p>
          ...
          <div>
            ...
            <ul>
              ...
              <li>
                <strong>Organize Everything Neatly:</strong> Make your gallery
    ...
    },
    {
      ...
      content: (
        <>
          <ScrollToTop />
          <h2>Setting Up Your Project Space 🎨</h2>

          <div>
            <h3>Think of it Like This...</h3>
            <p>
              Setting up your workspace is like preparing to cook in a kitchen:
              you need a clean counter (your folder), your recipe book (text
              editor), and your ingredients (your pictures)! Let's get
          ...
          <div>
            ...
            <p>
              First, let's create a special folder for your project. Think of
              this as your photo album's home!
            </p>
          ...
          <div>
            ...
            <ul>
              <li>
                <strong>Visual Studio Code (VS Code)</strong> - Like a Swiss
                Army knife for coding. It's free and super helpful!
              ...
              <li>
                <strong>Sublime Text</strong> - Fast and lightweight, works on
                all computers
              </li>
            </ul>
            <p>
          ...
          <div>
            ...
            <p>
              If you've got all these ready, you're all set to start building
              your gallery in the next step! 🚀
            </p>
          </div>
        </>
      ),
    },
    {
      ...
      content: (
        <>
          <h2>Building Your Gallery's Foundation 🏗️</h2>
          <ScrollToTop />
          ...
          <div>
            ...
            <ul>
              <li>
                The <code>&lt;!DOCTYPE html&gt;</code> is like your building
                permit
              </li>
              <li>
              ...
              <li>
                The <code>&lt;body&gt;</code> is where you'll put all your
                furniture (content)
              </li>
            </ul>
          </div>
...
<body>
    <h1>My Photo Gallery</h1>
            ...
            <div>
              ...
              <ul>
                <li>
                  <code>&lt;!DOCTYPE html&gt;</code>: Tells the browser this is
                  a modern webpage
                </li>
                <li>
                  <code>&lt;html lang="en"&gt;</code>: Says our page is in
                  English
                </li>
                <li>
                  <code>&lt;head&gt;</code>: Contains information about our
                  webpage
                </li>
                <li>
                  <code>&lt;title&gt;</code>: The name that appears on the
                  browser tab
                </li>
                <li>
                  <code>&lt;body&gt;</code>: Where all your visible content will
                  go
                </li>
                <li>
          ...
          <div>
            ...
            <p>
              You should see "My Photo Gallery" as a big heading on a white
              page. That's your first webpage! 🎉
            </p>
          </div>
        ...
        <>
          ...
          <div>
            ...
            <p>
              ...
              <code>&lt;figure&gt;</code>) to hold each photo and its caption -
              just like how each photo in an album has its own pocket and label!
            </p>
          </div>
            ...
            <ol>
              <li>
                ...
                <ul>
                  ...
                  <li>
                    Make sure they're not too large (under 1MB each is good)
                  </li>
                  <li>
    ...
    <figure>
        ...
        <figcaption>My Third Photo - Add an interesting caption here!</figcaption>
            ...
            <div>
              ...
              <ul>
                <li>
                  <code>&lt;section&gt;</code>: Like a chapter in your photo
                  album
                </li>
                <li>
                  <code>&lt;figure&gt;</code>: A container for each photo and
                  its caption
                </li>
                <li>
          ...
          <div>
            ...
            <p>
              You should see your photos with captions displayed on the page.
              That's your photo gallery! 🎉
            </p>
          </div>
      ...
      content: (
        <>
          ...
          <div>
            ...
            <p>
              Your photo gallery is almost complete! Let's add some final
              touches and ensure it follows best practices.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              ...
              load times. Tools like TinyPNG or online image compressors can
              help reduce file sizes without compromising quality.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Make sure your <code>alt</code> text accurately describes the
              image content. This is essential for accessibility and SEO.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Use consistent image sizes to maintain a clean layout. You can
              adjust image dimensions using image editing tools.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              If you wish to add more information about each image, you can
              include a paragraph or additional text within the{" "}
          ...
          <div>
            ...
            <p>
              Here's an example of the final HTML code with some additional
              images and captions:
            </p>
            <pre>
              <code>
    ...
    <section>
        ...
        <figure>
          ...
          <div>
            ...
            <ul>
              <li>
                Add more photos by copying the <code>&lt;figure&gt;</code>{" "}
                section
              </li>
              <li>
                Change the colors in the CSS by modifying the color codes (once
                you learn CSS!)
              </li>
              <li>
                Adjust the spacing by changing the padding and margin values
                (once you learn CSS!)
              </li>
  ...
  return (
    <div className="lesson-container">
      <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
        ...
        >
          Building Your First Photo Gallery
        </h1>
