...
export const metadata = {
  ...
  keywords: [
    ...
    "HTML projects for beginners tutorial",
    "HTML projects for beginners easy",
    "HTML projects for beginners examples",
    "HTML projects for beginners with explanation",
    "HTML projects for beginners with tutorial",
    "HTML projects for beginners with code and explanation",
    "HTML projects for beginners with code and tutorial",
...
const RestaurantMenuHtml = () => {
    ...
    <div className="lesson-wrapper">
      ...
      <article className="lesson-container">
        ...
        <p>
          ...
          menu to show their customers, but instead of using paper, we're going
          to create it for their website! Think of it like building a digital
          version of those menus you see at restaurants.
        </p>
        ...
        <div className="windows-instructions">
        ...
        <div className="tip-box">
          ...
          <p>
            ...
            the front door when visiting a restaurant!
          </p>
        </div>
        ...
        <p>
          ...
          digital <Link href="/projects/htmlP/4p">restaurant menu</Link>.
        </p>
  ...
  <footer>
    <p>© 2024 Yummy Restaurant</p>
        ...
        <p>
          ...
          like appetizers, main courses, and desserts. We're going to create
          these sections in our digital menu!
        </p>
  ...
  <div class="menu-section">
    <!-- We'll add main course items here -->
        ...
        <ul>
          <li>
            <code>&lt;section id="main-courses"&gt;</code> is the section for
            main dishes.
          </li>
          <li>
    ...
    <!-- We'll add dessert items here -->
        ...
        <div className="try-it-yourself">
          ...
          <p>
            ...
            see the section titles for appetizers, main courses, and desserts.
          </p>
        </div>
...
<div class="menu-item">
  ...
  <p class="description">
    Tender chicken breast in a creamy Alfredo sauce over fettuccine pasta.
        ...
        <p>
          Inside the <code>&lt;div class="menu-section"&gt;</code> of the
          desserts section, add the following code:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="html" style={docco}>
...
<div class="menu-item">
  ...
  <p class="description">
    Homemade apple pie with a flaky crust, served with whipped cream.
        ...
        <div className="try-it-yourself">
          ...
          <p>
            Save your file and refresh it in your web browser. You should now
            see all the menu items listed in their respective sections.
          </p>
        </div>
        ...
        <p>
          ...
          bit plain. Let's add some navigation links and basic styling to make
  ...
  <ul>
    ...
    <li><a href="#desserts">Desserts</a></li>
        ...
        <ul>
          <li>
            <code>&lt;nav&gt;</code> is used to define a set of navigation
            links.
          </li>
          <li>
          ...
          <li>
            <code>&lt;a href="#appetizers"&gt;</code> is a hyperlink that links
            to the appetizers section.
          </li>
        </ul>
        ...
        <div>
          ...
          <p>
            Save your file and refresh it in your web browser. You should now
            see a navigation bar at the top of the page, and clicking the links
            should take you to the corresponding sections.
          </p>
        </div>
        ...
        <p>
          ...
          them, we need to test our menu to make sure everything works
          perfectly.
        </p>
  ...
  <footer>
    ...
    <p class="copyright">© 2024 Yummy Restaurant. All rights reserved.</p>
        ...
        <div className="try-it-yourself">
          ...
          <p>
            You should see the complete restaurant menu with all sections,
            items, and navigation links working correctly.
          </p>
        </div>
...
export const HtmlProjectssssss = () => {
