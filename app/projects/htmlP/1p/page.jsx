  ...
  return (
    ...
    >
      ...
      <p>
        ...
        together, let's understand what we're going to create and learn. By the
        end of this guide, you'll have your very own website that looks
      ...
      <ul>
        ...
        <li>A positive attitude - remember, everyone starts as a beginner!</li>
      </ul>
      ...
      <p>
        ...
        website files. Think of this like creating a new folder for an important
        school project.
      </p>
...
<html lang="en">`}
      ...
      <ul>
        <li>
          <code>&lt;!DOCTYPE html&gt;</code> is like telling your browser "Hey,
          this is a webpage!"
        </li>
        <li>
...
<body>
    ...
    <h2>Web Developer in Training</h2>
      ...
      <ul>
        ...
        <li>"Web Developer in Training" tells visitors what you're learning</li>
    ...
    <h2>About Me</h2>
      ...
      <ul>
        ...
        <li>
          The <code>&lt;h2&gt;</code> shows visitors what this section is about
        </li>
      </ul>
    ...
    <p>When I'm not coding, I enjoy [write your hobbies here].</p>
      ...
      <p>After your About Me section, let's show what you're learning. Add:</p>
      <SyntaxHighlighter language="html" style={docco}>
        {`<section>
    <h2>My Skills</h2>
</section>`}
    ...
    <p>GitHub: <a href="https://github.com/yourusername">My GitHub Profile</a></p>
      ...
      <p>
        Now that we've built everything piece by piece, here's how your complete
        website should look:
      </p>
      <SyntaxHighlighter language="html" style={docco}>
        {`<!DOCTYPE html>
