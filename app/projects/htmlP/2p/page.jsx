...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/js_hjlvsn_ktm5kv.webp",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Learn how to create a professional HTML resume with this step-by-step tutorial. Perfect for beginners looking to build a resume from scratch using HTML.",
    images: ["https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/js_hjlvsn_ktm5kv.webp"],
  },
  robots: {
    index: true,
    follow: true,
...
const HtmlResume = () => {
  return (
    <div className="lesson-wrapper">
      ...
      >
        <h1>Learn How to Create a Professional Resume Using HTML</h1>
        ...
        <div>
          ...
          <div>
            ...
            <p>
              ...
              the next step, we'll start writing the basic HTML structure for
              your resume.
            </p>
          </div>
        </div>
        ...
        <div>
          ...
          <div>
            ...
            <p>
              This line tells the browser that this document is written in
              HTML5.
            </p>
            ...
            <p>
              This line starts your HTML document and specifies that the
              language is English.
            </p>
  ...
  <!-- We'll add our resume content here -->
        ...
        <div>
          ...
          <div>
            ...
            <p>
              Insert the following code inside the <code>&lt;body&gt;</code>{" "}
              tags:
            </p>
            <pre>
              <code>
  ...
  <h1>Your Name</h1>
            ...
            <ul>
              ...
              <li>
                <code>&lt;h1&gt;</code> makes the biggest heading (like a
                title).
              </li>
            </ul>
  ...
  <h2>Contact Information</h2>
            ...
            <ul>
              ...
              <li>
                <code>&lt;h2&gt;</code> is the heading for the contact
                information section.
              </li>
            </ul>
          </div>
        ...
        <div>
          <div>
            <p>
              ...
              professional goals or qualifications. Let's add this to your
              resume. Think of it as your elevator pitch for potential
              employers! 📢
            </p>
          </div>
        ...
        <div>
          <div>
            <p>
              ...
              parts of your resume. Let's add sections to highlight these. Think
              of it as telling your professional story! 📜
            </p>
          </div>
  ...
  <p>University Name, Graduation Year</p>
            ...
            <ul>
              <li>
                <code>&lt;h3&gt;</code> is used for the degree name, a level
  ...
  <ul>
    ...
    <li>Responsive Web Design</li>
        ...
        <p>
          Now that we've built everything piece by piece, here's the complete
          HTML code for your resume:
        </p>
        <pre>
          <code>
            <SyntaxHighlighter language="html" style={docco}>
  ...
  <section>
    ...
    <ul>
      ...
      <li>Responsive Web Design</li>
        ...
        <h3>Recommended </h3>
        <p>
          Now that you've built your resume, here are some additional resources
