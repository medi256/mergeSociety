...
const HtmlResume2024 = () => {
  ...
  const steps = [
    {
      title: "Welcome to the HTML Resume Tutorial for 2024",
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                ...
                effective resume using HTML. As of 2024, HTML resumes are still
                a great way to showcase your skills and experience, especially
                for beginners who are just starting to learn web development.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                tags and a text editor installed on your computer. If you're new
                to HTML, don't worry - we'll explain everything step by step!
              </p>
            </div>
          </div>
        </>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                Let's create the basic structure of our HTML document, which
                will serve as the foundation for your resume. Think of it like
                building the frame of a house - it's essential!
              </p>
            </div>
...
<body>
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      <code>lang="en"</code> attribute specifies the language as
                      English.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <p>
                      Ensures that the resume looks good on different devices
                      and screen sizes.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`6. <title>`}</p>
                    <p>
                      Sets the title of the webpage, which appears in the
                      browser tab.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`7. <body>`}</p>
                    <p>
                      This is where we'll add the visible content of your
                      resume.
                    </p>
                  </div>
                </div>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                Let's add a header to your resume, which will prominently
                display your name and job title. Think of it as the welcome sign
                for your resume! 🏠
              </p>
            </div>
  ...
  <!-- More sections will be added here -->
            ...
            <div>
              ...
              <p>
                Replace "Your Name" with your actual name, and "Your Job Title"
                with your desired job title or the position you're seeking. For
                example:
              </p>
              <ul>
                <li>
            ...
            <div>
              ...
              <p>
                ...
                job title displayed at the top of the page. If they look too
                plain, don't worry - we'll make them look prettier later with
                CSS (that's like the paint and decorations for your webpage).
              </p>
            </div>
          </div>
        </>
          ...
          <div>
            <div>
              <p>
                ...
                crucial for employers to reach out to you. Think of it as
                leaving your business card for visitors! 📫
              </p>
            </div>
    ...
    <li>LinkedIn: linkedin.com/in/yourprofile</li>
            ...
            <div>
              ...
              <p>
                ...
                details. You can add or remove list items as needed. For
                example:
              </p>
              <ul>
            ...
            <div>
              ...
              <p>
                ...
                now see your contact information displayed below your header.
              </p>
            </div>
          </div>
        </>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                A summary or objective statement is a concise description of
                your professional goals or qualifications. Let's add this to
                your resume. Think of it as your elevator pitch for potential
                employers! 📢
              </p>
            </div>
    ...
    This is your chance to make a strong first impression on potential employers.
            ...
            <div>
              ...
              <p>
                ...
                Keep it concise and tailored to the type of job you're seeking.
                For example:
              </p>
              <SyntaxHighlighter language="html" style={docco}>
                {`<p>
  ...
  Seeking a role where I can contribute to innovative web projects and grow my skills in a dynamic team.
            ...
            <div>
              ...
              <p>
                Save your file and refresh it in your web browser. You should
                now see your professional summary below your contact
                information.
              </p>
            </div>
          </div>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                Your educational background and work experience are essential
                parts of your resume. Let's add sections to highlight these.
                Think of it as telling your professional story! 📜
              </p>
            </div>
    ...
    <li>Achievements: Highlight your accomplishments</li>
              ...
              <div>
                ...
                <div>
                  ...
                  <div>
                    <p>{`3. <p>`}</p>
                    <p>
                      Contains the university name and graduation year or
            ...
            <div>
              ...
              <p>
                ...
                repeating the <code>&lt;h3&gt;</code>,<code>&lt;p&gt;</code>,
                and <code>&lt;ul&gt;</code>
  ...
  <ul>
    ...
    <li>Achievements: Successfully launched 3 major projects, improved website performance by 20%</li>
            ...
            <div>
              ...
              <p>
                Save your file and refresh it in your web browser. You should
                now see your education and work experience sections displayed on
                your resume.
              </p>
            </div>
          </div>
  ...
  <ul>
    ...
    <li>Git</li>
            ...
            <div>
              <h4>👉 Make It Personal:</h4>
              <p>
                Replace the placeholder skills with your own. You can add or
                remove list items as needed. For example:
              </p>
              <SyntaxHighlighter language="html" style={docco}>
                {`<section>
  <h2>Skills</h2>
  <ul>
    ...
    <li>Responsive Web Design</li>
            ...
            <div>
              ...
              <p>
                Save your file and refresh it in your web browser. You should
                now see a list of your skills displayed on your resume.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                You've successfully created an HTML resume for 2024. This
                tutorial focused solely on HTML, providing a solid foundation
                for your resume.
              </p>
              <p>
                ...
                to style your resume and make it visually appealing.
                Additionally, exploring JavaScript and modern web development
                frameworks can further enhance your resume and web development
                skills.
              </p>
              <p>
                Keep learning, practicing, and building. Every project you
                create will contribute to your growth as a web developer. Happy
                coding! 💪
              </p>
            </div>
          </div>
