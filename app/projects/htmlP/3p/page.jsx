...
const WeeklyScheduleHtml = () => {
  return (
    <div className="lesson-wrapper">
      ...
      >
        <h1>Creating an HTML Table for Weekly Schedules</h1>
        ...
        <div>
          <div>
            <p>
              ...
              schedule using HTML tables. This project is perfect for beginners
        ...
        <div>
          ...
          <div>
            ...
            <p>
              ...
              <code>border</code> attribute is like drawing a line around each
              cell to make it easier to see. In modern web development, we
              typically use CSS for styling, but this is useful for
              demonstration.
            </p>
          </div>
  ...
  <td>Art</td>
            ...
            <ul>
              ...
              <li>
                <code>&lt;td&gt;</code> (table data) cells represent activities
                or classes for that time slot on a specific day.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul>
              <li>
                ...
                table, like a title for a book. It's typically displayed above
                the table.
              </li>
            </ul>
          </div>
