      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                In this tutorial, we'll guide you through creating a weekly
                schedule using HTML tables. This project is perfect for
                beginners who want to practice their HTML skills and learn how
                to structure data using tables.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                ...
                HTML tags and a text editor installed on your computer. If
                you're new to HTML, don't worry - we'll explain everything step
                by step!
              </p>
            </div>
          </div>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                First, let's set up a workspace for your weekly schedule
                project:
              </p>
            </div>
            ...
            <div>
              ...
              <div>
                <p>
                  Think of this folder as a special drawer just for your
                  schedule files:
                </p>
            ...
            <div>
              ...
              <p>
                ...
                creating! In the next step, we'll start writing the basic HTML
                structure for your weekly schedule.
              </p>
            </div>
          </div>
        </>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                Let's start by creating the basic structure of our HTML
                document. This will serve as the foundation for our weekly
                schedule.
              </p>
            </div>
...
<body>
  ...
  <!-- We'll add our table here -->
                ...
                <div>
                  ...
                  <div>
                    ...
                    <p>
                      ...
                      <code>lang="en"</code> attribute tells the browser that
                  ...
                  <div>
                    <p>{`3. <head>`}</p>
                    <p>
                      This section is like the back cover of a book, where you
                      put information about the document itself, like the title
                  ...
                  <div>
                    ...
                    <p>
                      This tag sets the character encoding to UTF-8, which is
                      like a language that the browser uses to understand all
                  ...
                  <div>
                    <p>{`6. <title>`}</p>
                    <p>
                      This tag sets the title of the webpage, which appears in
                      the browser tab, like the title of a book on a shelf.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`7. <body>`}</p>
                    <p>
                      This is where you put all the visible content of your
                      webpage, like the pages inside a book.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`8. <h1>`}</p>
                    <p>
                      This is the main heading for your page, like the title of
                      a chapter in a book.
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <p>
                Right now you'll see the title "My Weekly Schedule" displayed on
                the page. In the next step, we'll start building our schedule
                table.
              </p>
            </div>
          </div>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                Now that we have our basic HTML structure, let's create the
                table for our weekly schedule. We'll start with a simple
                structure and build upon it.
              </p>
            </div>
  ...
  <tbody>
    <!-- We'll add time slots and activities here -->
                ...
                <div>
                  <div>
                    ...
                    <p>
                      ...
                      <code>border</code> attribute is like drawing a line
                      around each cell to make it easier to see. In modern web
                      development, we typically use CSS for styling, but this is
                  ...
                  <div>
                    <p>{`2. <thead>`}</p>
                    <p>
                      This section contains the header content of the table,
                      like the header of a spreadsheet.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`3. <tr>`}</p>
                    <p>
                      This stands for "table row". It defines a row in the
                      table, like a row in a spreadsheet.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`4. <th>`}</p>
                    <p>
                      This stands for "table header". It's used for header
                      cells, like the column headers in a spreadsheet.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`5. <tbody>`}</p>
                    <p>
                      This section will contain the main content of the table,
                      like the body of a spreadsheet.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div>
              <h4>👉 Try It Out!</h4>
              <p>
                Save your file and refresh it in your web browser. You should
                now see a table with days of the week as column headers.
              </p>
              <p>
                In the next step, we'll add time slots and activities to
                complete our weekly schedule.
              </p>
            </div>
          </div>
        </>
      ...
      content: (
        <>
          ...
          <div>
            <div>
              <p>
                Now that we have our basic table structure, let's add time slots
                and some sample activities to create a full weekly schedule.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                Replace the <code>&lt;tbody&gt;</code> section of your table
  ...
  <tr>
    ...
    <td>Economics</td>
              ...
              <div>
                ...
                <div>
                  <div>
                    <p>{`1. <tr>`}</p>
                    <p>
                      Each <code>&lt;tr&gt;</code> represents a row in our
                      schedule, corresponding to a specific time slot. Think of
                      it as a row in a spreadsheet.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`2. <th>`}</p>
                    <p>
                      The first <code>&lt;th&gt;</code> in each row shows the
                      time slot. It's like the label for each row in a
                      spreadsheet.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>{`3. <td>`}</p>
                    <p>
                      Each <code>&lt;td&gt;</code> (table data) cell represents
                      an activity or class for that time slot on a specific day.
                      Think of it as a cell in a spreadsheet where you write
            ...
            <div>
              ...
              <p>
                Save your file and refresh it in your web browser. You should
                now see a complete weekly schedule with time slots and
                activities.
              </p>
              <p>
          ...
          <div>
            <div>
              <p>
                ...
                let's add a few finishing touches. We'll add a caption to the
                table and use the <code>colspan</code>
    ...
    <tr>
      ...
      <td>Economics</td>
                ...
                <div>
                  <div>
                    ...
                    <p>
                      ...
                      title for a book. It's typically displayed above the
                      table.
                    </p>
                  </div>
                  ...
                  <div>
                    <p>2. colspan="5"</p>
                    <p>
                      This attribute makes the lunch break cell span across all
                      five weekdays, creating a unified lunch break row. It's
                      like merging cells in a spreadsheet to create a larger
                      cell.
                    </p>
                  </div>
                </div>
            ...
            <div>
              ...
              <p>
                Save your file and refresh it in your web browser. You should
                now see a more polished weekly schedule with a caption and a
                unified lunch break row.
              </p>
              ...
              <p>
                ...
                classes, changing the time slots, or even adding weekend
                activities. Remember, practice makes perfect in web development!
              </p>
            </div>
          </div>
        </>
