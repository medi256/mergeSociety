...
const WeatherAppWithAPI = () => {
  ...
  const steps = [
    {
      title: "Introduction to the Weather App with API",
      content: (
        <>
          ...
          <p>
            ...
            real-time weather data from an API and displays it on a webpage.
            This project will help you learn the basics of working with APIs,
            handling async functions, and displaying data on a webpage.
          </p>
          ...
          <p>
            By the end of this project, you'll have a fully functional weather
        ...
        <>
          ...
          <ol>
            <li>
              ...
              "Folder", and name it "weather-app".
            </li>
            <li>
            ...
            <ul>
              ...
              <li>
                ...
                "script.js". Make sure to save them in your "weather-app"
                folder.
              </li>
            </ul>
          </ol>
          <p>
            ...
            is the main page of our weather app, and it's standard to name it
            "index.html".
          </p>
          <p>
            Great job! You've set up your workspace. In the next step, we'll
            start building the HTML structure for our weather app.
          </p>
        </>
      ),
    },
...
<body>
  ...
  <script src="script.js"></script>
          ...
          <ul>
            ...
            <li>
              <code>&lt;div class="search-container"&gt;</code>: The container
    ...
    {
      title: "Styling the Weather App",
      content: (
        <>
          <ScrollToTop />
          <h3>Styling the Weather App</h3>
          <p>
            Let's start by styling the weather app to ensure a consistent and
            clean layout.
          </p>
          <ol>
            <li>
            ...
            <li>
              <strong>Add Weather App Styles:</strong> Copy and paste the
...
#description {
  ...
  margin-bottom: 10px;
          ...
          <ul>
            ...
            <li>
              <code>.search-container</code>: Adds margin to the search
              container.
            </li>
            <li>
              <code>#city-input</code>: Styles the input field for entering the
              city name with a border, padding, and margin.
            </li>
            <li>
            ...
            <li>
              <code>#search-button:hover</code>: Changes the background color of
              the search button on hover.
            </li>
            <li>
              <code>.weather-container</code>: Adds margin to the weather
              container.
            </li>
            <li>
              <code>#city-name</code>: Styles the city name with a larger font
              size and margin.
            </li>
            <li>
              <code>#temperature</code>: Styles the temperature with a larger
          ...
          <p>
            In the next step, we'll start adding JavaScript to handle API calls
    ...
    {
      title: "Adding JavaScript for API Calls: Part 1",
      content: (
        <>
          <h3>Adding JavaScript for API Calls: Part 1</h3>
          <ScrollToTop />
          <p>
            Let's start adding JavaScript to handle API calls and user
            interactions.
          </p>
          <ol>
            <li>
            ...
            <li>
              <strong>Defining the API Key and Base URL:</strong> Copy and paste
...
const baseUrl = 'https://api.openweathermap.org/data/2.5/weather';`}
          ...
          <ul>
            <li>
              <code>const apiKey = 'YOUR_API_KEY';</code>: Defines the API key
              for accessing the OpenWeatherMap API. Replace `'YOUR_API_KEY'`
    ...
    {
      title: "Adding JavaScript for API Calls: Part 2",
      content: (
        <>
          <ScrollToTop />
    ...
    return null;
          ...
          <ul>
            ...
            <li>
              ...
              : Sends a GET request to the OpenWeatherMap API with the city
              name, API key, and metric units.
            </li>
            <li>
              <code>{`if (!response.ok) { throw new Error('City not found'); }`}</code>
              : Checks if the response is not ok (e.g., city not found) and
              throws an error.
            </li>
            <li>
            ...
            <li>
              ...
              : Catches any errors that occur during the fetch request and logs
              them to the console.
            </li>
          </ul>
          <p>
            Save your "script.js" file. In the next step, we'll add the function
            to update the UI with the fetched weather data.
          </p>
        </>
      ),
    },
    {
      title: "Adding JavaScript for API Calls: Part 3",
      content: (
        <>
          <h3>Adding JavaScript for API Calls: Part 3</h3>
          <ScrollToTop />
          <p>
            Let's add the function to update the UI with the fetched weather
            data.
          </p>
          <ol>
            <li>
  ...
  weatherContainer.style.display = 'block';
          ...
          <ul>
            ...
            <li>
              <code>cityNameElement.textContent = weatherData.name;</code>: Sets
              the city name in the UI.
            </li>
            <li>
              <code>
            ...
            <li>
              <code>weatherContainer.style.display = 'block';</code>: Displays
  ...
  searchButton.addEventListener('click', async () => {
    ...
    if (city) {
      ...
      alert('Please enter a city name.');
          ...
          <ul>
            ...
            <li>
              <code>const city = cityInput.value.trim();</code>: Gets the city
              name from the input field and trims any leading or trailing
              spaces.
            </li>
            <li>
            ...
            <li>
              <code>const weatherData = await fetchWeatherData(city);</code>:
              Calls the <code>fetchWeatherData</code> function to fetch the
              weather data for the entered city.
            </li>
            <li>
              <code>{`if (weatherData) { updateUI(weatherData); }`}</code>: If
              the weather data is fetched successfully, calls the{" "}
              <code>updateUI</code>
            ...
            <li>
              <code>{`else { alert('Please enter a city name.'); }`}</code>: If
              no city name is entered, shows an alert message.
            </li>
          </ul>
          <p>
            Save your "script.js" file. Now, if you open "index.html" in a web
            browser, you'll be able to search for a city and see the weather
            data.
          </p>
          <p>
            In the next step, we'll make the weather app responsive for
    ...
    {
      title: "Making the Weather App Responsive",
      content: (
        <>
          <h3>Making the Weather App Responsive</h3>
          <ScrollToTop />
          <p>
            Let's ensure our weather app looks great on various devices by
  ...
  #description {
    font-size: 1rem;
          ...
          <ul>
            ...
            <li>
              <code>#search-button</code>: Adjusts the font size and padding of
              the search button for better readability on smaller screens.
            </li>
            <li>
              <code>#city-name</code>: Adjusts the font size of the city name
              for better readability on smaller screens.
            </li>
            <li>
              <code>#temperature</code>: Adjusts the font size of the
              temperature for better readability on smaller screens.
            </li>
            <li>
          ...
          <p>
            ...
            or view the weather app on different devices, you'll see the layout
...
#city-input:focus {
  ...
  box-shadow: 0 0 5px rgba(0, 123, 255, 0.5);
          ...
          <ul>
            ...
            <li>
              <code>#search-button</code>: Adds a transition effect for
              background color and transform to the search button.
            </li>
            <li>
              <code>#search-button:hover</code>: Scales the search button
              slightly larger on hover to create a subtle zoom effect.
            </li>
            <li>
              <code>#city-input:focus</code>: Changes the border color and adds
              a box shadow to the city input field when it is focused.
            </li>
          </ul>
          <p>
            Save your "styles.css" file. Now, if you open "index.html" in a web
          ...
          <p>
            Congratulations! You've completed the JavaScript project, "Weather
            App with API." You've learned how to create a simple weather app
            that fetches real-time weather data from an API and displays it on a
            webpage. You've also learned the basics of working with APIs,
            handling async functions, and displaying data on a webpage.
          </p>
          <p>
            Feel free to continue customizing your weather app and exploring
