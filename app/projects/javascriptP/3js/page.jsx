...
const JavaScriptQuizGame = () => {
  ...
  const steps = [
    {
      title: "Introduction to the JavaScript Quiz Game",
      content: (
        <>
          <h3>Welcome to Building a JavaScript Quiz Game!</h3>
          <ScrollToTop />
          <p>
            In this project, we'll create a simple quiz game where users can
            answer multiple-choice questions. This project will help you learn
            the basics of arrays, functions, and quiz logic in JavaScript.
          </p>
          ...
          <p>
            ...
            JavaScript quiz game. Let's get started by setting up our project
            files!
          </p>
        </>
      ),
        ...
        <>
          ...
          <ol>
            <li>
              ...
              "Folder", and name it "javascript-quiz-game".
            </li>
            <li>
              On Mac: Right-click on your desktop, select "New Folder", and name
              it "javascript-quiz-game".
            </li>
            <li>
              ...
              <ul>
                <li>
                  ...
                  right-click on the "javascript-quiz-game" folder and select
                  "Open with Code".
                </li>
                <li>
          ...
          <p>
            ...
            is the main page of our quiz game, and it's standard to name it
            "index.html".
          </p>
          <p>
            Great job! You've set up your workspace. In the next step, we'll
            start building the HTML structure for our quiz game.
          </p>
        </>
      ),
    },
      ...
      content: (
        <>
          ...
          <ol>
            ...
            <li>
              <strong>Add the Quiz Game HTML:</strong> Copy and paste the
  ...
  <script src="script.js"></script>
          ...
          <ul>
            <li>
              ...
              container for the quiz game.
            </li>
            <li>
              <code>&lt;h1&gt;JavaScript Quiz Game&lt;/h1&gt;</code>: The title
              of the quiz game.
            </li>
            <li>
              <code>&lt;div id="quiz-container"&gt;</code>: The container for
            ...
            <li>
              <code>&lt;ul id="options"&gt;&lt;/ul&gt;</code>: The unordered
              list for displaying the answer options.
            </li>
            <li>
              <code>
                &lt;button id="next-button" disabled&gt;Next
                Question&lt;/button&gt;
              </code>
              : The button for navigating to the next question, initially
              disabled.
            </li>
            <li>
            ...
            <li>
              <code>&lt;h2&gt;Quiz Results&lt;/h2&gt;</code>: The title for the
              quiz results.
            </li>
            <li>
    ...
    {
      title: "Styling the Quiz Game",
      content: (
        <>
          <ScrollToTop />
          <h3>Styling the Quiz Game</h3>
          <p>
            Let's start by styling the quiz game to ensure a consistent and
            clean layout.
          </p>
          <ol>
            <li>
            ...
            <li>
              <strong>Add Quiz Game Styles:</strong> Copy and paste the
...
#score {
  ...
  margin-bottom: 20px;
          ...
          <ul>
            ...
            <li>
              <code>#question</code>: Styles the question with a larger font
              size and margin.
            </li>
            <li>
              <code>#options</code>: Removes the default list style and padding
              from the options list.
            </li>
            <li>
              <code>#options li</code>: Styles the list items for the answer
              options with a light gray background, padding, margin,
              border-radius, cursor, and transition for smooth changes.
            </li>
            <li>
              <code>#options li:hover</code>: Changes the background color of
              the list items on hover.
            </li>
            <li>
              <code>button</code>: Styles the buttons with a blue background,
          ...
          <p>
            In the next step, we'll start adding JavaScript to handle quiz logic
    ...
    {
      title: "Adding JavaScript for Quiz Logic: Part 1",
      content: (
        <>
          ...
          <ol>
            ...
            <li>
              <strong>Defining the Quiz Data:</strong> Copy and paste the
  ...
  },
  {
    ...
    {
      title: "Adding JavaScript for Quiz Logic: Part 2",
      content: (
        <>
          <ScrollToTop />
          <h3>Adding JavaScript for Quiz Logic: Part 2</h3>
          <p>
            Let's add the initialization code and select the necessary DOM
            elements.
          </p>
          <ol>
            <li>
            ...
            <li>
              <strong>Initialization and DOM Selection:</strong> Copy and paste
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  loadQuestion();
          ...
          <ul>
            <li>
              <code>let currentQuestionIndex = 0</code>: Initializes the index
              of the current question to 0.
            </li>
            <li>
            ...
            <li>
              <code>{`function loadQuestion() { ... }`}</code>: Defines the
              function to load the current question and its options.
            </li>
            <li>
              <code>{`function checkAnswer(selectedOption) { ... }`}</code>:
              Defines the function to check the selected answer and update the
              score.
            </li>
            <li>
              <code>{`function showResult() { ... }`}</code>: Defines the
              function to display the quiz results.
            </li>
            <li>
              <code>{`nextButton.addEventListener('click', () => { ... })`}</code>
              : Adds an event listener to the "Next Question" button to handle
              the click event and load the next question or show the results.
            </li>
            <li>
              <code>{`restartButton.addEventListener('click', () => { ... })`}</code>
              : Adds an event listener to the "Restart Quiz" button to handle
              the click event and reset the quiz.
            </li>
            <li>
          ...
          <p>
            ...
            browser, you'll be able to play the quiz game, answer questions, and
    ...
    {
      title: "Making the Quiz Game Responsive",
      content: (
        <>
  ...
  #score {
    font-size: 1rem;
          ...
          <p>
            ...
            or view the quiz game on different devices, you'll see the layout
...
#options li:hover {
  transform: scale(1.05);
          ...
          <p>
            ...
            "JavaScript Quiz Game." You've learned how to create a simple quiz
            game where users can answer multiple-choice questions. You've also
            learned the basics of arrays, functions, and quiz logic in
            JavaScript.
          </p>
          <p>
