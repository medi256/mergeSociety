...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/Web_Analytics_jzmlyv_nwoqmf.webp",
        width: 1200,
        height: 630,
  ...
  twitter: {
    ...
    description:
      "Explore an exciting range of JavaScript projects for all skill levels. From interactive web apps to advanced algorithms, these projects will help you hone your JavaScript skills.",
    images: [
      "https://img.mergesociety.com/cdn-cgi/image/width=1200,quality=75,format=auto/mergesociety/Web_Analytics_jzmlyv_nwoqmf.webp",
    ],
  },
  robots: {
    index: true,
