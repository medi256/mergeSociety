...
const JavaScriptCalculator = () => {
  return (
    <div className="lesson-container">
      ...
      <h2>Introduction to the JavaScript Calculator</h2>
      ...
      <ul>
        ...
        <li>Making the calculator responsive for different screen sizes.</li>
      </ul>
      <p>
        By the end of this project, you'll have a fully functional JavaScript
        calculator. Let's get started by setting up our project files!
      </p>
      ...
      <ol>
        <li>
          ...
          and name it "javascript-calculator".
        </li>
        <li>
        ...
        <li>
          ...
          <ul>
            <li>
              ...
              right-click on the "javascript-calculator" folder and select "Open
              with Code".
            </li>
            <li>
        ...
        <ul>
          ...
          <li>
            ...
            Make sure to save them in your "javascript-calculator" folder.
          </li>
        </ul>
      </ol>
      <p>
        ...
        our calculator, and it's standard to name it "index.html".
      </p>
      <p>
        Great job! You've set up your workspace. In the next step, we'll start
        building the HTML structure for our calculator.
      </p>
      ...
      <ol>
        ...
        <li>
          <strong>Add the Calculator HTML:</strong> Copy and paste the following
...
<body>
  ...
  <script src="script.js"></script>
      ...
      <ul>
        <li>
          <code>&lt;div class="calculator"&gt;</code>: Represents the container
          for the calculator.
        </li>
        <li>
          <code>&lt;input type="text" id="display" disabled&gt;</code>: The
          input field for displaying the calculator input and result, disabled
          to prevent direct user input.
        </li>
        <li>
        ...
        <li>
          <code>&lt;button class="btn" id="backspace"&gt;←&lt;/button&gt;</code>
        ...
        <li>
          <code>&lt;button class="btn" id="sqrt"&gt;√&lt;/button&gt;</code>: The
          button for calculating the square root.
        </li>
        <li>
          <code>&lt;button class="btn" id="factorial"&gt;!&lt;/button&gt;</code>
      ...
      <p>
        Let's start by styling the calculator to ensure a consistent and clean
        layout.
      </p>
      <ol>
        <li>
        ...
        <li>
          <strong>Add Calculator Styles:</strong> Copy and paste the following
...
#decimal:hover, #zero:hover, #one:hover, #two:hover, #three:hover, #four:hover, #five:hover, #six:hover, #seven:hover, #eight:hover, #nine:hover {
  background-color: #d4d4d4;
      ...
      <ul>
        ...
        <li>
          <code>.btn</code>: Styles the buttons with a light gray background,
          border, padding, font size, border-radius, cursor, and transition for
          smooth changes.
        </li>
        <li>
          <code>.btn:hover</code>: Changes the background color of the buttons
          on hover.
        </li>
        <li>
          <code>#clear, #backspace, #sqrt, #factorial</code>: Styles the special
          function buttons with a red background and white text.
        </li>
        <li>
          <code>
            #clear:hover, #backspace:hover, #sqrt:hover, #factorial:hover
        ...
        <li>
          <code>#divide, #multiply, #subtract, #add, #equals</code>: Styles the
          operation buttons with a blue background and white text.
        </li>
        <li>
          <code>
        ...
        <li>
          ...
          : Styles the number and decimal buttons with a light gray background
          and dark text.
        </li>
        <li>
          <code>
            #decimal:hover, #zero:hover, #one:hover, #two:hover, #three:hover,
            #four:hover, #five:hover, #six:hover, #seven:hover, #eight:hover,
            #nine:hover
          </code>
          : Changes the background color of the number and decimal buttons on
          hover.
        </li>
      </ul>
      <p>
      ...
      <p>
        In the next step, we'll start adding JavaScript to handle button clicks
        and calculations.
      </p>

      <h2>Adding JavaScript for Button Clicks: Part 1</h2>
      <h3>Adding JavaScript for Button Clicks: Part 1</h3>

      <p>
        Let's start adding JavaScript to handle button clicks and calculations.
      </p>
      <ol>
        <li>
      ...
      <h2>Adding JavaScript for Button Clicks: Part 2</h2>
  ...
  if (display.value === '0' || display.value === 'Error') {
    ...
    display.value += number;
      ...
      <ul>
        <li>
          <code>{`function handleNumberClick(number) { ... }`}</code>: Defines a
          function to handle the click event for number buttons.
        </li>
        <li>
          <code>{`if (display.value === '0' || display.value === 'Error') { display.value = number; }`}</code>
          : If the display value is '0' or 'Error', sets the display value to
          the clicked number.
        </li>
        <li>
          <code>{`else { display.value += number; }`}</code>: If the display
          value is not '0' or 'Error', appends the clicked number to the display
          value.
        </li>
      </ul>
      <p>
      ...
      <h2>Adding JavaScript for Button Clicks: Part 3</h2>
      ...
      <ol>
        ...
        <li>
          <strong>Adding the Operation Button Click Function:</strong> Copy and
          paste the following JavaScript code into your "script.js" file:
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
...
function handleOperationClick(operation) {
  ...
  currentOperation = operation;
      ...
      <ul>
        ...
        <li>
          <code>let firstOperand = null;</code>: Initializes the first operand
          to null.
        </li>
        <li>
          <code>{`function handleOperationClick(operation) { ... }`}</code>:
          Defines a function to handle the click event for operation buttons.
        </li>
        <li>
          <code>{`if (firstOperand === null) { firstOperand = parseFloat(display.value); }`}</code>
          : If the first operand is null, sets it to the current display value
          converted to a number.
        </li>
        <li>
          <code>{`else if (display.value !== '') { ... }`}</code>: If the
          display value is not empty, performs the current operation with the
          first and second operands, updates the display value, and sets the
          first operand to the result.
        </li>
        <li>
          <code>currentOperation = operation;</code>: Sets the current operation
          to the clicked operation.
        </li>
      </ul>
      <p>
        Save your "script.js" file. In the next step, we'll add the function to
      ...
      <h2>Adding JavaScript for Calculations: Part 1</h2>
      ...
      <ol>
        ...
        <li>
          <strong>Adding the Calculation Function:</strong> Copy and paste the
          following JavaScript code into your "script.js" file:
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
  ...
  return result;
      ...
      <ul>
        ...
        <li>
          <code>{`try { ... } catch (error) { ... }`}</code>: Tries to perform
          the calculation and catches any errors.
        </li>
        <li>
          <code>{`switch (operation) { ... }`}</code>: Uses a switch statement
          to handle different operations.
        </li>
        <li>
          <code>case '+': result = firstOperand + secondOperand; break;</code>:
          Handles addition.
        </li>
        <li>
          <code>case '-': result = firstOperand - secondOperand; break;</code>:
        ...
        <li>
          <code>default: throw new Error('Invalid operation');</code>: Handles
          invalid operations.
        </li>
        <li>
          <code>{`catch (error) { display.value = 'Error'; firstOperand = null; currentOperation = null; return; }`}</code>
          : Catches any errors, displays 'Error' in the display, and resets the
          first operand and current operation.
        </li>
        <li>
          <code>return result;</code>: Returns the result of the calculation.
        </li>
      </ul>
      <p>
        Save your "script.js" file. In the next step, we'll add the function to
      ...
      <h2>Adding JavaScript for Button Clicks: Part 4</h2>
    ...
    currentOperation = null;
      ...
      <ul>
        ...
        <li>
          ...
          : Checks if the first operand, current operation, and display value
          are valid.
        </li>
        <li>
        ...
        <li>
          ...
          : Performs the calculation using the <code>performCalculation</code>
          function.
        </li>
        <li>
          <code>display.value = result;</code>: Updates the display value with
          the result.
        </li>
        <li>
        ...
        <li>
          <code>currentOperation = null;</code>: Resets the current operation to
          null.
        </li>
      </ul>
      <p>
      ...
      <h2>Adding JavaScript for Button Clicks: Part 5</h2>
  ...
  currentOperation = null;
      ...
      <ul>
        ...
        <li>
          <code>display.value = '0';</code>: Resets the display value to '0'.
        </li>
        <li>
          <code>firstOperand = null;</code>: Resets the first operand to null.
        </li>
        <li>
          <code>currentOperation = null;</code>: Resets the current operation to
          null.
      ...
      <h2>Adding JavaScript for Button Clicks: Part 6</h2>
      ...
      <ol>
        ...
        <li>
          <strong>Adding the Backspace Button Click Function:</strong> Copy and
          paste the following JavaScript code into your "script.js" file:
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
  ...
  if (display.value.length > 1) {
    ...
    display.value = '0';
      ...
      <ul>
        <li>
          <code>{`function handleBackspaceClick() { ... }`}</code>: Defines a
          function to handle the click event for the backspace button.
        </li>
        <li>
          <code>{`if (display.value.length > 1) { display.value = display.value.slice(0, -1); }`}</code>
          : If the display value has more than one character, removes the last
          character.
        </li>
        <li>
          <code>{`else { display.value = '0'; }`}</code>: If the display value
          has only one character, resets it to '0'.
        </li>
      </ul>
      <p>
        Save your "script.js" file. In the next step, we'll add the function to
        handle the decimal button click.
      </p>

      <h2>Adding JavaScript for Button Clicks: Part 7</h2>
      ...
      <ol>
        ...
        <li>
          <strong>Adding the Decimal Button Click Function:</strong> Copy and
          paste the following JavaScript code into your "script.js" file:
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
  ...
  if (!display.value.includes('.')) {
    display.value += '.';
      ...
      <h2>Adding JavaScript for Button Clicks: Part 8</h2>
      ...
      <ol>
        ...
        <li>
          <strong>Adding the Square Root Button Click Function:</strong> Copy
  ...
  if (display.value !== '') {
    ...
    display.value = result;
      ...
      <ul>
        ...
        <li>
          <code>{`const value = parseFloat(display.value);`}</code>: Converts
          the display value to a number.
        </li>
        <li>
      ...
      <h2>Adding JavaScript for Button Clicks: Part 9</h2>
      ...
      <ol>
        ...
        <li>
          <strong>Adding the Factorial Button Click Function:</strong> Copy and
          paste the following JavaScript code into your "script.js" file:
          <pre>
            <code>
              <SyntaxHighlighter language="javascript" style={docco}>
...
function factorial(n) {
  ...
  return n * factorial(n - 1);
      ...
      <ul>
        <li>
          <code>{`function handleFactorialClick() { ... }`}</code>: Defines a
          function to handle the click event for the factorial button.
        </li>
        <li>
          <code>{`if (display.value !== '') { ... }`}</code>: Checks if the
          display value is not empty.
        ...
        <li>
          <code>{`function factorial(n) { ... }`}</code>: Defines a recursive
          function to calculate the factorial of a number.
        </li>
        <li>
          <code>{`if (n === 0 || n === 1) { return 1; }`}</code>: Base case for
          the factorial function.
        </li>
        <li>
          <code>{`return n * factorial(n - 1);`}</code>: Recursive case for the
          factorial function.
        </li>
      </ul>
      <p>
      ...
      <h2>Adding Event Listeners for Button Clicks</h2>
      ...
      <ol>
        ...
        <li>
          <strong>Adding Event Listeners:</strong> Copy and paste the following
  ...
  document.getElementById('nine').addEventListener('click', () => handleNumberClick('9'));
      ...
      <ul>
        ...
        <li>
          ...
          : Adds an event listener to the backspace button to handle the click
          event.
        </li>
        <li>
        ...
        <li>
          ...
          : Adds an event listener to the multiply button to handle the click
          event and pass the multiplication operation.
        </li>
        <li>
          <code>{`document.getElementById('subtract').addEventListener('click', () => handleOperationClick('-'));`}</code>
          : Adds an event listener to the subtract button to handle the click
          event and pass the subtraction operation.
        </li>
        <li>
          <code>{`document.getElementById('add').addEventListener('click', () => handleOperationClick('+'));`}</code>
          : Adds an event listener to the add button to handle the click event
          and pass the addition operation.
        </li>
        <li>
          <code>
        ...
        <li>
          ...
          : Adds an event listener to the square root button to handle the click
          event.
        </li>
        <li>
          <code>
          ...
          : Adds an event listener to the factorial button to handle the click
          event.
        </li>
        <li>
          <code>{`document.getElementById('zero').addEventListener('click', () => handleNumberClick('0'));`}</code>
          : Adds an event listener to the zero button to handle the click event
          and pass the number '0'.
        </li>
        <li>
          <code>{`document.getElementById('one').addEventListener('click', () => handleNumberClick('1'));`}</code>
          : Adds an event listener to the one button to handle the click event
          and pass the number '1'.
        </li>
        <li>
          <code>{`document.getElementById('two').addEventListener('click', () => handleNumberClick('2'));`}</code>
          : Adds an event listener to the two button to handle the click event
          and pass the number '2'.
        </li>
        <li>
          <code>{`document.getElementById('three').addEventListener('click', () => handleNumberClick('3'));`}</code>
          : Adds an event listener to the three button to handle the click event
          and pass the number '3'.
        </li>
        <li>
          <code>{`document.getElementById('four').addEventListener('click', () => handleNumberClick('4'));`}</code>
          : Adds an event listener to the four button to handle the click event
          and pass the number '4'.
        </li>
        <li>
          <code>{`document.getElementById('five').addEventListener('click', () => handleNumberClick('5'));`}</code>
          : Adds an event listener to the five button to handle the click event
          and pass the number '5'.
        </li>
        <li>
          <code>{`document.getElementById('six').addEventListener('click', () => handleNumberClick('6'));`}</code>
          : Adds an event listener to the six button to handle the click event
          and pass the number '6'.
        </li>
        <li>
          <code>{`document.getElementById('seven').addEventListener('click', () => handleNumberClick('7'));`}</code>
          : Adds an event listener to the seven button to handle the click event
          and pass the number '7'.
        </li>
        <li>
          <code>{`document.getElementById('eight').addEventListener('click', () => handleNumberClick('8'));`}</code>
          : Adds an event listener to the eight button to handle the click event
          and pass the number '8'.
        </li>
        <li>
          <code>{`document.getElementById('nine').addEventListener('click', () => handleNumberClick('9'));`}</code>
          : Adds an event listener to the nine button to handle the click event
          and pass the number '9'.
        </li>
      </ul>
      <p>
      ...
      <h2>Making the Calculator Responsive</h2>
  ...
  .btn {
    ...
    padding: 15px;
      ...
      <ul>
        ...
        <li>
          <code>.calculator</code>: Adjusts the width of the calculator to 90%
          for better visibility on smaller screens.
        </li>
        <li>
          <code>#display</code>: Adjusts the font size of the display for better
          readability on smaller screens.
        </li>
        <li>
          <code>.btn</code>: Adjusts the font size and padding of the buttons
          for better readability on smaller screens.
        </li>
      </ul>
      <p>
        Save your "styles.css" file. Now, if you resize your browser window or
        view the calculator on different devices, you'll see the layout adapt to
...
#display:focus {
  ...
  box-shadow: 0 0 5px rgba(0, 123, 255, 0.5);
      ...
      <ul>
        ...
        <li>
          <code>.btn</code>: Adds a transition effect for background color and
          transform to the buttons.
        </li>
        <li>
          <code>.btn:hover</code>: Scales the buttons slightly larger on hover
          to create a subtle zoom effect.
        </li>
        <li>
          <code>#display:focus</code>: Changes the border color and adds a box
          shadow to the display when it is focused.
        </li>
      </ul>
      <p>
        Save your "styles.css" file. Now, if you open "index.html" in a web
      ...
      <p>
        ...
        Calculator." You've learned how to create a fully functional calculator
        with advanced operations. You've also learned the basics of working with
        event listeners, complex logic, and DOM manipulation.
      </p>
      <p>
