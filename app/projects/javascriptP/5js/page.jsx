      ...
      <article style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
        ...
        >
          ...
          <p>
            ...
            files. You can name it "javascript-calculator".
          </p>
...
<body>
  ...
  <script src="script.js"></script>
        ...
        <ul>
          ...
          <li>
            <code>&lt;h1&gt;JavaScript Calculator&lt;/h1&gt;</code>: The title
            of our app.
          </li>
          <li>
...
#decimal:hover, #zero:hover, #one:hover, #two:hover, #three:hover, #four:hover, #five:hover, #six:hover, #seven:hover, #eight:hover, #nine:hover {
  background-color: #3a7cbb;
        ...
        <ul>
          ...
          <li>
            <code>#clear, #delete, #equals</code>: Styles the special buttons
          ...
          <li>
            <code>#divide, #multiply, #subtract, #add</code>: Styles the
            operation buttons with an orange background and white text.
          </li>
          <li>
            <code>
              #divide:hover, #multiply:hover, #subtract:hover, #add:hover
          ...
          <li>
            ...
            : Styles the number buttons with a teal background and white text.
            and changes the background color on hover.
          </li>
        </ul>
        <p>
...
function deleteLastCharacter() {
  display.value = display.value.slice(0, -1);
        ...
        <p>
          Now, let's create a function to update the display with the value of
          the button clicked.
        </p>
        <ol className="space-y-6" start={6}>
          <li>
            <strong>6. Updating the Display:</strong> Copy and paste the
            following JavaScript code into your "script.js" file:
            <pre>
              <code>
                <SyntaxHighlighter language="javascript" style={docco}>
  ...
  try {
    ...
    display.value = 'Error';
        ...
        <p>
          ...
          expression in the display. If the evaluation is successful, it sets
          the display value to the result. If an error occurs, it sets the
          display value to 'Error'.
        </p>
        ...
        <ol className="space-y-6" start={8}>
          <li>
            <strong>8. Adding Event Listeners to Buttons:</strong> Copy and
...
buttons.forEach(button => {
  button.addEventListener('click', handleButtonClick);
        ...
        <p>
          This code iterates over all the buttons and adds a click event
          listener to each one, calling the <code>handleButtonClick</code>{" "}
        ...
        <p>
          If everything is working correctly, you should be able to perform
          basic and advanced operations using the calculator.
        </p>
